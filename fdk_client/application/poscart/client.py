...
class PosCart:
    ...
    async def getCart(self, id=None, i=None, b=None, p=None, assign_card_id=None, area_code=None, buy_now=None, body=""):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getCart"], proccessed_params="""{"required":[],"optional":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}},{"in":"query","name":"i","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart.","schema":{"type":"boolean"}},{"in":"query","name":"b","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items.","schema":{"type":"boolean"}},{"in":"query","name":"p","description":"This is a boolean value. Select `true` for getting a payment option in response.","schema":{"type":"boolean"}},{"in":"query","name":"assign_card_id","description":"Token of user's debit or credit card","schema":{"type":"integer"}},{"in":"query","name":"area_code","description":"Customer servicable area_code","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"This is a boolen value. Select `true` to set/initialize buy now cart","schema":{"type":"boolean"}}],"query":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}},{"in":"query","name":"i","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart.","schema":{"type":"boolean"}},{"in":"query","name":"b","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items.","schema":{"type":"boolean"}},{"in":"query","name":"p","description":"This is a boolean value. Select `true` for getting a payment option in response.","schema":{"type":"boolean"}},{"in":"query","name":"assign_card_id","description":"Token of user's debit or credit card","schema":{"type":"integer"}},{"in":"query","name":"area_code","description":"Customer servicable area_code","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"This is a boolen value. Select `true` to set/initialize buy now cart","schema":{"type":"boolean"}}],"headers":[],"path":[]}""", id=id, i=i, b=b, p=p, assign_card_id=assign_card_id, area_code=area_code, buy_now=buy_now)
        query_string = await create_query_string(id=id, i=i, b=b, p=p, assign_card_id=assign_card_id, area_code=area_code, buy_now=buy_now)
        headers = {
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(urlparse(self._urls["getCart"]).netloc, "get", await create_url_without_domain("/service/application/pos/cart/v1.0/detail", id=id, i=i, b=b, p=p, assign_card_id=assign_card_id, area_code=area_code, buy_now=buy_now), query_string, headers, body, exclude_headers=exclude_headers), data=body, cookies=self._conf.cookies)
    ...
    async def getCartLastModified(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getCartLastModified"], proccessed_params="""{"required":[],"optional":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}}],"query":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}}],"headers":[],"path":[]}""", id=id)
    ...
    async def addItems(self, i=None, b=None, p=None, area_code=None, buy_now=None, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["addItems"], proccessed_params="""{"required":[],"optional":[{"in":"query","name":"i","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart.","schema":{"type":"boolean"}},{"in":"query","name":"b","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items.","schema":{"type":"boolean"}},{"in":"query","name":"p","description":"This is a boolean value. Select `true` for getting a payment option in response.","schema":{"type":"boolean"}},{"in":"query","name":"area_code","description":"Customer servicable area_code","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"This is a boolen value. Select `true` to set/initialize buy now cart","schema":{"type":"boolean"}},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"i","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart.","schema":{"type":"boolean"}},{"in":"query","name":"b","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items.","schema":{"type":"boolean"}},{"in":"query","name":"p","description":"This is a boolean value. Select `true` for getting a payment option in response.","schema":{"type":"boolean"}},{"in":"query","name":"area_code","description":"Customer servicable area_code","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"This is a boolen value. Select `true` to set/initialize buy now cart","schema":{"type":"boolean"}},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", i=i, b=b, p=p, area_code=area_code, buy_now=buy_now, id=id)
        query_string = await create_query_string(i=i, b=b, p=p, area_code=area_code, buy_now=buy_now, id=id)
        headers = {
            "Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()
        }
        if self._conf.locationDetails:
        ...
        for key, val in headers.items():
            if not key.startswith("x-fp-"):
                exclude_headers.append(key)
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(urlparse(self._urls["addItems"]).netloc, "post", await create_url_without_domain("/service/application/pos/cart/v1.0/detail", i=i, b=b, p=p, area_code=area_code, buy_now=buy_now, id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body, cookies=self._conf.cookies)
    ...
    async def updateCart(self, id=None, i=None, b=None, p=None, area_code=None, buy_now=None, body=""):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["updateCart"], proccessed_params="""{"required":[],"optional":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}},{"in":"query","name":"i","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart.","schema":{"type":"boolean"}},{"in":"query","name":"b","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items.","schema":{"type":"boolean"}},{"in":"query","name":"p","description":"This is a boolean value. Select `true` for getting a payment option in response.","schema":{"type":"boolean"}},{"in":"query","name":"area_code","description":"Customer servicable area_code","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"This is a boolen value. Select `true` to set/initialize buy now cart","schema":{"type":"boolean"}}],"query":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}},{"in":"query","name":"i","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart.","schema":{"type":"boolean"}},{"in":"query","name":"b","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items.","schema":{"type":"boolean"}},{"in":"query","name":"p","description":"This is a boolean value. Select `true` for getting a payment option in response.","schema":{"type":"boolean"}},{"in":"query","name":"area_code","description":"Customer servicable area_code","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"This is a boolen value. Select `true` to set/initialize buy now cart","schema":{"type":"boolean"}}],"headers":[],"path":[]}""", id=id, i=i, b=b, p=p, area_code=area_code, buy_now=buy_now)
        query_string = await create_query_string(id=id, i=i, b=b, p=p, area_code=area_code, buy_now=buy_now)
        headers = {
            "Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()
        }
        if self._conf.locationDetails:
        ...
        for key, val in headers.items():
            if not key.startswith("x-fp-"):
                exclude_headers.append(key)
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(urlparse(self._urls["updateCart"]).netloc, "put", await create_url_without_domain("/service/application/pos/cart/v1.0/detail", id=id, i=i, b=b, p=p, area_code=area_code, buy_now=buy_now), query_string, headers, body, exclude_headers=exclude_headers), data=body, cookies=self._conf.cookies)
    ...
    async def getItemCount(self, id=None, buy_now=None, body=""):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getItemCount"], proccessed_params="""{"required":[],"optional":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"Boolean value to get buy_now cart.","schema":{"type":"boolean"}}],"query":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"Boolean value to get buy_now cart.","schema":{"type":"boolean"}}],"headers":[],"path":[]}""", id=id, buy_now=buy_now)
    ...
    async def updateCartMeta(self, id=None, buy_now=None, body=""):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["updateCartMeta"], proccessed_params="""{"required":[],"optional":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"this is boolean to get buy_now cart","schema":{"type":"boolean"}}],"query":[{"in":"query","name":"id","description":"The unique identifier of the cart","schema":{"type":"string"}},{"in":"query","name":"buy_now","description":"this is boolean to get buy_now cart","schema":{"type":"boolean"}}],"headers":[],"path":[]}""", id=id, buy_now=buy_now)
        query_string = await create_query_string(id=id, buy_now=buy_now)
        headers = {
            "Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()
        }
