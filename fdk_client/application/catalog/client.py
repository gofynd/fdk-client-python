...
class Catalog:
    ...
    async def unfollowById(self, collection_type=None, collection_id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["unfollowById"], proccessed_params="""{"required":[{"in":"path","name":"collection_type","description":"Type of collection followed, i.e. products, brands, or collections.","schema":{"type":"string","x-not-enum":true},"required":true},{"in":"path","name":"collection_id","description":"The ID of the collection type.","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"collection_type","description":"Type of collection followed, i.e. products, brands, or collections.","schema":{"type":"string","x-not-enum":true},"required":true},{"in":"path","name":"collection_id","description":"The ID of the collection type.","schema":{"type":"string"},"required":true}]}""", serverType="application", collection_type=collection_type, collection_id=collection_id)
        query_string = await create_query_string()
    ...
    async def getFollowerCountById(self, collection_type=None, collection_id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getFollowerCountById"], proccessed_params="""{"required":[{"in":"path","name":"collection_type","description":"Type of collection, i.e. products, brands, or collections.","schema":{"type":"string","x-not-enum":true},"required":true},{"in":"path","name":"collection_id","description":"The ID of the collection type.","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"collection_type","description":"Type of collection, i.e. products, brands, or collections.","schema":{"type":"string","x-not-enum":true},"required":true},{"in":"path","name":"collection_id","description":"The ID of the collection type.","schema":{"type":"string"},"required":true}]}""", serverType="application", collection_type=collection_type, collection_id=collection_id)
        query_string = await create_query_string()
    ...
    async def getFollowIds(self, collection_type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getFollowIds"], proccessed_params="""{"required":[],"optional":[{"in":"query","name":"collection_type","description":"Type of collection, i.e. products, brands, collections.","schema":{"type":"string","x-not-enum":true},"required":false}],"query":[{"in":"query","name":"collection_type","description":"Type of collection, i.e. products, brands, collections.","schema":{"type":"string","x-not-enum":true},"required":false}],"headers":[],"path":[]}""", serverType="application", collection_type=collection_type)
