...
class Catalog:
    ...
    async def getProducts(self, q=None, f=None, filters=None, sort_on=None, page_id=None, page_size=None, page_no=None, page_type=None, show_all_variants=None, body="", request_headers:Dict={}):
        ...
        :param sort_on : The order in which the list of products should be sorted. Supported values include latest, popular, price_asc, price_dsc, discount_asc, discount_dsc. Custom sort keys configured via listing configuration (e.g., best_selling) are also supported for cohort-based sorting. : type string
        :param page_id : Page ID to retrieve next set of results. : type string
        :param page_size : The number of items to retrieve in each page. : type integer
    ...
    async def getProductPriceBySlug(self, slug=None, size=None, store_id=None, moq=None, fulfillment_option_slug=None, body="", request_headers:Dict={}):
        ...
        :param fulfillment_option_slug : specifies the fulfillment method, indicating whether an order is for home delivery or store pickup  : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getProductPriceBySlug"], proccessed_params="""{"required":[{"in":"path","name":"slug","description":"A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/.","schema":{"type":"string"},"required":true},{"in":"path","name":"size","description":"A string indicating the size of the product, e.g. S, M, XL. You can get slug value from the endpoint /service/application/catalog/v1.0/products/sizes.","schema":{"type":"string"},"required":true}],"optional":[{"in":"query","name":"store_id","description":"The ID of the store that is selling the product, e.g. 1,2,3.","schema":{"type":"integer"},"required":false},{"in":"query","name":"moq","description":"An Integer indication the Minimum Order Quantity of a product, e.g. 100.","schema":{"type":"integer"},"required":false},{"in":"query","name":"fulfillment_option_slug","description":"specifies the fulfillment method, indicating whether an order is for home delivery or store pickup ","schema":{"type":"string"},"required":false}],"query":[{"in":"query","name":"store_id","description":"The ID of the store that is selling the product, e.g. 1,2,3.","schema":{"type":"integer"},"required":false},{"in":"query","name":"moq","description":"An Integer indication the Minimum Order Quantity of a product, e.g. 100.","schema":{"type":"integer"},"required":false},{"in":"query","name":"fulfillment_option_slug","description":"specifies the fulfillment method, indicating whether an order is for home delivery or store pickup ","schema":{"type":"string"},"required":false}],"headers":[],"path":[{"in":"path","name":"slug","description":"A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/.","schema":{"type":"string"},"required":true},{"in":"path","name":"size","description":"A string indicating the size of the product, e.g. S, M, XL. You can get slug value from the endpoint /service/application/catalog/v1.0/products/sizes.","schema":{"type":"string"},"required":true}]}""", serverType="application", slug=slug, size=size, store_id=store_id, moq=moq, fulfillment_option_slug=fulfillment_option_slug)
        query_string = await create_query_string(store_id=store_id, moq=moq, fulfillment_option_slug=fulfillment_option_slug)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(urlparse(self._urls["getProductPriceBySlug"]).netloc, "get", await create_url_without_domain("/service/application/catalog/v4.0/products/{slug}/sizes/{size}/price/", slug=slug, size=size, store_id=store_id, moq=moq, fulfillment_option_slug=fulfillment_option_slug), query_string, headers, body, exclude_headers=exclude_headers), data=body, cookies=self._conf.cookies, debug=(self._conf.logLevel=="DEBUG"))

        if 200 <= int(response['status_code']) < 300:
            from .models import ProductSizePriceResponseV4
            schema = ProductSizePriceResponseV4()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getProductSellersBySlug(self, slug=None, size=None, strategy=None, fulfillment_option_slug=None, page_no=None, page_size=None, q=None, body="", request_headers:Dict={}):
        ...
        :param page_no : The page number to navigate through the given set of results. : type integer
        :param page_size : The number of items to retrieve in each page. : type integer
        :param q : Filter sellers by matching text against store name, seller name, or store code. Case-insensitive partial match. : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(api_url=self._urls["getProductSellersBySlug"], proccessed_params="""{"required":[{"in":"path","name":"slug","description":"A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/.","schema":{"type":"string"},"required":true},{"in":"path","name":"size","description":"A string indicating the size of the product, e.g. S, M, XL. You can get slug value from the endpoint /service/application/catalog/v1.0/products/sizes.","schema":{"type":"string"},"required":true}],"optional":[{"in":"query","name":"strategy","description":"Sort stores on the basis of strategy. eg, fast-delivery, low-price, optimal.","schema":{"type":"string","enum":["fast-delivery","low-price","optimal"]}},{"in":"query","name":"fulfillment_option_slug","description":"specifies the fulfillment method, indicating whether an order is for home delivery or store pickup ","schema":{"type":"string"},"required":false},{"in":"query","name":"page_no","description":"The page number to navigate through the given set of results.","schema":{"type":"integer","default":1},"required":false},{"in":"query","name":"page_size","description":"The number of items to retrieve in each page.","schema":{"type":"integer","default":12},"required":false},{"in":"query","name":"q","description":"Filter sellers by matching text against store name, seller name, or store code. Case-insensitive partial match.","schema":{"type":"string"},"required":false}],"query":[{"in":"query","name":"strategy","description":"Sort stores on the basis of strategy. eg, fast-delivery, low-price, optimal.","schema":{"type":"string","enum":["fast-delivery","low-price","optimal"]}},{"in":"query","name":"fulfillment_option_slug","description":"specifies the fulfillment method, indicating whether an order is for home delivery or store pickup ","schema":{"type":"string"},"required":false},{"in":"query","name":"page_no","description":"The page number to navigate through the given set of results.","schema":{"type":"integer","default":1},"required":false},{"in":"query","name":"page_size","description":"The number of items to retrieve in each page.","schema":{"type":"integer","default":12},"required":false},{"in":"query","name":"q","description":"Filter sellers by matching text against store name, seller name, or store code. Case-insensitive partial match.","schema":{"type":"string"},"required":false}],"headers":[],"path":[{"in":"path","name":"slug","description":"A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/.","schema":{"type":"string"},"required":true},{"in":"path","name":"size","description":"A string indicating the size of the product, e.g. S, M, XL. You can get slug value from the endpoint /service/application/catalog/v1.0/products/sizes.","schema":{"type":"string"},"required":true}]}""", serverType="application", slug=slug, size=size, strategy=strategy, fulfillment_option_slug=fulfillment_option_slug, page_no=page_no, page_size=page_size, q=q)
        query_string = await create_query_string(strategy=strategy, fulfillment_option_slug=fulfillment_option_slug, page_no=page_no, page_size=page_size, q=q)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(urlparse(self._urls["getProductSellersBySlug"]).netloc, "get", await create_url_without_domain("/service/application/catalog/v4.0/products/{slug}/sizes/{size}/sellers/", slug=slug, size=size, strategy=strategy, fulfillment_option_slug=fulfillment_option_slug, page_no=page_no, page_size=page_size, q=q), query_string, headers, body, exclude_headers=exclude_headers), data=body, cookies=self._conf.cookies, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def listCountryCurrencyMappings(self, body="", request_headers:Dict={}):
        ...
        # Parameter validation
        schema = CatalogValidator.listCountryCurrencyMappings()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(api_url=self._urls["listCountryCurrencyMappings"], proccessed_params="""{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", serverType="application" )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(urlparse(self._urls["listCountryCurrencyMappings"]).netloc, "get", await create_url_without_domain("/service/application/catalog/v1.0/available-countries/", ), query_string, headers, body, exclude_headers=exclude_headers), data=body, cookies=self._conf.cookies, debug=(self._conf.logLevel=="DEBUG"))

        if 200 <= int(response['status_code']) < 300:
            from .models import AvailableCountrySchema
            schema = AvailableCountrySchema()
            try:
                schema.load(response["json"])
            except Exception as e:
                print("Response Validation failed for listCountryCurrencyMappings")
                print(e)
