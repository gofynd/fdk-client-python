...
class DeleteCartDetail(BaseSchema):
    pass


class CartItemCount(BaseSchema):
    pass
...
class BulkPriceResponseObject(BaseSchema):
    pass


class RewardPointRequestObject(BaseSchema):
    pass
...
class GetAddressesResponseObject(BaseSchema):
    pass
...
class SelectCartAddressRequestObject(BaseSchema):
    pass
...
class ShipmentResponseObject(BaseSchema):
    pass
...
class CartShipments(BaseSchema):
    pass
...
class CartCheckoutDetailRequestObject(BaseSchema):
    pass
...
class CartMetaRequestObject(BaseSchema):
    pass
...
class PromotionPaymentOffersResponseObject(BaseSchema):
    pass
...
class CartCheckoutDetailV2RequestObject(BaseSchema):
    pass
...
class CartConfigDetailResponseObject(BaseSchema):
    pass
...
class CartProductInfo(BaseSchema):
    ...
    charges = fields.List(fields.Dict(required=False), required=False)
...
class CartShipments(BaseSchema):
    ...
    shipments = fields.List(fields.Nested(ShipmentResponseObject, required=False), required=False)
