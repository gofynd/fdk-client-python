...
class CartConfigListObj(BaseSchema):
    pass


class CartConfigListResponse(BaseSchema):
    pass
...
class CartConfigListResponse(BaseSchema):
    ...
    data = fields.List(fields.Nested(CartConfigListObj, required=False), required=False)
