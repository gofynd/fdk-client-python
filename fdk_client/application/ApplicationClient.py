...
class Catalog:
    ...
    async def getProductBundlesBySlug(self, slug=None, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/catalog/v1.0/product-grouping/", """{"required":[],"optional":[{"in":"query","name":"slug","description":"Product slug for which bundles need to be fetched.","schema":{"type":"string"},"required":false},{"in":"query","name":"id","description":"Product uid","schema":{"type":"string"},"required":false}],"query":[{"in":"query","name":"slug","description":"Product slug for which bundles need to be fetched.","schema":{"type":"string"},"required":false},{"in":"query","name":"id","description":"Product uid","schema":{"type":"string"},"required":false}],"headers":[]}""", slug=slug, id=id)
...
class Content:
    ...
    async def getDataLoaders(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/data-loader", """{"required":[],"optional":[],"query":[],"headers":[]}""", )
        query_string = await create_query_string()
...
This operation will return the URL of the uploaded file.
    ...
    async def signUrls(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/assets/v1.0/sign-urls/", """{"required":[],"optional":[],"query":[],"headers":[]}""", )
        query_string = await create_query_string()
...
class Payment:
    ...
    async def getEpaylaterBannerDetails(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/epaylater/banner", """{"required":[],"optional":[],"query":[],"headers":[]}""", )
        query_string = await create_query_string()
    ...
    async def CustomerOnboard(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/credit-onboard/", """{"required":[],"optional":[],"query":[],"headers":[]}""", )
        query_string = await create_query_string()
