...
class Order:
    def __init__(self, config):
        ...
        self._relativeUrls = {
            ...
            "updateShipmentExternal": "/service/application/order/v1.0/orders/shipments/{shipment_id}/status"
    ...
    async def updateShipmentExternal(self, shipment_id=None, body=""):
        ...
        # Body validation
        from .models import UpdateShipmentExternalRequest
