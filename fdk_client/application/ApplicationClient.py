...
class Catalog:
    ...
    async def getDepartments(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/catalog/v1.0/departments/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
    ...
    async def getProductBundlesBySlug(self, slug=None, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/catalog/v1.0/product-grouping/", """{"required":[],"optional":[{"in":"query","name":"slug","description":"Product slug for which bundles need to be fetched.","schema":{"type":"string"},"required":false},{"in":"query","name":"id","description":"Product uid","schema":{"type":"string"},"required":false}],"query":[{"in":"query","name":"slug","description":"Product slug for which bundles need to be fetched.","schema":{"type":"string"},"required":false},{"in":"query","name":"id","description":"Product uid","schema":{"type":"string"},"required":false}],"headers":[],"path":[]}""", slug=slug, id=id)
        query_string = await create_query_string(slug=slug, id=id)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/catalog/v1.0/product-grouping/", slug=slug, id=id), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
...
class Cart:
    ...
    async def getCart(self, id=None, i=None, b=None, assign_card_id=None, area_code=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/detail", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"assign_card_id","schema":{"type":"integer","description":"Token of user's debit or credit card"}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"assign_card_id","schema":{"type":"integer","description":"Token of user's debit or credit card"}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"headers":[],"path":[]}""", id=id, i=i, b=b, assign_card_id=assign_card_id, area_code=area_code)
        query_string = await create_query_string(id=id, i=i, b=b, assign_card_id=assign_card_id, area_code=area_code)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/cart/v1.0/detail", id=id, i=i, b=b, assign_card_id=assign_card_id, area_code=area_code), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def getCartLastModified(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/detail", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", id=id)
    ...
    async def addItems(self, i=None, b=None, area_code=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/detail", """{"required":[],"optional":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"query":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"headers":[],"path":[]}""", i=i, b=b, area_code=area_code)
        query_string = await create_query_string(i=i, b=b, area_code=area_code)
        return await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain("/service/application/cart/v1.0/detail", i=i, b=b, area_code=area_code), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def updateCart(self, id=None, i=None, b=None, area_code=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/detail", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"headers":[],"path":[]}""", id=id, i=i, b=b, area_code=area_code)
        query_string = await create_query_string(id=id, i=i, b=b, area_code=area_code)
        return await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain("/service/application/cart/v1.0/detail", id=id, i=i, b=b, area_code=area_code), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def getItemCount(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/basic", """{"required":[],"optional":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}}],"query":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def getCoupons(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/coupon", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart."}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart."}}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def applyCoupon(self, i=None, b=None, p=None, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/coupon", """{"required":[],"optional":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"p","schema":{"type":"boolean","description":"This is a boolean value. Select `true` for getting a payment option in response."}},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"p","schema":{"type":"boolean","description":"This is a boolean value. Select `true` for getting a payment option in response."}},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", i=i, b=b, p=p, id=id)
    ...
    async def addAddress(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/address", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def updateAddress(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/address/{id}", """{"required":[{"name":"id","description":"ID allotted to the selected address","schema":{"type":"string"},"in":"path","required":true}],"optional":[],"query":[],"headers":[],"path":[{"name":"id","description":"ID allotted to the selected address","schema":{"type":"string"},"in":"path","required":true}]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def selectPaymentMode(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/payment", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def checkoutCart(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/checkout", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def updateCartMeta(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/meta", """{"required":[],"optional":[{"name":"id","description":"The unique identifier of the cart","schema":{"type":"string"},"in":"query"}],"query":[{"name":"id","description":"The unique identifier of the cart","schema":{"type":"string"},"in":"query"}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def getCartShareLink(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/share-cart", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getCartSharedItems(self, token=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/cart/v1.0/share-cart/{token}", """{"required":[{"name":"token","description":"Token of the shared short link","schema":{"type":"string"},"in":"path","required":true}],"optional":[],"query":[],"headers":[],"path":[{"name":"token","description":"Token of the shared short link","schema":{"type":"string"},"in":"path","required":true}]}""", token=token)
...
class Lead:
    ...
    async def createTicket(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/lead/v1.0/ticket/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def submitCustomForm(self, slug=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/lead/v1.0/form/{slug}/submit", """{"required":[{"name":"slug","in":"path","description":"Slug of form whose response is getting submitted","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"slug","in":"path","description":"Slug of form whose response is getting submitted","required":true,"schema":{"type":"string"}}]}""", slug=slug)
        query_string = await create_query_string(slug=slug)
    ...
    async def getTokenForVideoRoom(self, unique_name=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/lead/v1.0/video/room/{unique_name}/token", """{"required":[{"name":"unique_name","in":"path","description":"Unique name of Video Room","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"unique_name","in":"path","description":"Unique name of Video Room","required":true,"schema":{"type":"string"}}]}""", unique_name=unique_name)
        query_string = await create_query_string(unique_name=unique_name)
...
class Theme:
    ...
    async def getAppliedTheme(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/theme/v1.0/applied-theme", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getThemeForPreview(self, theme_id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/theme/v1.0/{theme_id}/preview", """{"required":[{"name":"theme_id","in":"path","description":"ID of the theme to be retrieved","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"theme_id","in":"path","description":"ID of the theme to be retrieved","required":true,"schema":{"type":"string"}}]}""", theme_id=theme_id)
        query_string = await create_query_string(theme_id=theme_id)
...
class User:
    ...
    async def loginWithEmailAndPassword(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/login/password", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def forgotPassword(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/login/password/reset/forgot", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def sendResetToken(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/login/password/reset/token", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def loginWithToken(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/login/token", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def verifyEmail(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/verify/email", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def verifyMobile(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/verify/mobile", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def hasPassword(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/has-password", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def updatePassword(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/password", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def logout(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/logout", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getLoggedInUser(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/session", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getListOfActiveSessions(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/sessions", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def setMobileNumberAsPrimary(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/profile/v1.0/mobile/primary", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def setEmailAsPrimary(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/profile/v1.0/email/primary", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
...
class Content:
    ...
    async def getAnnouncements(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/announcements", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getDataLoaders(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/data-loader", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/content/v1.0/data-loader", ), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def getFaqs(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/faq", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getFaqCategories(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/faq/categories", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getLandingPage(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/landing-page", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getLegalInformation(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/legal", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getSEOConfiguration(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/seo", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getSupportInformation(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/support", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getTags(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/tags", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
...
class Communication:
    ...
    async def getCommunicationConsent(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/communication/v1.0/consent", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def upsertAppPushtoken(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/communication/v1.0/pn-token", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
...
class Share:
    ...
    async def getApplicationQRCode(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/share/v1.0/qr/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def createShortLink(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/share/v1.0/links/short-link/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
...
class Configuration:
    ...
    async def getApplication(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/application", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getOwnerInfo(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/about", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getBasicDetails(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/detail", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getIntegrationTokens(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/token", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getOrderingStores(self, page_no=None, page_size=None, q=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/ordering-store/stores", """{"required":[],"optional":[{"name":"page_no","in":"query","schema":{"type":"integer"},"description":"The page number to navigate through the given set of results. Default value is 1."},{"name":"page_size","in":"query","schema":{"type":"integer"},"description":"The number of items to retrieve in each page. Default value is 10."},{"name":"q","in":"query","schema":{"type":"string"},"description":"Store code or name of the ordering store."}],"query":[{"name":"page_no","in":"query","schema":{"type":"integer"},"description":"The page number to navigate through the given set of results. Default value is 1."},{"name":"page_size","in":"query","schema":{"type":"integer"},"description":"The number of items to retrieve in each page. Default value is 10."},{"name":"q","in":"query","schema":{"type":"string"},"description":"Store code or name of the ordering store."}],"headers":[],"path":[]}""", page_no=page_no, page_size=page_size, q=q)
    ...
    async def getStoreDetailById(self, store_id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/ordering-store/stores/{store_id}", """{"required":[{"name":"store_id","in":"path","required":true,"description":"Store uid","schema":{"type":"integer"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"store_id","in":"path","required":true,"description":"Store uid","schema":{"type":"integer"}}]}""", store_id=store_id)
    ...
    async def getFeatures(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/feature", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getContactInfo(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/information", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getCurrencies(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/currencies", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getAppCurrencies(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/currency", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getLanguages(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/languages", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getOrderingStoreCookie(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/ordering-store/select", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getAppStaffs(self, order_incent=None, ordering_store=None, user=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/configuration/v1.0/staff", """{"required":[],"optional":[{"name":"order_incent","in":"query","description":"This is a boolean value. Select `true` to retrieve the staff members eligible for getting incentives on orders.","required":false,"schema":{"type":"boolean","example":true}},{"name":"ordering_store","in":"query","description":"ID of the ordering store. Helps in retrieving staff members working at a particular ordering store.","required":false,"schema":{"type":"integer","example":12}},{"name":"user","in":"query","description":"Mongo ID of the staff. Helps in retrieving the details of a particular staff member.","required":false,"schema":{"type":"string","example":"5e6b6ae7d450b1219ffdf3b2"}}],"query":[{"name":"order_incent","in":"query","description":"This is a boolean value. Select `true` to retrieve the staff members eligible for getting incentives on orders.","required":false,"schema":{"type":"boolean","example":true}},{"name":"ordering_store","in":"query","description":"ID of the ordering store. Helps in retrieving staff members working at a particular ordering store.","required":false,"schema":{"type":"integer","example":12}},{"name":"user","in":"query","description":"Mongo ID of the staff. Helps in retrieving the details of a particular staff member.","required":false,"schema":{"type":"string","example":"5e6b6ae7d450b1219ffdf3b2"}}],"headers":[],"path":[]}""", order_incent=order_incent, ordering_store=ordering_store, user=user)
...
class Payment:
    ...
    async def attachCardToCustomer(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/card/attach", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getActiveCardAggregator(self, refresh=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/card/aggregator", """{"required":[],"optional":[{"in":"query","name":"refresh","schema":{"type":"boolean","default":false,"description":"This is a boolean value. Select `true` to remove temporary cache files on payment gateway and replace with the latest one."}}],"query":[{"in":"query","name":"refresh","schema":{"type":"boolean","default":false,"description":"This is a boolean value. Select `true` to remove temporary cache files on payment gateway and replace with the latest one."}}],"headers":[],"path":[]}""", refresh=refresh)
    ...
    async def deleteUserCard(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/card/remove", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def verifyCustomerForPayment(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/payment/customer/validation", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def verifyAndChargePayment(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/payment/confirm/charge", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def initialisePayment(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/payment/request", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def checkAndUpdatePaymentStatus(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/payment/confirm/polling", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getRupifiBannerDetails(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/rupifi/banner", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getEpaylaterBannerDetails(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/epaylater/banner", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/payment/v1.0/epaylater/banner", ), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def getActiveRefundTransferModes(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/refund/transfer-mode", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def verifyIfscCode(self, ifsc_code=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/ifsc-code/verify", """{"required":[],"optional":[{"in":"query","name":"ifsc_code","schema":{"type":"string"},"description":"A 11-digit alphanumeric code that uniquely identifies a bank branch."}],"query":[{"in":"query","name":"ifsc_code","schema":{"type":"string"},"description":"A 11-digit alphanumeric code that uniquely identifies a bank branch."}],"headers":[],"path":[]}""", ifsc_code=ifsc_code)
    ...
    async def verifyOtpAndAddBeneficiaryForBank(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/refund/verification/bank", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def addBeneficiaryDetails(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/refund/account", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def addRefundBankAccountUsingOTP(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/refund/account/otp", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def verifyOtpAndAddBeneficiaryForWallet(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/refund/verification/wallet", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def updateDefaultBeneficiary(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/refund/beneficiary/default", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def customerCreditSummary(self, aggregator=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/payment/credit-summary/", """{"required":[],"optional":[{"in":"query","name":"aggregator","schema":{"type":"string","description":"This is a String value that contains aggregator name as value."}}],"query":[{"in":"query","name":"aggregator","schema":{"type":"string","description":"This is a String value that contains aggregator name as value."}}],"headers":[],"path":[]}""", aggregator=aggregator)
        query_string = await create_query_string(aggregator=aggregator)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/payment/v1.0/payment/credit-summary/", aggregator=aggregator), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def redirectToAggregator(self, source=None, aggregator=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/payment/redirect-to-aggregator/", """{"required":[],"optional":[{"name":"source","in":"query","description":"This is a String value that contains callback URL as value.","schema":{"type":"string"}},{"name":"aggregator","in":"query","description":"This is a String value that contains aggregator name as value.","schema":{"type":"string"}}],"query":[{"name":"source","in":"query","description":"This is a String value that contains callback URL as value.","schema":{"type":"string"}},{"name":"aggregator","in":"query","description":"This is a String value that contains aggregator name as value.","schema":{"type":"string"}}],"headers":[],"path":[]}""", source=source, aggregator=aggregator)
        query_string = await create_query_string(source=source, aggregator=aggregator)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/payment/v1.0/payment/redirect-to-aggregator/", source=source, aggregator=aggregator), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def checkCredit(self, aggregator=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/check-credits/", """{"required":[],"optional":[{"in":"query","name":"aggregator","schema":{"type":"string","description":"This is a String value that contains aggregator name as value."}}],"query":[{"in":"query","name":"aggregator","schema":{"type":"string","description":"This is a String value that contains aggregator name as value."}}],"headers":[],"path":[]}""", aggregator=aggregator)
        query_string = await create_query_string(aggregator=aggregator)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/payment/v1.0/check-credits/", aggregator=aggregator), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def customerOnboard(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/payment/v1.0/credit-onboard/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
        return await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain("/service/application/payment/v1.0/credit-onboard/", ), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
...
class Order:
    ...
    async def getPosOrderById(self, order_id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/order/v1.0/orders/pos-order/{order_id}", """{"required":[{"name":"order_id","in":"path","description":"A unique number used for identifying and tracking your orders.","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"order_id","in":"path","description":"A unique number used for identifying and tracking your orders.","required":true,"schema":{"type":"string"}}]}""", order_id=order_id)
        query_string = await create_query_string(order_id=order_id)
...
class Rewards:
    ...
    async def getPointsOnProduct(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/rewards/v1.0/catalogue/offer/order/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getOrderDiscount(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/rewards/v1.0/user/offers/order-discount/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getUserPoints(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/rewards/v1.0/user/points/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getUserReferralDetails(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/rewards/v1.0/user/referral/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def redeemReferralCode(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/rewards/v1.0/user/referral/redeem/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
...
class Feedback:
    ...
    async def createAbuseReport(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/abuse", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def createAttribute(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/attributes", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def createComment(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/comment", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def deleteMedia(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/media/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
        return await AiohttpHelper().aiohttp_request("DELETE", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "delete", await create_url_without_domain("/service/application/feedback/v1.0/media/", ), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def createReview(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/review/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def createQuestion(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/template/qna/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def createVote(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/feedback/v1.0/vote/", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
...
class PosCart:
    ...
    async def getCart(self, id=None, i=None, b=None, assign_card_id=None, area_code=None, body=""):
        ...
        query_string = await create_query_string(id=id, i=i, b=b, assign_card_id=assign_card_id, area_code=area_code)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/pos/cart/v1.0/detail", id=id, i=i, b=b, assign_card_id=assign_card_id, area_code=area_code), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def addItems(self, i=None, b=None, area_code=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/detail", """{"required":[],"optional":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"query":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"headers":[],"path":[]}""", i=i, b=b, area_code=area_code)
        query_string = await create_query_string(i=i, b=b, area_code=area_code)
        return await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain("/service/application/pos/cart/v1.0/detail", i=i, b=b, area_code=area_code), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def updateCart(self, id=None, i=None, b=None, area_code=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/detail", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"area_code","schema":{"type":"string","description":"Customer servicable area_code"}}],"headers":[],"path":[]}""", id=id, i=i, b=b, area_code=area_code)
        query_string = await create_query_string(id=id, i=i, b=b, area_code=area_code)
        return await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain("/service/application/pos/cart/v1.0/detail", id=id, i=i, b=b, area_code=area_code), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}, body, exclude_headers=["Authorization"]), data=body)
    ...
    async def addAddress(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/address", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def updateAddress(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/address/{id}", """{"required":[{"name":"id","description":"ID allotted to the selected address","schema":{"type":"string"},"in":"path","required":true}],"optional":[],"query":[],"headers":[],"path":[{"name":"id","description":"ID allotted to the selected address","schema":{"type":"string"},"in":"path","required":true}]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def selectPaymentMode(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/payment", """{"required":[],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def checkoutCart(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/checkout", """{"required":[],"optional":[{"in":"query","name":"id","required":false,"schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"id","required":false,"schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def updateCartMeta(self, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/meta", """{"required":[],"optional":[{"name":"id","description":"The unique identifier of the cart","schema":{"type":"string"},"in":"query"}],"query":[{"name":"id","description":"The unique identifier of the cart","schema":{"type":"string"},"in":"query"}],"headers":[],"path":[]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def getAvailableDeliveryModes(self, area_code=None, id=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/available-delivery-mode", """{"required":[{"in":"query","name":"area_code","required":true,"schema":{"type":"string","description":"The PIN Code of the destination address, e.g. 400059"}}],"optional":[{"name":"id","in":"query","required":false,"schema":{"type":"string","description":"The unique identifier of the cart"}}],"query":[{"in":"query","name":"area_code","required":true,"schema":{"type":"string","description":"The PIN Code of the destination address, e.g. 400059"}},{"name":"id","in":"query","required":false,"schema":{"type":"string","description":"The unique identifier of the cart"}}],"headers":[],"path":[]}""", area_code=area_code, id=id)
    ...
    async def getStoreAddressByUid(self, store_uid=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/store-address", """{"required":[{"in":"query","name":"store_uid","required":true,"schema":{"type":"integer","description":"The unique identifier of the store"}}],"optional":[],"query":[{"in":"query","name":"store_uid","required":true,"schema":{"type":"integer","description":"The unique identifier of the store"}}],"headers":[],"path":[]}""", store_uid=store_uid)
    ...
    async def getCartShareLink(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/share-cart", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
    ...
    async def getCartSharedItems(self, token=None, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/pos/cart/v1.0/share-cart/{token}", """{"required":[{"name":"token","description":"Token of the shared short link","schema":{"type":"string"},"in":"path","required":true}],"optional":[],"query":[],"headers":[],"path":[{"name":"token","description":"Token of the shared short link","schema":{"type":"string"},"in":"path","required":true}]}""", token=token)
        query_string = await create_query_string(token=token)
...
class Logistic:
    ...
    async def getTatProduct(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/logistics/v1.0", """{"required":[],"optional":[],"query":[],"headers":[],"path":[]}""", )
        query_string = await create_query_string()
