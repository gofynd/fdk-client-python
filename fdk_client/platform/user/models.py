...
class UserGroupCategoriesResponseSchema(BaseSchema):
    pass


class UserGroupCategory(BaseSchema):
    pass
...
class UserGroupCategoriesResponseSchema(BaseSchema):
    ...
    items = fields.List(fields.Nested(UserGroupCategory, required=False), required=False)
