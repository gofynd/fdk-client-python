...
class Webhook:
    ...
    async def manualRetryOfFailedEvent(self, body=""):
    ...
    async def getEventCounts(self, body=""):
    ...
    async def getManualRetryStatus(self, ):
    ...
    async def manualRetryCancel(self, ):
    ...
    async def getDeliveryReports(self, body=""):
    ...
    async def downloadDeliveryReport(self, body=""):
    ...
    async def pingWebhook(self, body=""):
    ...
    async def getReportFilters(self, body=""):
    ...
    async def getHistoricalReports(self, body=""):
    ...
    async def cancelJobByName(self, filename=None):
