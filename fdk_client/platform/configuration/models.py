...
class DomainStoreInStoreConfig(BaseSchema):
    pass


class ThemeStoreInStoreConfig(BaseSchema):
    pass


class StoreInStoreConfig(BaseSchema):
    pass
...
class ThemeStoreInStoreConfig(BaseSchema):
    ...
    theme_name = fields.Str(required=False)
...
class StoreInStoreConfig(BaseSchema):
    ...
    domain = fields.Nested(DomainStoreInStoreConfig, required=False)
    
    theme = fields.Nested(ThemeStoreInStoreConfig, required=False)
