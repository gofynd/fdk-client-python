...
class Plan(BaseSchema):
    ...
    fee_components = fields.List(fields.Raw(required=False), required=False)
    ...
    company_ids = fields.List(fields.Raw(required=False), required=False)
...
class CreditTransaction(BaseSchema):
    ...
    is_test = fields.Raw(required=False)
...
class SetupIntentData(BaseSchema):
    ...
    customer = fields.Raw(required=False)
