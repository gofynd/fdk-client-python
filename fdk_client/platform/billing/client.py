...
class Billing:
    ...
    async def getChargeDetails(self, extension_id=None, charge_id=None, request_headers:Dict={}):
        ...
        :param extension_id : The unique identifier of the extension : type string
        :param charge_id : The unique identifier of the entity charge in the system. : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/billing/v1.0/company/{self._conf.companyId}/extension/{extension_id}/charge/{charge_id}", """{"required":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}},{"in":"path","name":"charge_id","description":"The unique identifier of the entity charge in the system.","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}},{"in":"path","name":"charge_id","description":"The unique identifier of the entity charge in the system.","required":true,"schema":{"type":"string"}}]}""", serverType="platform", extension_id=extension_id, charge_id=charge_id)
    ...
    async def getSubscriptionCharge(self, extension_id=None, subscription_id=None, request_headers:Dict={}):
        ...
        :param extension_id : The unique identifier of the extension : type string
        :param subscription_id : The unique identifier of the subscription : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/billing/v1.0/company/{self._conf.companyId}/extension/{extension_id}/subscription/{subscription_id}", """{"required":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}},{"in":"path","name":"subscription_id","description":"The unique identifier of the subscription","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}},{"in":"path","name":"subscription_id","description":"The unique identifier of the subscription","required":true,"schema":{"type":"string"}}]}""", serverType="platform", extension_id=extension_id, subscription_id=subscription_id)
        query_string = await create_query_string()
    ...
    async def cancelSubscriptionCharge(self, extension_id=None, subscription_id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/billing/v1.0/company/{self._conf.companyId}/extension/{extension_id}/subscription/{subscription_id}/cancel", """{"required":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}},{"in":"path","name":"subscription_id","description":"The unique identifier of the subscription","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}},{"in":"path","name":"subscription_id","description":"The unique identifier of the subscription","required":true,"schema":{"type":"string"}}]}""", serverType="platform", extension_id=extension_id, subscription_id=subscription_id)
        query_string = await create_query_string()
    ...
    async def createOneTimeCharge(self, extension_id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/billing/v1.0/company/{self._conf.companyId}/extension/{extension_id}/one_time_charge", """{"required":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"string"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}}]}""", serverType="platform", extension_id=extension_id)
        query_string = await create_query_string()
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import CreateOneTimeChargeResponseSchemas
            schema = CreateOneTimeChargeResponseSchemas()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def createSubscriptionCharge(self, extension_id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/billing/v1.0/company/{self._conf.companyId}/extension/{extension_id}/subscription", """{"required":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"integer"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","required":true,"schema":{"type":"integer"}},{"in":"path","name":"extension_id","description":"The unique identifier of the extension","required":true,"schema":{"type":"string"}}]}""", serverType="platform", extension_id=extension_id)
        query_string = await create_query_string()
