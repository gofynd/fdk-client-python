...
class BulkInventoryJob(BaseSchema):
    pass
...
class CreateTaxComponentNameRequestSchema(BaseSchema):
    pass
...
class LocationQuantityRequestSchema(BaseSchema):
    ...
    damaged_quantity = fields.Int(required=False)
