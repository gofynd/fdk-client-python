...
class SearchErrorResponse(BaseSchema):
    pass
...
class SearchKeywordResult1(BaseSchema):
    pass
...
class UpdateAutocompleteWordData(BaseSchema):
    pass
...
class AutocompletePageAction1(BaseSchema):
    pass


class AutocompleteAction1(BaseSchema):
    pass
...
class AutocompleteResult1(BaseSchema):
    pass
...
class RerankingAttribute(BaseSchema):
    pass


class BoostBury(BaseSchema):
    pass


class SearchRerankingModel(BaseSchema):
    pass


class SearchRerankListing(BaseSchema):
    pass


class RerankingAttribute1(BaseSchema):
    pass


class BoostBury1(BaseSchema):
    pass


class CreateSearchReranking(BaseSchema):
    pass


class DeleteRerankResponse(BaseSchema):
    pass
...
class CollectionErrorResponse(BaseSchema):
    pass
...
class CollectionUpdateImage(BaseSchema):
    pass


class CollectionUpdateBanner(BaseSchema):
    pass


class CollectionUpdateResponse(BaseSchema):
    pass
...
class CrossSellingDataResponse(BaseSchema):
    pass
...
class DepartmentPageResponse(BaseSchema):
    pass
...
class DepartmentCreateError(BaseSchema):
    pass
...
class StoreAssign(BaseSchema):
    pass


class StoreAssignError(BaseSchema):
    pass
...
class CreateSearchKeyword(BaseSchema):
    ...
    result = fields.Nested(SearchKeywordResult1, required=False)
...
class AutocompleteAction1(BaseSchema):
    ...
    page = fields.Nested(AutocompletePageAction1, required=False)
...
class AutocompleteResult1(BaseSchema):
    ...
    action = fields.Nested(AutocompleteAction1, required=False)
...
class CreateAutocompleteKeyword(BaseSchema):
    ...
    results = fields.List(fields.Nested(AutocompleteResult1, required=False), required=False)
...
class BoostBury(BaseSchema):
    ...
    boost = fields.List(fields.Nested(RerankingAttribute, required=False), required=False)
...
class SearchRerankingModel(BaseSchema):
    ...
    ranking = fields.Nested(BoostBury, required=False)
...
class SearchRerankListing(BaseSchema):
    ...
    items = fields.List(fields.Nested(SearchRerankingModel, required=False), required=False)
...
class BoostBury1(BaseSchema):
    ...
    boost = fields.List(fields.Nested(RerankingAttribute1, required=False), required=False)
...
class CreateSearchReranking(BaseSchema):
    ...
    ranking = fields.Nested(BoostBury1, required=False)
...
class CollectionUpdateBanner(BaseSchema):
    ...
    portrait = fields.Nested(CollectionUpdateImage, required=False)
    
    landscape = fields.Nested(CollectionUpdateImage, required=False)
...
class CollectionUpdateResponse(BaseSchema):
    ...
    logo = fields.Nested(CollectionUpdateImage, required=False)
    
    banners = fields.Nested(CollectionUpdateBanner, required=False)
...
class ProductListingDetail(BaseSchema):
    ...
    medias = fields.List(fields.Nested(Media2, required=False), required=False)
...
class DepartmentListResponse(BaseSchema):
    ...
    page = fields.Nested(DepartmentPageResponse, required=False)
    
    items = fields.List(fields.Nested(DepartmentModel, required=False), required=False)
...
class Category(BaseSchema):
    ...
    media = fields.Nested(Media3, required=False)
...
class ProductSchemaV2(BaseSchema):
    ...
    media = fields.List(fields.Nested(Media2, required=False), required=False)
...
class StoreAssignResponse(BaseSchema):
    ...
    items = fields.List(fields.Nested(StoreAssign, required=False), required=False)
    
    error = fields.Nested(StoreAssignError, required=False)
