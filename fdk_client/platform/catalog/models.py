...
class CollectionScheduleStartEnd(BaseSchema):
    pass
...
class CollectionActionPageQuery(BaseSchema):
    pass


class CollectionActionPage(BaseSchema):
    pass
...
class CollectionSchedule1(BaseSchema):
    pass


class CollectionBadge1(BaseSchema):
    pass
...
class ArticleAssignment2(BaseSchema):
    pass
...
class CollectionSchedule(BaseSchema):
    ...
    next_schedule = fields.List(fields.Nested(CollectionScheduleStartEnd, required=False), required=False)
...
class CollectionActionPage(BaseSchema):
    ...
    query = fields.Nested(CollectionActionPageQuery, required=False)
...
class GetCollectionDetailNest(BaseSchema):
    ...
    action = fields.Nested(CollectionActionPage, required=False)
...
class CreateCollection(BaseSchema):
    ...
    _schedule = fields.Nested(CollectionSchedule1, required=False)
    ...
    badge = fields.Nested(CollectionBadge1, required=False)
...
class StoreAssignResponse(BaseSchema):
    ...
    article_assignment = fields.Nested(ArticleAssignment2, required=False)
