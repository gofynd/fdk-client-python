...
class Catalog:
    ...
    async def getApplicationBrandListing(self, page_no=None, page_size=None, q=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/brand", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"1"},"failure":{"value":"1"}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}}],"optional":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":0}}},{"description":"Search query with brand name.Use this parameter to search brands by  brand name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"},"failure":{"value":"test"}}}],"query":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":0}}},{"description":"Search query with brand name.Use this parameter to search brands by  brand name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"},"failure":{"value":"test"}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"1"},"failure":{"value":"1"}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}}]}""", page_no=page_no, page_size=page_size, q=q)
    ...
    async def updateAppBrand(self, brand_uid=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/brand/{brand_uid}", """{"required":[{"description":"Id of the company associated to brand custom json.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":99}}},{"description":"application id for which the custom_json is associated.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"brand id for which the custom_json is associated.","in":"path","name":"brand_uid","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":99}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"Id of the company associated to brand custom json.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":99}}},{"description":"application id for which the custom_json is associated.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"brand id for which the custom_json is associated.","in":"path","name":"brand_uid","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":99}}}]}""", brand_uid=brand_uid)
    ...
    async def getApplicationBrands(self, department=None, page_no=None, page_size=None, q=None, brand_id=None, request_headers:Dict={}):
        ...
        :param page_size : Number of items to retrieve in each page. Default is 12. : type integer
        :param q : Search query with brand name.Use this parameter to search brands by  brand name. : type string
        :param brand_id : Helps to sort the brands list on the basis of uid list. : type integer
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/brands", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}}],"optional":[{"description":"The name of the department. Use this parameter to filter products by a particular department. See below the list of available departments. You can retrieve available departments from the **v1.0/departments/** API","in":"query","name":"department","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"fashiontest"},"failure":{"value":"invalid"}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Search query with brand name.Use this parameter to search brands by  brand name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"},"failure":{"value":"test"}}},{"description":"Helps to sort the brands list on the basis of uid list.","in":"query","name":"brand_id","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":2},"failure":{"value":2}}}],"query":[{"description":"The name of the department. Use this parameter to filter products by a particular department. See below the list of available departments. You can retrieve available departments from the **v1.0/departments/** API","in":"query","name":"department","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"fashiontest"},"failure":{"value":"invalid"}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Search query with brand name.Use this parameter to search brands by  brand name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"},"failure":{"value":"test"}}},{"description":"Helps to sort the brands list on the basis of uid list.","in":"query","name":"brand_id","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":2},"failure":{"value":2}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}}]}""", department=department, page_no=page_no, page_size=page_size, q=q, brand_id=brand_id)
    ...
    async def getCategories(self, department=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/categories", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}}],"optional":[{"description":"The name of the department. Use this parameter to filter products by a particular department. See below the list of available departments. You can retrieve available departments from the **v1.0/departments/** API","in":"query","name":"department","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"women"}}}],"query":[{"description":"The name of the department. Use this parameter to filter products by a particular department. See below the list of available departments. You can retrieve available departments from the **v1.0/departments/** API","in":"query","name":"department","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"women"}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}}]}""", department=department)
    ...
    async def getApplicationCategoryListing(self, department_id=None, page_no=None, page_size=None, q=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/category", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"}}}],"optional":[{"description":"A `department_id` is a unique identifier for a particular department.","in":"query","name":"department_id","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search query with brand name.Use this parameter to search brands by  brand name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}}],"query":[{"description":"A `department_id` is a unique identifier for a particular department.","in":"query","name":"department_id","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search query with brand name.Use this parameter to search brands by  brand name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"}}}]}""", department_id=department_id, page_no=page_no, page_size=page_size, q=q)
    ...
    async def getAllCollections(self, q=None, schedule_status=None, type=None, tag=None, is_active=None, page_no=None, page_size=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/collections", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"}}}],"optional":[{"description":"Get collection list filtered by q string,","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}},{"description":"Get collection list filtered by scheduled status,","in":"query","name":"schedule_status","required":false,"schema":{"enum":["live","upcoming","expired"],"type":"string"},"examples":{"success":{"value":"live"}}},{"description":"type of the collections","in":"query","name":"type","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"query"}}},{"description":"Each response will contain next_id param, which should be sent back to make pagination work.","in":"query","name":"tag","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["Test Collection 123"]}}},{"description":"get collections filtered by active status.","in":"query","name":"is_active","required":false,"schema":{"type":"boolean"},"examples":{"success":{"value":true}}},{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}}],"query":[{"description":"Get collection list filtered by q string,","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}},{"description":"Get collection list filtered by scheduled status,","in":"query","name":"schedule_status","required":false,"schema":{"enum":["live","upcoming","expired"],"type":"string"},"examples":{"success":{"value":"live"}}},{"description":"type of the collections","in":"query","name":"type","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"query"}}},{"description":"Each response will contain next_id param, which should be sent back to make pagination work.","in":"query","name":"tag","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["Test Collection 123"]}}},{"description":"get collections filtered by active status.","in":"query","name":"is_active","required":false,"schema":{"type":"boolean"},"examples":{"success":{"value":true}}},{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"}}}]}""", q=q, schedule_status=schedule_status, type=type, tag=tag, is_active=is_active, page_no=page_no, page_size=page_size)
    ...
    async def addCollectionItems(self, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/collections/{id}/items", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"},"failure":{"value":"64c00b72c07acacc1357503b"}}},{"description":"A `id` is a unique identifier of a collection.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"65620443a7d23306c5d75df2"},"failure":{"value":"invalid"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"},"failure":{"value":"64c00b72c07acacc1357503b"}}},{"description":"A `id` is a unique identifier of a collection.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"65620443a7d23306c5d75df2"},"failure":{"value":"invalid"}}}]}""", id=id)
    ...
    async def getCollectionDetail(self, slug=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/collections/{slug}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"}}},{"description":"A `slug` is a human readable, URL friendly unique identifier of an object. Pass the `slug` of the collection which you want to retrieve.","in":"path","name":"slug","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"testslug2"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"}}},{"description":"A `slug` is a human readable, URL friendly unique identifier of an object. Pass the `slug` of the collection which you want to retrieve.","in":"path","name":"slug","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"testslug2"}}}]}""", slug=slug)
    ...
    async def getApplicationDepartmentListing(self, page_no=None, page_size=None, q=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/department", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"}}}],"optional":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search query with brand name.Use this parameter to search department by name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}}],"query":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search query with brand name.Use this parameter to search department by name.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"}}}]}""", page_no=page_no, page_size=page_size, q=q)
        query_string = await create_query_string(page_no=page_no, page_size=page_size, q=q)
    ...
    async def getConfigurationsFilterMetadata(self, filter=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/metadata/{filter}", filter=filter), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getAppInventory(self, item_ids=None, store_ids=None, brand_ids=None, seller_identifiers=None, timestamp=None, page_size=None, page_id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/inventory", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"655b09a916628f2bf9203e3b"},"failure":{"value":"655b09a916628f2bf9203e3b"}}}],"optional":[{"description":"The Item Id of the product.","in":"query","name":"item_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]},"failure":{"value":[1]}}},{"description":"The Store Id of products to fetch inventory.","in":"query","name":"store_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]},"failure":{"value":[1]}}},{"description":"The Brand Id of products to fetch inventory.","in":"query","name":"brand_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]},"failure":{"value":[1]}}},{"description":"Unique seller_identifier of the product.","in":"query","name":"seller_identifiers","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["TEST"]},"failure":{"value":["TEST"]}}},{"description":"Timestamp in UTC format (2020-07-23T10:27:50Z)","in":"query","name":"timestamp","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"2020-07-23T10:27:50Z"},"failure":{"value":"invalid"}}},{"description":"The number of items to retrieve in each page.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Page ID to retrieve next set of results.","in":"query","name":"page_id","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"636a4c5c295d937d233826a5"},"failure":{"value":"636a4c5c295d937d233826a5"}}}],"query":[{"description":"The Item Id of the product.","in":"query","name":"item_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]},"failure":{"value":[1]}}},{"description":"The Store Id of products to fetch inventory.","in":"query","name":"store_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]},"failure":{"value":[1]}}},{"description":"The Brand Id of products to fetch inventory.","in":"query","name":"brand_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]},"failure":{"value":[1]}}},{"description":"Unique seller_identifier of the product.","in":"query","name":"seller_identifiers","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["TEST"]},"failure":{"value":["TEST"]}}},{"description":"Timestamp in UTC format (2020-07-23T10:27:50Z)","in":"query","name":"timestamp","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"2020-07-23T10:27:50Z"},"failure":{"value":"invalid"}}},{"description":"The number of items to retrieve in each page.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"Page ID to retrieve next set of results.","in":"query","name":"page_id","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"636a4c5c295d937d233826a5"},"failure":{"value":"636a4c5c295d937d233826a5"}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"655b09a916628f2bf9203e3b"},"failure":{"value":"655b09a916628f2bf9203e3b"}}}]}""", item_ids=item_ids, store_ids=store_ids, brand_ids=brand_ids, seller_identifiers=seller_identifiers, timestamp=timestamp, page_size=page_size, page_id=page_id)
    ...
    async def getAppLocations(self, store_type=None, uid=None, q=None, stage=None, page_no=None, page_size=None, tags=None, store_types=None, company_uids=None, request_headers:Dict={}):
        ...
        :param uid : Helps to sort the location list on the basis of uid list. : type string
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/locations", """{"required":[{"description":"Id of the company whose locations are to fetched","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Id of the application whose locations are to fetched","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"655b09a916628f2bf9203e3b"}}}],"optional":[{"description":"Helps to sort the location list on the basis of location type.","in":"query","name":"store_type","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"high_street"}}},{"description":"Helps to sort the location list on the basis of uid list.","in":"query","name":"uid","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"1"}}},{"description":"Query that is to be searched.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}},{"description":"to filter companies on basis of verified or unverified companies.","in":"query","name":"stage","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"verified"}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"default":1,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 20.","in":"query","name":"page_size","required":false,"schema":{"default":20,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Get locations filtered by tags.","in":"query","name":"tags","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["test"]}}},{"description":"Get locations filtered by store types.","in":"query","name":"store_types","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["test"]}}},{"description":"Filter stores by company IDs available in the application.","in":"query","name":"company_uids","required":false,"schema":{"type":"array","items":{"type":"integer"}},"examples":{"success":{"value":[1]}}}],"query":[{"description":"Helps to sort the location list on the basis of location type.","in":"query","name":"store_type","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"high_street"}}},{"description":"Helps to sort the location list on the basis of uid list.","in":"query","name":"uid","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"1"}}},{"description":"Query that is to be searched.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}},{"description":"to filter companies on basis of verified or unverified companies.","in":"query","name":"stage","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"verified"}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"default":1,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 20.","in":"query","name":"page_size","required":false,"schema":{"default":20,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Get locations filtered by tags.","in":"query","name":"tags","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["test"]}}},{"description":"Get locations filtered by store types.","in":"query","name":"store_types","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["test"]}}},{"description":"Filter stores by company IDs available in the application.","in":"query","name":"company_uids","required":false,"schema":{"type":"array","items":{"type":"integer"}},"examples":{"success":{"value":[1]}}}],"headers":[],"path":[{"description":"Id of the company whose locations are to fetched","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Id of the application whose locations are to fetched","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"655b09a916628f2bf9203e3b"}}}]}""", store_type=store_type, uid=uid, q=q, stage=stage, page_no=page_no, page_size=page_size, tags=tags, store_types=store_types, company_uids=company_uids)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/locations", store_type=store_type, uid=uid, q=q, stage=stage, page_no=page_no, page_size=page_size, tags=tags, store_types=store_types, company_uids=company_uids), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def createConfigurationByType(self, type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{type}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"type can be brands, categories etc.","in":"path","name":"type","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"details_groups"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"type can be brands, categories etc.","in":"path","name":"type","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"details_groups"}}}]}""", type=type)
        query_string = await create_query_string(type=type)
    ...
    async def getAppicationProducts(self, q=None, f=None, c=None, filters=None, is_dependent=None, sort_on=None, page_id=None, page_size=None, page_no=None, page_type=None, item_ids=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/products", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}}],"optional":[{"description":"The search query. This can be a partial or complete name of a either a product, brand or category","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"laptop"},"failure":{"value":"laptop"}}},{"description":"The search filter parameters. All the parameter filtered from filter parameters will be passed in **f** parameter in this format. **?f=brand:voi-jeans||and:::category:t-shirts||shirts**","in":"query","name":"f","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"item_code:LGLAPTOPSLEEVE5"},"failure":{"value":"item_code:LGLAPTOPSLEEVE5"}}},{"description":"The search filter parameters for collection items. All the parameter filtered from filter parameters will be passed in **c** parameter in this format. **?c=brand:in:voi-jeans|and:::category:nin:t-shirts|shirts**","in":"query","name":"c","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"item_code:in:LGLAPTOPSLEEVE5"},"failure":{"value":"invalid"}}},{"description":"Pass `filters` parameter to fetch the filter details. This flag is used to fetch all filters","in":"query","name":"filters","required":false,"schema":{"default":true,"type":"boolean"},"examples":{"success":{"value":true},"failure":{"value":true}}},{"description":"This query parameter is used to get the dependent products in the listing.","in":"query","name":"is_dependent","required":false,"schema":{"default":true,"type":"boolean"},"examples":{"success":{"value":true},"failure":{"value":true}}},{"description":"The order to sort the list of products on. The supported sort parameters are popularity, price, redemption and discount in either ascending or descending order. See the supported values below.","in":"query","name":"sort_on","required":false,"schema":{"enum":["latest","popular","price_asc","price_dsc","discount_asc","discount_dsc"],"type":"string"},"examples":{"success":{"value":"price_asc"},"failure":{"value":"price_asc"}}},{"description":"Each response will contain **page_id** param, which should be sent back to make pagination work.","in":"query","name":"page_id","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"*"},"failure":{"value":"*"}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"If page_type is number then pass it to fetch page items. Default is 1.","in":"query","name":"page_no","required":false,"schema":{"default":1,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"For pagination type should be cursor or number. Default is cursor.","in":"query","name":"page_type","required":false,"schema":{"default":"cursor","type":"string"},"examples":{"success":{"value":"number"},"failure":{"value":"number"}}},{"description":"Item Ids of product","in":"query","name":"item_ids","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["10"]},"failure":{"value":["10"]}}}],"query":[{"description":"The search query. This can be a partial or complete name of a either a product, brand or category","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"laptop"},"failure":{"value":"laptop"}}},{"description":"The search filter parameters. All the parameter filtered from filter parameters will be passed in **f** parameter in this format. **?f=brand:voi-jeans||and:::category:t-shirts||shirts**","in":"query","name":"f","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"item_code:LGLAPTOPSLEEVE5"},"failure":{"value":"item_code:LGLAPTOPSLEEVE5"}}},{"description":"The search filter parameters for collection items. All the parameter filtered from filter parameters will be passed in **c** parameter in this format. **?c=brand:in:voi-jeans|and:::category:nin:t-shirts|shirts**","in":"query","name":"c","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"item_code:in:LGLAPTOPSLEEVE5"},"failure":{"value":"invalid"}}},{"description":"Pass `filters` parameter to fetch the filter details. This flag is used to fetch all filters","in":"query","name":"filters","required":false,"schema":{"default":true,"type":"boolean"},"examples":{"success":{"value":true},"failure":{"value":true}}},{"description":"This query parameter is used to get the dependent products in the listing.","in":"query","name":"is_dependent","required":false,"schema":{"default":true,"type":"boolean"},"examples":{"success":{"value":true},"failure":{"value":true}}},{"description":"The order to sort the list of products on. The supported sort parameters are popularity, price, redemption and discount in either ascending or descending order. See the supported values below.","in":"query","name":"sort_on","required":false,"schema":{"enum":["latest","popular","price_asc","price_dsc","discount_asc","discount_dsc"],"type":"string"},"examples":{"success":{"value":"price_asc"},"failure":{"value":"price_asc"}}},{"description":"Each response will contain **page_id** param, which should be sent back to make pagination work.","in":"query","name":"page_id","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"*"},"failure":{"value":"*"}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"If page_type is number then pass it to fetch page items. Default is 1.","in":"query","name":"page_no","required":false,"schema":{"default":1,"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"For pagination type should be cursor or number. Default is cursor.","in":"query","name":"page_type","required":false,"schema":{"default":"cursor","type":"string"},"examples":{"success":{"value":"number"},"failure":{"value":"number"}}},{"description":"Item Ids of product","in":"query","name":"item_ids","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":["10"]},"failure":{"value":["10"]}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}}]}""", q=q, f=f, c=c, filters=filters, is_dependent=is_dependent, sort_on=sort_on, page_id=page_id, page_size=page_size, page_no=page_no, page_type=page_type, item_ids=item_ids)
    ...
    async def getDiscountedInventoryBySizeIdentifier(self, item_id=None, size_identifier=None, page_no=None, page_size=None, location_ids=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/products/{item_id}/inventory/{size_identifier}", """{"required":[{"description":"Id of the company associated to product that is to be viewed.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Uniquer Application ID.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"63b6aa5558bf3ed100740c10"}}},{"description":"Item code of the product of which size is to be get.","in":"path","name":"item_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":75779472}}},{"description":"Size Identifier (Seller Identifier or Primary Identifier) of which inventory is to get.","in":"path","name":"size_identifier","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":410163085004}}}],"optional":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search by store ids.","in":"query","name":"location_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}}],"query":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search by store ids.","in":"query","name":"location_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}}],"headers":[],"path":[{"description":"Id of the company associated to product that is to be viewed.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Uniquer Application ID.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"63b6aa5558bf3ed100740c10"}}},{"description":"Item code of the product of which size is to be get.","in":"path","name":"item_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":75779472}}},{"description":"Size Identifier (Seller Identifier or Primary Identifier) of which inventory is to get.","in":"path","name":"size_identifier","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":410163085004}}}]}""", item_id=item_id, size_identifier=size_identifier, page_no=page_no, page_size=page_size, location_ids=location_ids)
        query_string = await create_query_string(item_id=item_id, size_identifier=size_identifier, page_no=page_no, page_size=page_size, location_ids=location_ids)
    ...
    async def getProductDetailBySlug(self, slug=None, request_headers:Dict={}):
        ...
        :param slug : The unique identifier of a product. i.e; `slug` of a product or `uid` of a product. You can retrieve these from the APIs that list products like **v1.0/products/** : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/products/{slug}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":10},"failure":{"value":10}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"},"failure":{"value":"64c00b72c07acacc1357503b"}}},{"description":"The unique identifier of a product. i.e; `slug` of a product or `uid` of a product. You can retrieve these from the APIs that list products like **v1.0/products/**","in":"path","name":"slug","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"75779472"},"failure":{"value":"99"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":10},"failure":{"value":10}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64c00b72c07acacc1357503b"},"failure":{"value":"64c00b72c07acacc1357503b"}}},{"description":"The unique identifier of a product. i.e; `slug` of a product or `uid` of a product. You can retrieve these from the APIs that list products like **v1.0/products/**","in":"path","name":"slug","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"75779472"},"failure":{"value":"99"}}}]}""", slug=slug)
        query_string = await create_query_string(slug=slug)
    ...
    async def getAppProducts(self, brand_ids=None, category_ids=None, department_ids=None, tags=None, item_ids=None, page_no=None, page_size=None, q=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/raw-products", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"655b09a916628f2bf9203e3b"}}}],"optional":[{"description":"Get multiple products filtered by Brand Ids","in":"query","name":"brand_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"Get multiple products filtered by Category Ids","in":"query","name":"category_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"Get multiple products filtered by Department Ids","in":"query","name":"department_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"Get multiple products filtered by tags","in":"query","name":"tags","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":[""]}}},{"description":"Get multiple products filtered by Item Ids","in":"query","name":"item_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 10.","in":"query","name":"page_size","required":false,"schema":{"default":10,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search with Item Code, Name, Slug or Identifier.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}}],"query":[{"description":"Get multiple products filtered by Brand Ids","in":"query","name":"brand_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"Get multiple products filtered by Category Ids","in":"query","name":"category_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"Get multiple products filtered by Department Ids","in":"query","name":"department_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"Get multiple products filtered by tags","in":"query","name":"tags","required":false,"schema":{"items":{"type":"string"},"type":"array"},"examples":{"success":{"value":[""]}}},{"description":"Get multiple products filtered by Item Ids","in":"query","name":"item_ids","required":false,"schema":{"items":{"type":"integer"},"type":"array"},"examples":{"success":{"value":[1]}}},{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 10.","in":"query","name":"page_size","required":false,"schema":{"default":10,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search with Item Code, Name, Slug or Identifier.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"655b09a916628f2bf9203e3b"}}}]}""", brand_ids=brand_ids, category_ids=category_ids, department_ids=department_ids, tags=tags, item_ids=item_ids, page_no=page_no, page_size=page_size, q=q)
    ...
    async def getAutocompleteConfig(self, page_no=None, page_size=None, q=None, is_active=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed377b1fd04565d0dff30"}}}],"optional":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search query with words name.Use this parameter to search keywords by words.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"fx"}}},{"description":"Can query for keywords based on whether they are active or inactive.","in":"query","name":"is_active","required":false,"schema":{"type":"boolean"},"examples":{"success":{"value":true}}}],"query":[{"description":"The page number to navigate through the given set of results","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"default":12,"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Search query with words name.Use this parameter to search keywords by words.","in":"query","name":"q","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"fx"}}},{"description":"Can query for keywords based on whether they are active or inactive.","in":"query","name":"is_active","required":false,"schema":{"type":"boolean"},"examples":{"success":{"value":true}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed377b1fd04565d0dff30"}}}]}""", page_no=page_no, page_size=page_size, q=q, is_active=is_active)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete", page_no=page_no, page_size=page_size, q=q, is_active=is_active), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def updateAutocompleteKeyword(self, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/{id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed377b1fd04565d0dff30"},"failure":{"value":"64aed377b1fd04565d0dff30"}}},{"description":"A `id` is a unique identifier for a particular detail. Pass the `id` of the keywords which you want to delete.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"6569804246bf2fe018bf9d01"},"failure":{"value":"6569804246bf2fe018bf9d01"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed377b1fd04565d0dff30"},"failure":{"value":"64aed377b1fd04565d0dff30"}}},{"description":"A `id` is a unique identifier for a particular detail. Pass the `id` of the keywords which you want to delete.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"6569804246bf2fe018bf9d01"},"failure":{"value":"6569804246bf2fe018bf9d01"}}}]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def getSearchRerank(self, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/rerank", ), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getSearchRerankDetail(self, id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/rerank/{id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sales channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"An `id` is the identifier for a particular search rerank configuration. channel.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"6589a91055565ca43767b2e2"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sales channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"An `id` is the identifier for a particular search rerank configuration. channel.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"6589a91055565ca43767b2e2"}}}]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def updateSearchRerankConfiguration(self, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/rerank/{id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"An `id` is the identifier for a particular search rerank configuration. channel.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"6589a91055565ca43767b2e2"},"failure":{"value":"6589a91055565ca43767b2e2"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"An `id` is the identifier for a particular search rerank configuration. channel.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"6589a91055565ca43767b2e2"},"failure":{"value":"6589a91055565ca43767b2e2"}}}]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def updateSearchKeywords(self, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/keyword/{id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"A `id` is a unique identifier for a particular detail. Pass the `id` of the keywords which you want to delete.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"65685b181dfa866c6e8349cf"},"failure":{"value":"65685b181dfa866c6e8349cd"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"64aed475db2cfb5b8a9f623d"},"failure":{"value":"64aed475db2cfb5b8a9f623d"}}},{"description":"A `id` is a unique identifier for a particular detail. Pass the `id` of the keywords which you want to delete.","in":"path","name":"id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"65685b181dfa866c6e8349cf"},"failure":{"value":"65685b181dfa866c6e8349cd"}}}]}""", id=id)
        query_string = await create_query_string(id=id)
    ...
    async def getListingConfigurations(self, config_type=None, page_no=None, page_size=None, search=None, uids=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{config_type}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is an identifier that defines a specific type of configuration.","in":"path","name":"config_type","required":true,"schema":{"enum":["filter","sort","brands","categories","variant","similar"],"type":"string"},"examples":{"success":{"value":"filter"}}}],"optional":[{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Get configuration list filtered by `search` string.","in":"query","name":"search","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"cushion"}}},{"description":"Only for categories config type, Get configuration list filtered by `uids`.","in":"query","name":"uids","required":false,"schema":{"type":"array","items":{"type":"integer"}},"examples":{"success":{"value":[1]}}}],"query":[{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Get configuration list filtered by `search` string.","in":"query","name":"search","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"cushion"}}},{"description":"Only for categories config type, Get configuration list filtered by `uids`.","in":"query","name":"uids","required":false,"schema":{"type":"array","items":{"type":"integer"}},"examples":{"success":{"value":[1]}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is an identifier that defines a specific type of configuration.","in":"path","name":"config_type","required":true,"schema":{"enum":["filter","sort","brands","categories","variant","similar"],"type":"string"},"examples":{"success":{"value":"filter"}}}]}""", config_type=config_type, page_no=page_no, page_size=page_size, search=search, uids=uids)
        query_string = await create_query_string(config_type=config_type, page_no=page_no, page_size=page_size, search=search, uids=uids)
    ...
    async def createGroupConfiguration(self, config_type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{config_type}/groups", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is a unique identifier for a particular group configuration type.","in":"path","name":"config_type","required":true,"schema":{"enum":["comparisons_groups","details_groups","seller_groups"],"type":"string"},"examples":{"success":{"value":"seller_groups"},"failure":{"value":"seller_groups"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is a unique identifier for a particular group configuration type.","in":"path","name":"config_type","required":true,"schema":{"enum":["comparisons_groups","details_groups","seller_groups"],"type":"string"},"examples":{"success":{"value":"seller_groups"},"failure":{"value":"seller_groups"}}}]}""", config_type=config_type)
        query_string = await create_query_string(config_type=config_type)
    ...
    async def getGroupConfigurations(self, config_type=None, page_no=None, page_size=None, search=None, template_slug=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{config_type}/groups", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is an identifier that defines a specific type of configuration.","in":"path","name":"config_type","required":true,"schema":{"enum":["comparisons_groups","details_groups","seller_groups"],"type":"string"},"examples":{"success":{"value":"seller_groups"}}}],"optional":[{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Get configuration list filtered by `search` string.","in":"query","name":"search","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}},{"description":"Get configuration list filtered by `template_slug` string. This is for the details and comparision groups.","in":"query","name":"template_slug","required":false,"schema":{"type":"string"},"examples":{"success":{"value":""}}}],"query":[{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"Get configuration list filtered by `search` string.","in":"query","name":"search","required":false,"schema":{"type":"string"},"examples":{"success":{"value":"test"}}},{"description":"Get configuration list filtered by `template_slug` string. This is for the details and comparision groups.","in":"query","name":"template_slug","required":false,"schema":{"type":"string"},"examples":{"success":{"value":""}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is an identifier that defines a specific type of configuration.","in":"path","name":"config_type","required":true,"schema":{"enum":["comparisons_groups","details_groups","seller_groups"],"type":"string"},"examples":{"success":{"value":"seller_groups"}}}]}""", config_type=config_type, page_no=page_no, page_size=page_size, search=search, template_slug=template_slug)
    ...
    async def updateGroupConfiguration(self, config_type=None, group_slug=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{config_type}/groups/{group_slug}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is a unique identifier for a particular group configuration type.","in":"path","name":"config_type","required":true,"schema":{"enum":["comparisons_groups","details_groups","seller_groups"],"type":"string"},"examples":{"success":{"value":"seller_groups"},"failure":{"value":"seller_groups"}}},{"description":"A `group_slug` is a unique identifier of a particular configuration.","in":"path","name":"group_slug","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"656c3941f62a832779362cf0"},"failure":{"value":"invalid"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is a unique identifier for a particular group configuration type.","in":"path","name":"config_type","required":true,"schema":{"enum":["comparisons_groups","details_groups","seller_groups"],"type":"string"},"examples":{"success":{"value":"seller_groups"},"failure":{"value":"seller_groups"}}},{"description":"A `group_slug` is a unique identifier of a particular configuration.","in":"path","name":"group_slug","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"656c3941f62a832779362cf0"},"failure":{"value":"invalid"}}}]}""", config_type=config_type, group_slug=group_slug)
    ...
    async def updateListingConfiguration(self, config_type=None, config_id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{config_type}/item/{config_id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is a unique identifier for a particular listing configuration type.","in":"path","name":"config_type","required":true,"schema":{"enum":["filter","sort","brands","categories","variant","similar"],"type":"string"},"examples":{"success":{"value":"filter"},"failure":{"value":"filter"}}},{"description":"A `config_id` is a unique identifier of a particular configuration.","in":"path","name":"config_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"656cc670c404d0f059e622b4"},"failure":{"value":"656cc670c404d0f059e622b4"}}}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1},"failure":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"},"failure":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is a unique identifier for a particular listing configuration type.","in":"path","name":"config_type","required":true,"schema":{"enum":["filter","sort","brands","categories","variant","similar"],"type":"string"},"examples":{"success":{"value":"filter"},"failure":{"value":"filter"}}},{"description":"A `config_id` is a unique identifier of a particular configuration.","in":"path","name":"config_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"656cc670c404d0f059e622b4"},"failure":{"value":"656cc670c404d0f059e622b4"}}}]}""", config_type=config_type, config_id=config_id)
    ...
    async def getConfigurationMetadata(self, config_type=None, template_slug=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/product-configuration/{config_type}/metadata", """{"required":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is an identifier that defines a specific type of configuration.","in":"path","name":"config_type","required":true,"schema":{"enum":["filter","sort","details_groups","comparisons_groups","variant","similar","brands","categories","seller_groups"],"type":"string"},"examples":{"success":{"value":"filter"}}}],"optional":[{"description":"Get configuration list filtered by `template_slug` string. This is for the details and comparision groups.","in":"query","name":"template_slug","required":false,"schema":{"type":"string"},"examples":{"success":{"value":""}}}],"query":[{"description":"Get configuration list filtered by `template_slug` string. This is for the details and comparision groups.","in":"query","name":"template_slug","required":false,"schema":{"type":"string"},"examples":{"success":{"value":""}}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular seller account.","in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"examples":{"success":{"value":1}}},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","required":true,"schema":{"type":"string"},"examples":{"success":{"value":"000000000000000000000001"}}},{"description":"A `config_type` is an identifier that defines a specific type of configuration.","in":"path","name":"config_type","required":true,"schema":{"enum":["filter","sort","details_groups","comparisons_groups","variant","similar","brands","categories","seller_groups"],"type":"string"},"examples":{"success":{"value":"filter"}}}]}""", config_type=config_type, template_slug=template_slug)
    ...
    async def createAutocompleteSettings(self, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/settings", """{"required":[{"name":"application_id","description":"The company id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"company_id","description":"The application id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"application_id","description":"The company id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"company_id","description":"The application id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}}]}""", )
        query_string = await create_query_string()
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/settings", ), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getAutocompleteSettings(self, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/settings", """{"required":[{"description":"The company id for which the autocomplete settings is being referenced","in":"path","name":"application_id","required":true,"schema":{"type":"integer"}},{"description":"The application id for which the autocomplete settings is being referenced","in":"path","name":"company_id","required":true,"schema":{"type":"integer"}}],"optional":[],"query":[],"headers":[],"path":[{"description":"The company id for which the autocomplete settings is being referenced","in":"path","name":"application_id","required":true,"schema":{"type":"integer"}},{"description":"The application id for which the autocomplete settings is being referenced","in":"path","name":"company_id","required":true,"schema":{"type":"integer"}}]}""", )
        query_string = await create_query_string()
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/settings", ), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def updateAutocompleteSettings(self, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/settings/{id}", """{"required":[{"name":"application_id","description":"The company id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"company_id","description":"The application id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"id","description":"An `id` is a unique identifier for a particular autocomplete settings config.","in":"path","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"application_id","description":"The company id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"company_id","description":"The application id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"id","description":"An `id` is a unique identifier for a particular autocomplete settings config.","in":"path","required":true,"schema":{"type":"string"}}]}""", id=id)
        query_string = await create_query_string(id=id)
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/settings/{id}", id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getAutocompletePreview(self, q=None, category_suggestion=None, brand_suggestion=None, collection_suggestion=None, product_suggestion=None, query_suggestion=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/preview", """{"required":[{"name":"application_id","description":"The company id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"company_id","description":"The application id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}}],"optional":[{"name":"q","in":"query","description":"Get suggestions related to `q` string.","schema":{"type":"string"},"required":false},{"name":"category_suggestion","description":"For getting related category suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"brand_suggestion","description":"For getting related brand suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"collection_suggestion","description":"For getting collection suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"product_suggestion","description":"For getting product suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"query_suggestion","description":"For getting query suggestions.","in":"query","required":false,"schema":{"type":"integer"}}],"query":[{"name":"q","in":"query","description":"Get suggestions related to `q` string.","schema":{"type":"string"},"required":false},{"name":"category_suggestion","description":"For getting related category suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"brand_suggestion","description":"For getting related brand suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"collection_suggestion","description":"For getting collection suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"product_suggestion","description":"For getting product suggestions.","in":"query","required":false,"schema":{"type":"integer"}},{"name":"query_suggestion","description":"For getting query suggestions.","in":"query","required":false,"schema":{"type":"integer"}}],"headers":[],"path":[{"name":"application_id","description":"The company id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}},{"name":"company_id","description":"The application id for which the autocomplete settings is being referenced","in":"path","required":true,"schema":{"type":"integer"}}]}""", q=q, category_suggestion=category_suggestion, brand_suggestion=brand_suggestion, collection_suggestion=collection_suggestion, product_suggestion=product_suggestion, query_suggestion=query_suggestion)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/search/autocomplete/preview", q=q, category_suggestion=category_suggestion, brand_suggestion=brand_suggestion, collection_suggestion=collection_suggestion, product_suggestion=product_suggestion, query_suggestion=query_suggestion), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getMerchandisingRulePinAction(self, merchandising_rule_id=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/pin", merchandising_rule_id=merchandising_rule_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def createMerchandisingRulePinAction(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/pin", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def updateMerchandisingRulePinAction(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/pin", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getMerchandisingRuleBoostAction(self, merchandising_rule_id=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/boost", merchandising_rule_id=merchandising_rule_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def createMerchandisingRuleBoostAction(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/boost", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def updateMerchandisingRuleBoostAction(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/boost", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getMerchandisingRuleBuryAction(self, merchandising_rule_id=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/bury", merchandising_rule_id=merchandising_rule_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def createMerchandisingRuleBuryAction(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/bury", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def updateMerchandisingRuleBuryAction(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/bury", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def createMerchandisingRuleQuery(self, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/query", """{"required":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true}]}""", )
        query_string = await create_query_string()
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/query", ), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getMerchandisingQuery(self, merchandising_rule_id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/query", """{"required":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true},{"in":"path","name":"merchandising_rule_id","description":"A `merchandising_rule_id` is a unique identifier for a particular merchandising rule.","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true},{"in":"path","name":"merchandising_rule_id","description":"A `merchandising_rule_id` is a unique identifier for a particular merchandising rule.","schema":{"type":"string"},"required":true}]}""", merchandising_rule_id=merchandising_rule_id)
        query_string = await create_query_string(merchandising_rule_id=merchandising_rule_id)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/query", merchandising_rule_id=merchandising_rule_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def updateMerchandisingRuleQuery(self, merchandising_rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/query", merchandising_rule_id=merchandising_rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getMerchandisingRules(self, page_id=None, page_size=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules", """{"required":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true}],"optional":[{"in":"query","name":"page_id","description":"Each response will contain next_id param, which should be sent back to make pagination work.","schema":{"type":"string"},"required":false},{"in":"query","name":"page_size","description":"Number of items to retrieve in each page. Default is 12.","schema":{"type":"integer"},"required":false}],"query":[{"in":"query","name":"page_id","description":"Each response will contain next_id param, which should be sent back to make pagination work.","schema":{"type":"string"},"required":false},{"in":"query","name":"page_size","description":"Number of items to retrieve in each page. Default is 12.","schema":{"type":"integer"},"required":false}],"headers":[],"path":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true}]}""", page_id=page_id, page_size=page_size)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules", page_id=page_id, page_size=page_size), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getLivePreview(self, merchandising_rule_id=None, search_keyword=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/preview", """{"required":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true},{"in":"path","name":"merchandising_rule_id","description":"A `merchandising_rule_id` is a unique identifier for a particular merchandising rule.","schema":{"type":"string"},"required":true}],"optional":[{"in":"query","name":"search_keyword","description":"A sample query that can be used to get a live preview of the merchandising rule.","schema":{"type":"string"},"required":false}],"query":[{"in":"query","name":"search_keyword","description":"A sample query that can be used to get a live preview of the merchandising rule.","schema":{"type":"string"},"required":false}],"headers":[],"path":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular seller account.","schema":{"type":"string"},"required":true},{"in":"path","name":"application_id","description":"A `application_id` is a unique identifier for a particular sale channel.","schema":{"type":"string"},"required":true},{"in":"path","name":"merchandising_rule_id","description":"A `merchandising_rule_id` is a unique identifier for a particular merchandising rule.","schema":{"type":"string"},"required":true}]}""", merchandising_rule_id=merchandising_rule_id, search_keyword=search_keyword)
        query_string = await create_query_string(merchandising_rule_id=merchandising_rule_id, search_keyword=search_keyword)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/merchandise/rules/{merchandising_rule_id}/preview", merchandising_rule_id=merchandising_rule_id, search_keyword=search_keyword), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def createAppPriceFactory(self, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import CreateAppPriceFactoryRequest
        schema = CreateAppPriceFactoryRequest()
        schema.dump(schema.load(body))

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true}]}""", )
        query_string = await create_query_string()
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory", ), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getAppPriceFactories(self, is_active=None, factory_type_id=None, code=None, page_no=None, page_size=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory", is_active=is_active, factory_type_id=factory_type_id, code=code, page_no=page_no, page_size=page_size), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getAppPriceFactory(self, id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true}]}""", id=id)
        query_string = await create_query_string(id=id)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}", id=id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def editAppPriceFactory(self, id=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import EditAppPriceFactoryRequest
        schema = EditAppPriceFactoryRequest()
        schema.dump(schema.load(body))
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}", id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def addProductsInPriceFactoryByZoneId(self, id=None, zone_id=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import CreateAppPriceFactoryProductRequest
        schema = CreateAppPriceFactoryProductRequest()
        schema.dump(schema.load(body))

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/zone/{zone_id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"An `zone_id` is a unique identifier for a particular price factory zone.","in":"path","name":"zone_id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"An `zone_id` is a unique identifier for a particular price factory zone.","in":"path","name":"zone_id","schema":{"type":"string"},"required":true}]}""", id=id, zone_id=zone_id)
        query_string = await create_query_string(id=id, zone_id=zone_id)
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/zone/{zone_id}", id=id, zone_id=zone_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def getProductsInPriceFactoryByZoneId(self, id=None, zone_id=None, item_id=None, seller_identifier=None, page_no=None, page_size=None, request_headers:Dict={}):
        """This API allows to get products in price factory.
        :param id : An `id` is a unique identifier for a particular price factory. : type string
        :param zone_id : An `zone_id` is a unique identifier for a particular price factory zone. : type string
        :param item_id : gets price factory filtered by item_id. : type boolean
        :param seller_identifier : gets price factory filtered by seller_identifier. : type string
        :param page_no : The page number to navigate through the given set of results. : type integer
        :param page_size : Number of items to retrieve in each page. Default is 12. : type integer
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/zone/{zone_id}", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"An `zone_id` is a unique identifier for a particular price factory zone.","in":"path","name":"zone_id","schema":{"type":"string"},"required":true}],"optional":[{"description":"gets price factory filtered by item_id.","in":"query","name":"item_id","required":false,"schema":{"type":"boolean"}},{"description":"gets price factory filtered by seller_identifier.","in":"query","name":"seller_identifier","required":false,"schema":{"type":"string"}},{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"}}],"query":[{"description":"gets price factory filtered by item_id.","in":"query","name":"item_id","required":false,"schema":{"type":"boolean"}},{"description":"gets price factory filtered by seller_identifier.","in":"query","name":"seller_identifier","required":false,"schema":{"type":"string"}},{"description":"The page number to navigate through the given set of results.","in":"query","name":"page_no","required":false,"schema":{"type":"integer"}},{"description":"Number of items to retrieve in each page. Default is 12.","in":"query","name":"page_size","required":false,"schema":{"type":"integer"}}],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"An `zone_id` is a unique identifier for a particular price factory zone.","in":"path","name":"zone_id","schema":{"type":"string"},"required":true}]}""", id=id, zone_id=zone_id, item_id=item_id, seller_identifier=seller_identifier, page_no=page_no, page_size=page_size)
        query_string = await create_query_string(id=id, zone_id=zone_id, item_id=item_id, seller_identifier=seller_identifier, page_no=page_no, page_size=page_size)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/zone/{zone_id}", id=id, zone_id=zone_id, item_id=item_id, seller_identifier=seller_identifier, page_no=page_no, page_size=page_size), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def updateProductPriceByZoneInPriceFactory(self, id=None, item_id=None, zone_id=None, body="", request_headers:Dict={}):
        """This API allows to partially update products in price factory.
        :param id : A `id` is a unique identifier for a particular price factory. : type string
        ...
        # Parameter validation
        schema = CatalogValidator.updateProductPriceByZoneInPriceFactory()
        schema.dump(schema.load(payload))
        
        # Body validation
        from .models import UpdateAppPriceFactoryProductRequest
        schema = UpdateAppPriceFactoryProductRequest()
        schema.dump(schema.load(body))

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/product/{item_id}/zone/{zone_id}/price", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"A `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"A `item_id` is a unique identifier for a particular product.","in":"path","name":"item_id","schema":{"type":"integer"},"required":true},{"description":"A `zone_id` is a unique identifier for a particular zone.","in":"path","name":"zone_id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"A `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"A `item_id` is a unique identifier for a particular product.","in":"path","name":"item_id","schema":{"type":"integer"},"required":true},{"description":"A `zone_id` is a unique identifier for a particular zone.","in":"path","name":"zone_id","schema":{"type":"string"},"required":true}]}""", id=id, item_id=item_id, zone_id=zone_id)
        query_string = await create_query_string(id=id, item_id=item_id, zone_id=zone_id)
        ...
        response = await AiohttpHelper().aiohttp_request("PATCH", url_with_params, headers=get_headers_with_signature(self._conf.domain, "patch", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/product/{item_id}/zone/{zone_id}/price", id=id, item_id=item_id, zone_id=zone_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)

        if 200 <= int(response['status_code']) < 300:
            from .models import UpdateAppPriceFactoryProductResponse
            schema = UpdateAppPriceFactoryProductResponse()
            try:
                schema.load(response["json"])
            except Exception as e:
                print("Response Validation failed for updateProductPriceByZoneInPriceFactory")
                print(e)
    ...
    async def createProductPriceFactoryBulkJob(self, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true}]}""", id=id)
        query_string = await create_query_string(id=id)
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk", id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def pollProductPriceFactoryBulkJob(self, id=None, job_id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk/{job_id}/poll", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"A `job_id` is a unique identifier for a particular bulk job.","in":"path","name":"job_id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"A `job_id` is a unique identifier for a particular bulk job.","in":"path","name":"job_id","schema":{"type":"string"},"required":true}]}""", id=id, job_id=job_id)
        query_string = await create_query_string(id=id, job_id=job_id)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk/{job_id}/poll", id=id, job_id=job_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def validateProductPriceFactoryBulkJob(self, id=None, job_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk/{job_id}/validate", id=id, job_id=job_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
    ...
    async def processProductPriceFactoryBulkJob(self, id=None, job_id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk/{job_id}/process", """{"required":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"A `job_id` is a unique identifier for a particular bulk job.","in":"path","name":"job_id","schema":{"type":"string"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"description":"A `company_id` is a unique identifier for a particular company.","in":"path","name":"company_id","schema":{"type":"integer"},"required":true},{"description":"A `application_id` is a unique identifier for a particular sale channel.","in":"path","name":"application_id","schema":{"type":"string"},"required":true},{"description":"An `id` is a unique identifier for a particular price factory.","in":"path","name":"id","schema":{"type":"string"},"required":true},{"description":"A `job_id` is a unique identifier for a particular bulk job.","in":"path","name":"job_id","schema":{"type":"string"},"required":true}]}""", id=id, job_id=job_id)
        query_string = await create_query_string(id=id, job_id=job_id)
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/catalog/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/price-factory/{id}/products/bulk/{job_id}/process", id=id, job_id=job_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)
