...
class Catalog:
    ...
    async def listProductTemplateCategories(self, departments=None, item_type=None, page_size=None, page_no=None, q=None, slug=None, request_headers:Dict={}):
        ...
        :param q : Search string (Name of a category) to search categories from : type string
        :param slug : slug string to search categories from : type string
        """
        payload = {}
