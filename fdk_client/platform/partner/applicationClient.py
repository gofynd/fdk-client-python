...
class Partner:
    ...
    async def getProxyPath(self, extension_id=None):
        ...
        schema = PartnerValidator.getProxyPath()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/partners/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/proxy/{extension_id}", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current application id","in":"path","required":true,"name":"application_id"},{"schema":{"type":"string"},"name":"extension_id","required":true,"in":"path","description":"extension id"}],"optional":[],"query":[],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current application id","in":"path","required":true,"name":"application_id"},{"schema":{"type":"string"},"name":"extension_id","required":true,"in":"path","description":"extension id"}]}""", extension_id=extension_id)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/partners/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/proxy/{extension_id}", extension_id=extension_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getProxyPathAttachedPath(self, extension_id=None, attached_path=None):
        """Use this API to get proxy url
        :param extension_id : extension id : type string
        :param attached_path : application id : type string
        """
        payload = {}
        ...
        # Parameter validation
        schema = PartnerValidator.getProxyPathAttachedPath()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/partners/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/proxy/{extension_id}/{attached_path}", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current application id","in":"path","required":true,"name":"application_id"},{"schema":{"type":"string"},"name":"extension_id","required":true,"in":"path","description":"extension id"},{"schema":{"type":"string"},"required":true,"name":"attached_path","in":"path","description":"application id"}],"optional":[],"query":[],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current application id","in":"path","required":true,"name":"application_id"},{"schema":{"type":"string"},"name":"extension_id","required":true,"in":"path","description":"extension id"},{"schema":{"type":"string"},"required":true,"name":"attached_path","in":"path","description":"application id"}]}""", extension_id=extension_id, attached_path=attached_path)
        ...
        for key, val in headers.items():
            if not key.startswith("x-fp-"):
                exclude_headers.append(key)
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/partners/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/proxy/{extension_id}/{attached_path}", extension_id=extension_id, attached_path=attached_path), query_string, headers, "", exclude_headers=exclude_headers), data="")
