...
class Partner:
    ...
    async def getExtensionsForCompany(self, page_size=None, tag=None, current_page=None, page_no=None, filter_by=None):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/partners/v1.0/company/{self._conf.companyId}/extensions", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"}],"optional":[{"name":"page_size","in":"query","description":"Number of records you want to get in single page","schema":{"type":"number"},"example":10},{"name":"tag","in":"query","description":"tag","schema":{"type":"string"}},{"name":"current_page","in":"query","description":"tag","schema":{"type":"string"}},{"name":"page_no","in":"query","description":"Current page number","schema":{"type":"number"},"example":1},{"name":"filter_by","in":"query","description":"Filter by","schema":{"type":"string"},"example":"user_specific"}],"query":[{"name":"page_size","in":"query","description":"Number of records you want to get in single page","schema":{"type":"number"},"example":10},{"name":"tag","in":"query","description":"tag","schema":{"type":"string"}},{"name":"current_page","in":"query","description":"tag","schema":{"type":"string"}},{"name":"page_no","in":"query","description":"Current page number","schema":{"type":"number"},"example":1},{"name":"filter_by","in":"query","description":"Filter by","schema":{"type":"string"},"example":"user_specific"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"}]}""", page_size=page_size, tag=tag, current_page=current_page, page_no=page_no, filter_by=filter_by)
        query_string = await create_query_string(page_size=page_size, tag=tag, current_page=current_page, page_no=page_no, filter_by=filter_by)
        headers = {
            "Authorization": "Bearer " + await self._conf.getAccessToken()
        }
        for h in self._conf.extraHeaders:
