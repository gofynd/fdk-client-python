...
class DataObjectResponse(BaseSchema):
    pass
...
class CompanyDpAccountRequest(BaseSchema):
    ...
    data = fields.List(fields.Nested(DP, required=False), required=False)
...
class CompanyDpAccountResponse(BaseSchema):
    ...
    data = fields.List(fields.Nested(DataObjectResponse, required=False), required=False)
...
class FailureResponse(BaseSchema):
    ...
    error = fields.List(fields.Nested(ErrorResponse1, required=False), required=False)
...
class DpMultipleRuleSuccessResponse(BaseSchema):
    ...
    items = fields.List(fields.Nested(DpRuleResponse, required=False), required=False)
