...
class Serviceability:
    ...
    async def getCompanyCourierPartnersList(self, body="", request_headers:Dict={}):
        ...
        # Parameter validation
        schema = ServiceabilityValidator.getCompanyCourierPartnersList()
        schema.dump(schema.load(payload))
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/logistics/v2.0/company/{self._conf.companyId}/courier-partners", """{"required":[{"in":"path","name":"company_id","description":"The ID of the company.","schema":{"type":"integer"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","description":"The ID of the company.","schema":{"type":"integer"},"required":true}]}""", serverType="platform", )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for getCompanyCourierPartnersList")
                print(e)

        return response
    
    async def updateCompanyConfiguration(self, fulfillment_option_slug=None, body="", request_headers:Dict={}):
        """Updates an existing delivery setup for a company, including the ability to adjust self-shipping preferences.
        :param fulfillment_option_slug : Slug representing the fulfillment option. : type string
        """
        payload = {}
        
        if fulfillment_option_slug is not None:
            payload["fulfillment_option_slug"] = fulfillment_option_slug
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/logistics/v1.0/company/{self._conf.companyId}/configuration", """{"required":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular sale channel.","schema":{"type":"integer"},"required":true},{"in":"query","name":"fulfillment_option_slug","description":"Slug representing the fulfillment option.","schema":{"type":"string"},"required":true}],"optional":[],"query":[{"in":"query","name":"fulfillment_option_slug","description":"Slug representing the fulfillment option.","schema":{"type":"string"},"required":true}],"headers":[],"path":[{"in":"path","name":"company_id","description":"A `company_id` is a unique identifier for a particular sale channel.","schema":{"type":"integer"},"required":true}]}""", serverType="platform", fulfillment_option_slug=fulfillment_option_slug)
        query_string = await create_query_string(fulfillment_option_slug=fulfillment_option_slug)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/logistics/v1.0/company/{self._conf.companyId}/configuration", fulfillment_option_slug=fulfillment_option_slug), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
...
Export locality wise CSV files.
    ...
    async def getCourierPartnerSchemes(self, extension_id=None, scheme_type=None, payment_mode=None, capabilities=None, scheme_ids=None, q=None, request_headers:Dict={}):
        ...
        :param q : The search string to search in the list of courier partners schemes by name. : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/logistics/v2.0/company/{self._conf.companyId}/courier-partner/scheme", """{"required":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","schema":{"type":"integer"},"required":true}],"optional":[{"in":"query","name":"extension_id","description":"Unique Identifier of courier partner extension.","schema":{"type":"string"},"required":false},{"in":"query","name":"scheme_type","description":"Indicates whether a scheme is created by an admin for global purposes or customized for a specific company.","schema":{"type":"string","enum":["global","custom"]},"required":false},{"in":"query","name":"payment_mode","description":"Indicates payment mode for a scheme.","schema":{"type":"string","enum":["COD","PREPAID"]},"required":false},{"in":"query","name":"capabilities","description":"Indicates whether the scheme possesses certain capabilities.","schema":{"type":"array","items":{"type":"string"}},"required":false},{"in":"query","name":"scheme_ids","description":"List of scheme ids which need to be returned in the response.","schema":{"type":"array","items":{"type":"string"}},"required":false},{"in":"query","name":"q","description":"The search string to search in the list of courier partners schemes by name.","schema":{"type":"string"},"required":false}],"query":[{"in":"query","name":"extension_id","description":"Unique Identifier of courier partner extension.","schema":{"type":"string"},"required":false},{"in":"query","name":"scheme_type","description":"Indicates whether a scheme is created by an admin for global purposes or customized for a specific company.","schema":{"type":"string","enum":["global","custom"]},"required":false},{"in":"query","name":"payment_mode","description":"Indicates payment mode for a scheme.","schema":{"type":"string","enum":["COD","PREPAID"]},"required":false},{"in":"query","name":"capabilities","description":"Indicates whether the scheme possesses certain capabilities.","schema":{"type":"array","items":{"type":"string"}},"required":false},{"in":"query","name":"scheme_ids","description":"List of scheme ids which need to be returned in the response.","schema":{"type":"array","items":{"type":"string"}},"required":false},{"in":"query","name":"q","description":"The search string to search in the list of courier partners schemes by name.","schema":{"type":"string"},"required":false}],"headers":[],"path":[{"in":"path","name":"company_id","description":"The unique identifier of the company.","schema":{"type":"integer"},"required":true}]}""", serverType="platform", extension_id=extension_id, scheme_type=scheme_type, payment_mode=payment_mode, capabilities=capabilities, scheme_ids=scheme_ids, q=q)
        query_string = await create_query_string(extension_id=extension_id, scheme_type=scheme_type, payment_mode=payment_mode, capabilities=capabilities, scheme_ids=scheme_ids, q=q)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/logistics/v2.0/company/{self._conf.companyId}/courier-partner/scheme", extension_id=extension_id, scheme_type=scheme_type, payment_mode=payment_mode, capabilities=capabilities, scheme_ids=scheme_ids, q=q), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))
