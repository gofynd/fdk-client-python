...
class Payment:
    ...
    async def addRefundBankAccountUsingOTP(self, body=""):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/payment/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/refund/account", """{"required":[{"in":"path","name":"company_id","schema":{"type":"integer","description":"Company Id"},"required":true},{"in":"path","name":"application_id","schema":{"type":"string","description":"Application id"},"required":true}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","schema":{"type":"integer","description":"Company Id"},"required":true},{"in":"path","name":"application_id","schema":{"type":"string","description":"Application id"},"required":true}]}""", )
        query_string = await create_query_string()
        headers = {
            "Authorization": "Bearer " + await self._conf.getAccessToken()
        }
