...
class Payment:
    ...
    async def updateEdcDevice(self, terminal_unique_identifier=None, body=""):
        ...
        # Body validation
        from .models.EdcAddRequest import EdcAddRequest
    ...
    async def addEdcDevice(self, terminal_unique_identifier=None, body=""):
        ...
        # Body validation
        from .models.EdcUpdateRequest import EdcUpdateRequest
...
class Cart:
    ...
    async def updateCartUser(self, id=None, body=""):
        ...
        # Body validation
        from .models.UpdateUserCartMapping import UpdateUserCartMapping
    ...
    async def deleteCart(self, id=None, body=""):
        ...
        # Body validation
        from .models.DeleteCartRequest import DeleteCartRequest
    ...
    async def updateCartMeta(self, id=None, buy_now=None, body=""):
        ...
        # Body validation
        from .models.PlatformCartMetaRequest import PlatformCartMetaRequest
