...
class CompanyThemeReqSchema(BaseSchema):
    pass
...
class CreateThemePreviewBody(BaseSchema):
    pass


class CreateThemePreviewResponseSchema(BaseSchema):
    pass
...
class FontsSchemaItems(BaseSchema):
    ...
    menu = fields.Str(required=False)
...
class ThemeUpgradable(BaseSchema):
    ...
    versions = fields.Dict(required=False)
...
class CreateThemePreviewBody(BaseSchema):
    ...
    user_group_uid = fields.Int(required=False)
    
    preview_date_time = fields.Str(required=False)
