...
class Theme:
    ...
    async def getDefaultPageDetails(self, page_value=None):
        """Use this API to retrieve default page details of a page.
        :param page_value : Value of the page to be retrieved : type string
        """
        payload = {}
        ...
        # Parameter validation
        schema = ThemeValidator.getDefaultPageDetails()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/theme/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/page/{page_value}/default", """{"required":[{"name":"company_id","in":"path","description":"Company ID","required":true,"schema":{"type":"string"}},{"name":"application_id","in":"path","description":"Application ID","required":true,"schema":{"type":"string"}},{"name":"page_value","in":"path","description":"Value of the page to be retrieved","required":true,"schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"company_id","in":"path","description":"Company ID","required":true,"schema":{"type":"string"}},{"name":"application_id","in":"path","description":"Application ID","required":true,"schema":{"type":"string"}},{"name":"page_value","in":"path","description":"Value of the page to be retrieved","required":true,"schema":{"type":"string"}}]}""", page_value=page_value)
        query_string = await create_query_string(page_value=page_value)
        headers = {
            "Authorization": "Bearer " + await self._conf.getAccessToken()
        }
        for h in self._conf.extraHeaders:
        ...
        for key, val in headers.items():
            if not key.startswith("x-fp-"):
                exclude_headers.append(key)
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/theme/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/page/{page_value}/default", page_value=page_value), query_string, headers, "", exclude_headers=exclude_headers), data="")
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for getDefaultPageDetails")
                print(e)
    ...
    async def getApplicationThemesV2(self, ):
        """
        """
        payload = {}
        ...
        # Parameter validation
        schema = ThemeValidator.getApplicationThemesV2()
        schema.dump(schema.load(payload))
    ...
    async def getFontsV2(self, ):
        ...
        for key, val in headers.items():
            if not key.startswith("x-fp-"):
                exclude_headers.append(key)
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/theme/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/fonts", ), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getApplicationThemesCountV2(self, ):
        """
        """
        payload = {}
        ...
        # Parameter validation
        schema = ThemeValidator.getApplicationThemesCountV2()
        schema.dump(schema.load(payload))
    ...
    async def getApplicationThemeByIdV2(self, theme_id=None):
        """
        ...
        # Parameter validation
        schema = ThemeValidator.getApplicationThemeByIdV2()
        schema.dump(schema.load(payload))
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for getApplicationThemeByIdV2")
                print(e)
    ...
    async def updateThemeV2(self, theme_id=None, body=""):
        """
        :param theme_id : The ID of the theme. : type string
        """
        payload = {}
        ...
        # Parameter validation
        schema = ThemeValidator.updateThemeV2()
        schema.dump(schema.load(payload))
        
        # Body validation
        from .models import UpdateThemeRequestBodyV2
        schema = UpdateThemeRequestBodyV2()
        schema.dump(schema.load(body))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/theme/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/{theme_id}", """{"required":[{"in":"path","name":"company_id","schema":{"type":"integer"},"required":true,"description":"The ID of the company."},{"in":"path","name":"application_id","schema":{"type":"string"},"required":true,"description":"The ID of the application."},{"in":"path","name":"theme_id","schema":{"type":"string"},"required":true,"description":"The ID of the theme."}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","schema":{"type":"integer"},"required":true,"description":"The ID of the company."},{"in":"path","name":"application_id","schema":{"type":"string"},"required":true,"description":"The ID of the application."},{"in":"path","name":"theme_id","schema":{"type":"string"},"required":true,"description":"The ID of the theme."}]}""", theme_id=theme_id)
        query_string = await create_query_string(theme_id=theme_id)
        headers = {
            "Authorization": "Bearer " + await self._conf.getAccessToken()
        }
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for updateThemeV2")
                print(e)
    ...
    async def addThemeToApplicationV2(self, body=""):
        ...
        # Body validation
        from .models import ApplyThemeRequestV2
        schema = ApplyThemeRequestV2()
        schema.dump(schema.load(body))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/theme/v2.0/company/{self._conf.companyId}/application/{self.applicationId}", """{"required":[{"name":"company_id","in":"path","description":"The ID of the company","required":true,"schema":{"type":"integer","example":17461}},{"name":"application_id","in":"path","description":"The ID of the application","required":true,"schema":{"type":"string","example":"644268ee520b9544cc95e204"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"company_id","in":"path","description":"The ID of the company","required":true,"schema":{"type":"integer","example":17461}},{"name":"application_id","in":"path","description":"The ID of the application","required":true,"schema":{"type":"string","example":"644268ee520b9544cc95e204"}}]}""", )
        query_string = await create_query_string()
        headers = {
            "Authorization": "Bearer " + await self._conf.getAccessToken()
        }
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import ApplyThemeResponseV2
            schema = ApplyThemeResponseV2()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getAppliedThemeV2(self, ):
    ...
    async def getThemePreviewByIdV2(self, theme_id=None):
        """
        :param theme_id : The ID of the theme : type string
        """
        payload = {}
        ...
        # Parameter validation
        schema = ThemeValidator.getThemePreviewByIdV2()
        schema.dump(schema.load(payload))
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for getThemePreviewByIdV2")
                print(e)
    ...
    async def getThemeLastModifiedV2(self, theme_id=None):
        """Use this API to fetch Last-Modified timestamp in header metadata.
        :param theme_id : ID allotted to the theme. : type string
        """
        payload = {}
        ...
        # Parameter validation
        schema = ThemeValidator.getThemeLastModifiedV2()
        schema.dump(schema.load(payload))
    ...
    async def checkThemeUpgradableV2(self, theme_id=None):
        ...
        # Parameter validation
        schema = ThemeValidator.checkThemeUpgradableV2()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/theme/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/{theme_id}/upgradable", """{"required":[{"name":"company_id","in":"path","required":true,"description":"The ID of the company","schema":{"type":"string","example":"19243"}},{"name":"application_id","in":"path","required":true,"description":"The ID of the application","schema":{"type":"string","example":"6487ea376e1442284917c44e"}},{"name":"theme_id","in":"path","required":true,"description":"The ID of the theme","schema":{"type":"string","example":"648832dcb99296ab200fbaaa"}}],"optional":[],"query":[],"headers":[],"path":[{"name":"company_id","in":"path","required":true,"description":"The ID of the company","schema":{"type":"string","example":"19243"}},{"name":"application_id","in":"path","required":true,"description":"The ID of the application","schema":{"type":"string","example":"6487ea376e1442284917c44e"}},{"name":"theme_id","in":"path","required":true,"description":"The ID of the theme","schema":{"type":"string","example":"648832dcb99296ab200fbaaa"}}]}""", theme_id=theme_id)
        query_string = await create_query_string(theme_id=theme_id)
        headers = {
            "Authorization": "Bearer " + await self._conf.getAccessToken()
        }
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import ThemeUpgradableResponseV2
            schema = ThemeUpgradableResponseV2()
            try:
                schema.load(response["json"])
            except Exception as e:
                print("Response Validation failed for checkThemeUpgradableV2")
                print(e)
