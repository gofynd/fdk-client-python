...
class EdcAggregatorAndModelListResponse(BaseSchema):
    ...
    edc_models = fields.Dict(required=False)
...
class EdcDevice(BaseSchema):
    ...
    edc_models_name = fields.Str(required=False)
    ...
    edc_models_id = fields.Int(required=False)
...
class EdcAddRequest(BaseSchema):
    ...
    edc_model_id = fields.Int(required=False)
