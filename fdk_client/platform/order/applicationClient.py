...
class Order:
    ...
    async def getQuestions(self, page_no=None, page_size=None, q=None, is_active=None, request_headers:Dict={}):
        ...
        :param is_active : To get active questions : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/question/", """{"required":[{"in":"path","name":"company_id","required":true,"schema":{"type":"string"}},{"in":"path","name":"application_id","required":true,"schema":{"type":"string"}}],"optional":[{"in":"query","name":"page_no","required":false,"schema":{"type":"integer","default":1}},{"in":"query","name":"page_size","required":false,"schema":{"type":"integer","default":10}},{"in":"query","name":"q","description":"To search questions using query","schema":{"type":"string","default":"None"}},{"in":"query","name":"is_active","description":"To get active questions","schema":{"type":"string","default":"None"}}],"query":[{"in":"query","name":"page_no","required":false,"schema":{"type":"integer","default":1}},{"in":"query","name":"page_size","required":false,"schema":{"type":"integer","default":10}},{"in":"query","name":"q","description":"To search questions using query","schema":{"type":"string","default":"None"}},{"in":"query","name":"is_active","description":"To get active questions","schema":{"type":"string","default":"None"}}],"headers":[],"path":[{"in":"path","name":"company_id","required":true,"schema":{"type":"string"}},{"in":"path","name":"application_id","required":true,"schema":{"type":"string"}}]}""", page_no=page_no, page_size=page_size, q=q, is_active=is_active)
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/question/", page_no=page_no, page_size=page_size, q=q, is_active=is_active), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def getRuleLaneConfig(self, search_value=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule-lane-config", search_value=search_value), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def createRule(self, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule", ), query_string, headers, body, exclude_headers=exclude_headers), data=body)

        if 200 <= int(response['status_code']) < 300:
            from .models import CreateRuleResponse
    ...
    async def getRuleById(self, rule_id=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule/{rule_id}", rule_id=rule_id), query_string, headers, "", exclude_headers=exclude_headers), data="")
    ...
    async def updateRule(self, rule_id=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule/{rule_id}", rule_id=rule_id), query_string, headers, body, exclude_headers=exclude_headers), data=body)

        if 200 <= int(response['status_code']) < 300:
            from .models import RuleUpdateResponse
            schema = RuleUpdateResponse()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def deleteRule(self, rule_id=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("DELETE", url_with_params, headers=get_headers_with_signature(self._conf.domain, "delete", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule/{rule_id}", rule_id=rule_id), query_string, headers, "", exclude_headers=exclude_headers), data="")

        if 200 <= int(response['status_code']) < 300:
            from .models import DeleteRuleResponse
    ...
    async def updateRulePosition(self, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule-position/", ), query_string, headers, body, exclude_headers=exclude_headers), data=body)

        if 200 <= int(response['status_code']) < 300:
            from .models import UpdateRulePositionResponse
            schema = UpdateRulePositionResponse()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getRuleList(self, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/rule_list", ), query_string, headers, body, exclude_headers=exclude_headers), data=body)
