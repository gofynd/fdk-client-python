...
class ShipmentTags1(BaseSchema):
    pass
...
class PaymentMethod1(BaseSchema):
    pass
...
class ShipmentMeta(BaseSchema):
    ...
    shipment_tags = fields.List(fields.Nested(ShipmentTags1, required=False), required=False)
...
class PaymentInfo(BaseSchema):
    ...
    payment_methods = fields.List(fields.Nested(PaymentMethod1, required=False), required=False)
