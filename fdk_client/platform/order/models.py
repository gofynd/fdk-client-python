...
class CreditNoteData(BaseSchema):
    pass
...
class CreditNoteData(BaseSchema):
    ...
    date_of_issue = fields.Str(required=False)
    
    expiry_date = fields.Str(required=False)
    
    total_balance = fields.Float(required=False)
...
class ShipmentMeta(BaseSchema):
    ...
    credit_note_data = fields.Nested(CreditNoteData, required=False)
...
class PDFLink(BaseSchema):
    ...
    credit_note_a4 = fields.Str(required=False)
...
class PlatformShipment(BaseSchema):
    ...
    pdf_links = fields.Nested(PDFLink, required=False)
