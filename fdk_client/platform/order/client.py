...
The ESM config stores order processing configuration. Each document in the ESM config collection of  Order Management System - OMS's database is a JSON object representing the configuration of a specific application ID. This includes filters, hooks, flags set on different state-transitions.  This configuration is picked and accordingly features are enabled. 
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/state/manager/config", """{"required":[{"name":"company_id","in":"path","required":true,"description":"The unique identifier of the company on the platform.","schema":{"type":"integer"}}],"optional":[{"name":"app_id","in":"query","required":false,"description":"The unique identifier of the application.","schema":{"type":"string"}},{"name":"ordering_channel","in":"query","required":false,"description":"The channel through which orders are placed.","schema":{"type":"string"}},{"name":"ordering_source","in":"query","required":false,"description":"To uniquely identify the source through which order has been placed.","schema":{"type":"string"}},{"name":"entity","in":"query","required":false,"description":"The entity for which the configuration is applied.","schema":{"type":"string"}}],"query":[{"name":"app_id","in":"query","required":false,"description":"The unique identifier of the application.","schema":{"type":"string"}},{"name":"ordering_channel","in":"query","required":false,"description":"The channel through which orders are placed.","schema":{"type":"string"}},{"name":"ordering_source","in":"query","required":false,"description":"To uniquely identify the source through which order has been placed.","schema":{"type":"string"}},{"name":"entity","in":"query","required":false,"description":"The entity for which the configuration is applied.","schema":{"type":"string"}}],"headers":[],"path":[{"name":"company_id","in":"path","required":true,"description":"The unique identifier of the company on the platform.","schema":{"type":"integer"}}]}""", serverType="platform", app_id=app_id, ordering_channel=ordering_channel, ordering_source=ordering_source, entity=entity)
    ...
    async def createOrder(self, x_ordering_source=None, x_application_id=None, x_extension_id=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import CreateOrderRequestSchema
        schema = CreateOrderRequestSchema()
        schema.dump(schema.load(body))

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/orders", """{"required":[{"name":"company_id","in":"path","description":"","required":true,"schema":{"type":"integer"}},{"in":"header","name":"x-ordering-source","description":"To uniquely identify the source through which order has been placed.","required":true,"schema":{"type":"string"}}],"optional":[{"name":"x-application-id","in":"header","description":"The Application ID is a unique identifier assigned to a storefront that typically follows a 24-character hexadecimal string. Either `x-application-id` or `x-extension-id` header is mandatory. At least one of them must be provided.","required":false,"example":"66fe99245f70599b2d63d312","schema":{"type":"string"}},{"name":"x-extension-id","in":"header","description":"The Extension ID is a unique identifier assigned to an extension that typically follows a 24-character hexadecimal string. Either `x-application-id` or `x-extension-id` header is mandatory. At least one of them must be provided.","required":false,"example":"66fe99245f70599b2d63d312","schema":{"type":"string"}}],"query":[],"headers":[{"in":"header","name":"x-ordering-source","description":"To uniquely identify the source through which order has been placed.","required":true,"schema":{"type":"string"}},{"name":"x-application-id","in":"header","description":"The Application ID is a unique identifier assigned to a storefront that typically follows a 24-character hexadecimal string. Either `x-application-id` or `x-extension-id` header is mandatory. At least one of them must be provided.","required":false,"example":"66fe99245f70599b2d63d312","schema":{"type":"string"}},{"name":"x-extension-id","in":"header","description":"The Extension ID is a unique identifier assigned to an extension that typically follows a 24-character hexadecimal string. Either `x-application-id` or `x-extension-id` header is mandatory. At least one of them must be provided.","required":false,"example":"66fe99245f70599b2d63d312","schema":{"type":"string"}}],"path":[{"name":"company_id","in":"path","description":"","required":true,"schema":{"type":"integer"}}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_application_id=x_application_id, x_extension_id=x_extension_id)
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/orders", x_ordering_source=x_ordering_source, x_application_id=x_application_id, x_extension_id=x_extension_id), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))

        return response
    
    async def createAccount(self, body="", request_headers:Dict={}):
        ...
        # Parameter validation
        schema = OrderValidator.createAccount()
        schema.dump(schema.load(payload))
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account", """{"required":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}}]}""", serverType="platform", )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account", ), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for createAccount")
                print(e)

        return response
    
    async def listAccounts(self, page=None, size=None, request_headers:Dict={}):
        ...
        :param page : The page number to retrieve in the paginated results. Default is page 1. : type integer
        :param size : Number of channel accounts to return per page. Default is 20 items per page. : type integer
        """
        payload = {}
        ...
        # Parameter validation
        schema = OrderValidator.listAccounts()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account", """{"required":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}}],"optional":[{"in":"query","name":"page","schema":{"type":"integer","default":1},"description":"The page number to retrieve in the paginated results. Default is page 1."},{"in":"query","name":"size","schema":{"type":"integer","default":20},"description":"Number of channel accounts to return per page. Default is 20 items per page."}],"query":[{"in":"query","name":"page","schema":{"type":"integer","default":1},"description":"The page number to retrieve in the paginated results. Default is page 1."},{"in":"query","name":"size","schema":{"type":"integer","default":20},"description":"Number of channel accounts to return per page. Default is 20 items per page."}],"headers":[],"path":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}}]}""", serverType="platform", page=page, size=size)
        query_string = await create_query_string(page=page, size=size)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account", page=page, size=size), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))

        if 200 <= int(response['status_code']) < 300:
            from .models import AccountsList
            schema = AccountsList()
            try:
                schema.load(response["json"])
            except Exception as e:
                print("Response Validation failed for listAccounts")
                print(e)

        return response
    
    async def getAccountById(self, channel_account_id=None, request_headers:Dict={}):
        ...
        :param channel_account_id : Unique identifier of the channel account to retrieve. : type string
        """
        payload = {}
        
        if channel_account_id is not None:
            payload["channel_account_id"] = channel_account_id

        # Parameter validation
        schema = OrderValidator.getAccountById()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account/{channel_account_id}", """{"required":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}},{"in":"path","name":"channel_account_id","required":true,"description":"Unique identifier of the channel account to retrieve.","schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}},{"in":"path","name":"channel_account_id","required":true,"description":"Unique identifier of the channel account to retrieve.","schema":{"type":"string"}}]}""", serverType="platform", channel_account_id=channel_account_id)
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account/{channel_account_id}", channel_account_id=channel_account_id), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))
        ...
        if 200 <= int(response['status_code']) < 300:
            ...
            try:
                ...
                print("Response Validation failed for getAccountById")
                print(e)

        return response
    
    async def updateAccount(self, channel_account_id=None, body="", request_headers:Dict={}):
        """Updates the details of a specific channel account.
        :param channel_account_id : Unique identifier of the account. : type string
        """
        payload = {}
        ...
        # Parameter validation
        schema = OrderValidator.updateAccount()
        schema.dump(schema.load(payload))
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account/{channel_account_id}", """{"required":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}},{"in":"path","name":"channel_account_id","required":true,"description":"Unique identifier of the account.","schema":{"type":"string"}}],"optional":[],"query":[],"headers":[],"path":[{"in":"path","name":"company_id","required":true,"description":"Unique identifier of a company on the platform.","schema":{"type":"integer"}},{"in":"path","name":"channel_account_id","required":true,"description":"Unique identifier of the account.","schema":{"type":"string"}}]}""", serverType="platform", channel_account_id=channel_account_id)
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/order-manage/v1.0/company/{self._conf.companyId}/account/{channel_account_id}", channel_account_id=channel_account_id), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
 ...
 : type string
    ...
    async def getShipments(self, lane=None, bag_status=None, status_assigned=None, status_override_lane=None, time_to_dispatch=None, search_type=None, search_value=None, from_date=None, to_date=None, start_date=None, end_date=None, status_assigned_start_date=None, status_assigned_end_date=None, dp_ids=None, stores=None, sales_channels=None, page_no=None, page_size=None, fetch_active_shipment=None, allow_inactive=None, exclude_locked_shipments=None, payment_methods=None, channel_shipment_id=None, channel_order_id=None, custom_meta=None, ordering_channel=None, company_affiliate_tag=None, my_orders=None, platform_user_id=None, sort_type=None, show_cross_company_data=None, tags=None, customer_id=None, order_type=None, group_entity=None, enforce_date_filter=None, fulfillment_type=None, ordering_source=None, channel_account_id=None, include_count=None, request_headers:Dict={}):
        ...
        :param ordering_source : Filter orders by ordering source. Accepts comma-separated values for multiple sources. : type string
        :param channel_account_id : Comma-separated channel account IDs to filter orders by specific channel accounts. : type string
        :param include_count : Set to false to skip computing the total number of matching shipments. `total_count` and `page.total` are then returned as -1; use `page.has_next` to paginate. The total can be fetched separately from the listing/count API (`GET /service/platform/order/v1.0/company/{company_id}/listing/count/`). : type boolean
        """
        payload = {}
...
- "Digital": This order type likely refers to orders that involve digital goods or services, such as software, digital subscriptions, e-books, online courses, or any other item that can be delivered electronically.
 : type string
    ...
    async def getOrders(self, lane=None, search_type=None, bag_status=None, time_to_dispatch=None, payment_methods=None, tags=None, search_value=None, from_date=None, to_date=None, start_date=None, end_date=None, dp_ids=None, stores=None, sales_channels=None, page_no=None, page_size=None, is_priority_sort=None, custom_meta=None, my_orders=None, show_cross_company_data=None, customer_id=None, order_type=None, allow_inactive=None, group_entity=None, enforce_date_filter=None, fulfillment_type=None, ordering_source=None, channel_account_id=None, include_count=None, request_headers:Dict={}):
        ...
        :param ordering_source : Filter orders by ordering source. Accepts comma-separated values for multiple sources. : type string
        :param channel_account_id : Comma-separated channel account IDs to filter orders by specific channel accounts. : type string
        :param include_count : Set to false to skip computing the total number of matching orders. `total_count` and `page.total` are then returned as -1; use `page.has_next` to paginate. The total can be fetched separately from the listing/count API (`GET /service/platform/order/v1.0/company/{company_id}/listing/count/`). : type boolean
        """
        payload = {}
    ...
    async def getListingCount(self, group_entity=None, parent_view_slug=None, child_view_slug=None, bag_status=None, status_assigned=None, time_to_dispatch=None, search_type=None, search_value=None, from_date=None, to_date=None, start_date=None, end_date=None, status_assigned_start_date=None, status_assigned_end_date=None, dp_ids=None, stores=None, sales_channels=None, fetch_active_shipment=None, allow_inactive=None, exclude_locked_shipments=None, payment_methods=None, channel_shipment_id=None, channel_order_id=None, company_affiliate_tag=None, my_orders=None, platform_user_id=None, show_cross_company_data=None, tags=None, customer_id=None, order_type=None, enforce_date_filter=None, fulfillment_type=None, ordering_source=None, channel_account_id=None, request_headers:Dict={}):
        """Get the total number of shipments or orders matching the given filters. Companion to the shipments-listing and orders-listing APIs when they are called with `include_count=false`: the listing skips computing the total and this API returns it separately. Accepts the same filter query parameters as the listing APIs; pass the same values that were sent to the listing call.
        :param group_entity : Whether to count shipments or orders. Must match the group_entity of the listing API whose count is being fetched. : type string
        :param parent_view_slug : Slug of the parent view the count is for. Used internally while resolving the request; not returned in the response. : type string
        :param child_view_slug : Slug of the child view (lane) the count is for. Used internally while resolving the request; not returned in the response. : type string
        :param bag_status : Comma separated values of bag statuses. : type string
        :param status_assigned : Used to filter shipments based on status present in shipment_status_history. For more information on these statuses, refer to the Fynd Partners documentation. : type string
        :param time_to_dispatch : Indicates the time to dispatch. : type integer
        :param search_type : Specifies the key used to determine the type of search being performed. : type string
        ...
        # Parameter validation
        schema = OrderValidator.getListingCount()
        schema.dump(schema.load(payload))
        

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/order/v1.0/company/{self._conf.companyId}/listing/count/", """{"required":[{"in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"description":"Unique identifier of a company on the platform."}],"optional":[{"in":"query","name":"group_entity","description":"Whether to count shipments or orders. Must match the group_entity of the listing API whose count is being fetched.","required":false,"schema":{"type":"string","enum":["shipments","orders"],"default":"shipments"}},{"in":"query","name":"parent_view_slug","description":"Slug of the parent view the count is for. Used internally while resolving the request; not returned in the response.","required":false,"schema":{"type":"string","example":"unfulfilled"}},{"in":"query","name":"child_view_slug","description":"Slug of the child view (lane) the count is for. Used internally while resolving the request; not returned in the response.","required":false,"schema":{"type":"string","example":"new"}},{"in":"query","name":"bag_status","description":"Comma separated values of bag statuses.","required":false,"schema":{"type":"string"}},{"in":"query","name":"status_assigned","description":"Used to filter shipments based on status present in shipment_status_history. For more information on these statuses, refer to the Fynd Partners documentation.","required":false,"schema":{"type":"string"}},{"in":"query","name":"time_to_dispatch","required":false,"description":"Indicates the time to dispatch.","schema":{"type":"integer","enum":[1,-1]}},{"in":"query","name":"search_type","description":"Specifies the key used to determine the type of search being performed.","required":false,"schema":{"type":"string","enum":["shipment_id","order_id","channel_name","fynd_order_id"]}},{"in":"query","name":"search_value","description":"The value corresponding to the search type, such as a specific shipment ID or order ID.","required":false,"schema":{"type":"string"}},{"in":"query","name":"from_date","description":"Start Date in DD-MM-YYYY format","required":false,"schema":{"type":"string","format":"date"}},{"in":"query","name":"to_date","description":"End Date in DD-MM-YYYY format","required":false,"schema":{"type":"string","format":"date"}},{"in":"query","name":"start_date","description":"The UTC start date in ISO format (YYYY-MM-DDTHH:MM:SSZ) for filtering results.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"end_date","description":"The UTC end date in ISO format (YYYY-MM-DDTHH:MM:SSZ) for filtering results.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"status_assigned_start_date","description":"Specifies the starting UTC date and time (in ISO format, YYYY-MM-DDTHH:MM:SSZ) to define the lower boundary for filtering shipments based on the `created_at` timestamp of statuses in the shipment's status history. It allows filtering statuses that were created within a  specific time range.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"status_assigned_end_date","description":"Specifies the ending UTC date and time (in ISO format, YYYY-MM-DDTHH:MM:SSZ) to define the  upper boundary for filtering shipments based on the `created_at` timestamp of statuses  in the shipment's status history.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"dp_ids","description":"A comma-separated list of delivery partner IDs to filter results by specific delivery partners.","required":false,"schema":{"type":"string"}},{"in":"query","name":"stores","description":"A comma-separated list of store IDs used to filter results to only those related to specific stores.","required":false,"schema":{"type":"string"}},{"in":"query","name":"sales_channels","description":"A comma-separated list of sales channel IDs to filter results based on the sales channels involved.","required":false,"schema":{"type":"string"}},{"in":"query","name":"fetch_active_shipment","description":"A boolean flag that indicates whether to include only active shipments in the results.","required":false,"schema":{"type":"boolean","default":true}},{"in":"query","name":"allow_inactive","description":"A flag indicating whether to allow the inclusion of inactive shipments in the results.","required":false,"schema":{"type":"boolean","default":false}},{"in":"query","name":"exclude_locked_shipments","description":"A flag to specify whether to exclude shipments that are locked from the results.","required":false,"schema":{"type":"boolean","default":true}},{"in":"query","name":"payment_methods","description":"A comma-separated list of payment methods.","required":false,"schema":{"type":"string"}},{"in":"query","name":"channel_shipment_id","description":"The shipment ID used in the application, which can be used to reference specific shipments.","required":false,"schema":{"type":"string"}},{"in":"query","name":"channel_order_id","description":"The order ID used in the application.","required":false,"schema":{"type":"string"}},{"in":"query","name":"company_affiliate_tag","required":false,"description":"A tag used to identify the company's affiliation for filtering or reporting purposes.","schema":{"type":"string"}},{"in":"query","name":"my_orders","required":false,"description":"A boolean flag indicating whether the query should return only the user's orders.","schema":{"type":"boolean"}},{"in":"query","name":"platform_user_id","required":false,"description":"The unique identifier of the user on the platform, useful for filtering orders related to a specific user.","schema":{"type":"string"}},{"in":"query","name":"show_cross_company_data","description":"A flag indicating whether to include data from both cross-company and non-cross-company orders in the results.","required":false,"schema":{"type":"boolean","default":false}},{"in":"query","name":"tags","description":"A comma-separated list of tags associated with the orders to filter results based on specific characteristics.","required":false,"schema":{"type":"string"}},{"in":"query","name":"customer_id","description":"The unique identifier for the customer associated with the query, useful for filtering results to a specific customer.","required":false,"schema":{"type":"string"}},{"in":"query","name":"order_type","description":"The type of order being queried.","required":false,"schema":{"type":"string","example":"HomeDelivery","enum":["HomeDelivery","PickAtStore","Digital"]}},{"in":"query","name":"enforce_date_filter","description":"Applies a date filter for listing shipments. This is useful when fetching data  for a specific date range while performing searches.","required":false,"schema":{"type":"boolean","default":false}},{"in":"query","name":"fulfillment_type","description":"Define the Fulfillment Type for Listing Orders, This is use when we want to get list of shipments or orders by cross store or cross company or fulfilling Store (by default), this is also depends on the login user accessType and store access","required":false,"schema":{"type":"string","example":"FULFILLMENT","enum":["FULFILLMENT","CROSS_STORE","CROSS_COMPANY"]}},{"in":"query","name":"ordering_source","description":"Filter orders by ordering source. Accepts comma-separated values for multiple sources.","required":false,"schema":{"type":"string","example":"gofynd"}},{"in":"query","name":"channel_account_id","description":"Comma-separated channel account IDs to filter orders by specific channel accounts.","required":false,"schema":{"type":"string","example":"68e7a15429f2a988886094d3,68e7a15429f2a988886094d4"}}],"query":[{"in":"query","name":"group_entity","description":"Whether to count shipments or orders. Must match the group_entity of the listing API whose count is being fetched.","required":false,"schema":{"type":"string","enum":["shipments","orders"],"default":"shipments"}},{"in":"query","name":"parent_view_slug","description":"Slug of the parent view the count is for. Used internally while resolving the request; not returned in the response.","required":false,"schema":{"type":"string","example":"unfulfilled"}},{"in":"query","name":"child_view_slug","description":"Slug of the child view (lane) the count is for. Used internally while resolving the request; not returned in the response.","required":false,"schema":{"type":"string","example":"new"}},{"in":"query","name":"bag_status","description":"Comma separated values of bag statuses.","required":false,"schema":{"type":"string"}},{"in":"query","name":"status_assigned","description":"Used to filter shipments based on status present in shipment_status_history. For more information on these statuses, refer to the Fynd Partners documentation.","required":false,"schema":{"type":"string"}},{"in":"query","name":"time_to_dispatch","required":false,"description":"Indicates the time to dispatch.","schema":{"type":"integer","enum":[1,-1]}},{"in":"query","name":"search_type","description":"Specifies the key used to determine the type of search being performed.","required":false,"schema":{"type":"string","enum":["shipment_id","order_id","channel_name","fynd_order_id"]}},{"in":"query","name":"search_value","description":"The value corresponding to the search type, such as a specific shipment ID or order ID.","required":false,"schema":{"type":"string"}},{"in":"query","name":"from_date","description":"Start Date in DD-MM-YYYY format","required":false,"schema":{"type":"string","format":"date"}},{"in":"query","name":"to_date","description":"End Date in DD-MM-YYYY format","required":false,"schema":{"type":"string","format":"date"}},{"in":"query","name":"start_date","description":"The UTC start date in ISO format (YYYY-MM-DDTHH:MM:SSZ) for filtering results.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"end_date","description":"The UTC end date in ISO format (YYYY-MM-DDTHH:MM:SSZ) for filtering results.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"status_assigned_start_date","description":"Specifies the starting UTC date and time (in ISO format, YYYY-MM-DDTHH:MM:SSZ) to define the lower boundary for filtering shipments based on the `created_at` timestamp of statuses in the shipment's status history. It allows filtering statuses that were created within a  specific time range.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"status_assigned_end_date","description":"Specifies the ending UTC date and time (in ISO format, YYYY-MM-DDTHH:MM:SSZ) to define the  upper boundary for filtering shipments based on the `created_at` timestamp of statuses  in the shipment's status history.","required":false,"schema":{"type":"string","format":"date-time"}},{"in":"query","name":"dp_ids","description":"A comma-separated list of delivery partner IDs to filter results by specific delivery partners.","required":false,"schema":{"type":"string"}},{"in":"query","name":"stores","description":"A comma-separated list of store IDs used to filter results to only those related to specific stores.","required":false,"schema":{"type":"string"}},{"in":"query","name":"sales_channels","description":"A comma-separated list of sales channel IDs to filter results based on the sales channels involved.","required":false,"schema":{"type":"string"}},{"in":"query","name":"fetch_active_shipment","description":"A boolean flag that indicates whether to include only active shipments in the results.","required":false,"schema":{"type":"boolean","default":true}},{"in":"query","name":"allow_inactive","description":"A flag indicating whether to allow the inclusion of inactive shipments in the results.","required":false,"schema":{"type":"boolean","default":false}},{"in":"query","name":"exclude_locked_shipments","description":"A flag to specify whether to exclude shipments that are locked from the results.","required":false,"schema":{"type":"boolean","default":true}},{"in":"query","name":"payment_methods","description":"A comma-separated list of payment methods.","required":false,"schema":{"type":"string"}},{"in":"query","name":"channel_shipment_id","description":"The shipment ID used in the application, which can be used to reference specific shipments.","required":false,"schema":{"type":"string"}},{"in":"query","name":"channel_order_id","description":"The order ID used in the application.","required":false,"schema":{"type":"string"}},{"in":"query","name":"company_affiliate_tag","required":false,"description":"A tag used to identify the company's affiliation for filtering or reporting purposes.","schema":{"type":"string"}},{"in":"query","name":"my_orders","required":false,"description":"A boolean flag indicating whether the query should return only the user's orders.","schema":{"type":"boolean"}},{"in":"query","name":"platform_user_id","required":false,"description":"The unique identifier of the user on the platform, useful for filtering orders related to a specific user.","schema":{"type":"string"}},{"in":"query","name":"show_cross_company_data","description":"A flag indicating whether to include data from both cross-company and non-cross-company orders in the results.","required":false,"schema":{"type":"boolean","default":false}},{"in":"query","name":"tags","description":"A comma-separated list of tags associated with the orders to filter results based on specific characteristics.","required":false,"schema":{"type":"string"}},{"in":"query","name":"customer_id","description":"The unique identifier for the customer associated with the query, useful for filtering results to a specific customer.","required":false,"schema":{"type":"string"}},{"in":"query","name":"order_type","description":"The type of order being queried.","required":false,"schema":{"type":"string","example":"HomeDelivery","enum":["HomeDelivery","PickAtStore","Digital"]}},{"in":"query","name":"enforce_date_filter","description":"Applies a date filter for listing shipments. This is useful when fetching data  for a specific date range while performing searches.","required":false,"schema":{"type":"boolean","default":false}},{"in":"query","name":"fulfillment_type","description":"Define the Fulfillment Type for Listing Orders, This is use when we want to get list of shipments or orders by cross store or cross company or fulfilling Store (by default), this is also depends on the login user accessType and store access","required":false,"schema":{"type":"string","example":"FULFILLMENT","enum":["FULFILLMENT","CROSS_STORE","CROSS_COMPANY"]}},{"in":"query","name":"ordering_source","description":"Filter orders by ordering source. Accepts comma-separated values for multiple sources.","required":false,"schema":{"type":"string","example":"gofynd"}},{"in":"query","name":"channel_account_id","description":"Comma-separated channel account IDs to filter orders by specific channel accounts.","required":false,"schema":{"type":"string","example":"68e7a15429f2a988886094d3,68e7a15429f2a988886094d4"}}],"headers":[],"path":[{"in":"path","name":"company_id","required":true,"schema":{"type":"integer"},"description":"Unique identifier of a company on the platform."}]}""", serverType="platform", group_entity=group_entity, parent_view_slug=parent_view_slug, child_view_slug=child_view_slug, bag_status=bag_status, status_assigned=status_assigned, time_to_dispatch=time_to_dispatch, search_type=search_type, search_value=search_value, from_date=from_date, to_date=to_date, start_date=start_date, end_date=end_date, status_assigned_start_date=status_assigned_start_date, status_assigned_end_date=status_assigned_end_date, dp_ids=dp_ids, stores=stores, sales_channels=sales_channels, fetch_active_shipment=fetch_active_shipment, allow_inactive=allow_inactive, exclude_locked_shipments=exclude_locked_shipments, payment_methods=payment_methods, channel_shipment_id=channel_shipment_id, channel_order_id=channel_order_id, company_affiliate_tag=company_affiliate_tag, my_orders=my_orders, platform_user_id=platform_user_id, show_cross_company_data=show_cross_company_data, tags=tags, customer_id=customer_id, order_type=order_type, enforce_date_filter=enforce_date_filter, fulfillment_type=fulfillment_type, ordering_source=ordering_source, channel_account_id=channel_account_id)
        query_string = await create_query_string(group_entity=group_entity, parent_view_slug=parent_view_slug, child_view_slug=child_view_slug, bag_status=bag_status, status_assigned=status_assigned, time_to_dispatch=time_to_dispatch, search_type=search_type, search_value=search_value, from_date=from_date, to_date=to_date, start_date=start_date, end_date=end_date, status_assigned_start_date=status_assigned_start_date, status_assigned_end_date=status_assigned_end_date, dp_ids=dp_ids, stores=stores, sales_channels=sales_channels, fetch_active_shipment=fetch_active_shipment, allow_inactive=allow_inactive, exclude_locked_shipments=exclude_locked_shipments, payment_methods=payment_methods, channel_shipment_id=channel_shipment_id, channel_order_id=channel_order_id, company_affiliate_tag=company_affiliate_tag, my_orders=my_orders, platform_user_id=platform_user_id, show_cross_company_data=show_cross_company_data, tags=tags, customer_id=customer_id, order_type=order_type, enforce_date_filter=enforce_date_filter, fulfillment_type=fulfillment_type, ordering_source=ordering_source, channel_account_id=channel_account_id)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/order/v1.0/company/{self._conf.companyId}/listing/count/", group_entity=group_entity, parent_view_slug=parent_view_slug, child_view_slug=child_view_slug, bag_status=bag_status, status_assigned=status_assigned, time_to_dispatch=time_to_dispatch, search_type=search_type, search_value=search_value, from_date=from_date, to_date=to_date, start_date=start_date, end_date=end_date, status_assigned_start_date=status_assigned_start_date, status_assigned_end_date=status_assigned_end_date, dp_ids=dp_ids, stores=stores, sales_channels=sales_channels, fetch_active_shipment=fetch_active_shipment, allow_inactive=allow_inactive, exclude_locked_shipments=exclude_locked_shipments, payment_methods=payment_methods, channel_shipment_id=channel_shipment_id, channel_order_id=channel_order_id, company_affiliate_tag=company_affiliate_tag, my_orders=my_orders, platform_user_id=platform_user_id, show_cross_company_data=show_cross_company_data, tags=tags, customer_id=customer_id, order_type=order_type, enforce_date_filter=enforce_date_filter, fulfillment_type=fulfillment_type, ordering_source=ordering_source, channel_account_id=channel_account_id), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))

        if 200 <= int(response['status_code']) < 300:
            from .models import ListingCountResponseSchema
            schema = ListingCountResponseSchema()
            try:
                schema.load(response["json"])
            except Exception as e:
                print("Response Validation failed for getListingCount")
                print(e)
