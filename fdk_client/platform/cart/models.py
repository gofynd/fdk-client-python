...
class CouponsResponseObject(BaseSchema):
    pass
...
class CouponDetailResponseObject(BaseSchema):
    pass


class TagsViewResponseObject(BaseSchema):
    pass
...
class OperationErrorResponseObject(BaseSchema):
    pass


class CartMetaConfigOperationErrorObject(BaseSchema):
    pass
...
class PromotionsResponseObject(BaseSchema):
    pass
...
class ActivePromosResponseObject(BaseSchema):
    pass
...
class TimeStampIDObject(BaseSchema):
    pass


class CartMetaConfigDetailObject(BaseSchema):
    pass


class CartMetaConfigListResponseObject(BaseSchema):
    pass
...
class CartMetaConfigAddResponseObject(BaseSchema):
    pass
...
class AddPriceAdjustmentResponseObject(BaseSchema):
    pass


class UpdatePriceAdjustmentResponseObject(BaseSchema):
    pass


class PriceAdjustmentResponsObject(BaseSchema):
    pass


class GetPriceAdjustmentResponseObject(BaseSchema):
    pass
...
class OpenapiCartDetailsRequestObject(BaseSchema):
    pass
...
class OpenapiCartDetailsResponseObject(BaseSchema):
    pass


class OpenApiErrorResponseObject(BaseSchema):
    pass
...
class OpenApiCartServiceabilityRequestObject(BaseSchema):
    pass


class OpenApiCartServiceabilityResponseObject(BaseSchema):
    pass
...
class OpenApiCheckoutResponseObject(BaseSchema):
    pass
...
class AbandonedCartResponseObject(BaseSchema):
    pass
...
class CartDetailResponseObject(BaseSchema):
    pass
...
class AddCartRequestObject(BaseSchema):
    pass


class AddCartDetailResponseObject(BaseSchema):
    pass
...
class UpdateCartRequestObject(BaseSchema):
    pass


class UpdateCartDetailResponseObject(BaseSchema):
    pass
...
class OverrideCheckoutResponseObject(BaseSchema):
    pass


class GetShareCartLinkRequestObject(BaseSchema):
    pass


class GetShareCartLinkResponseObject(BaseSchema):
    pass
...
class SharedCartResponseObject(BaseSchema):
    pass
...
class MultiCartResponseObject(BaseSchema):
    pass
...
class UserCartMappingResponseObject(BaseSchema):
    pass
...
class PlatformAddCartRequestObject(BaseSchema):
    pass


class PlatformUpdateCartRequestObject(BaseSchema):
    pass


class DeleteCartRequestObject(BaseSchema):
    pass


class DeleteCartDetailResponseObject(BaseSchema):
    pass


class CartItemCountResponseObject(BaseSchema):
    pass
...
class GetCouponResponseObject(BaseSchema):
    pass


class ApplyCouponRequestObject(BaseSchema):
    pass
...
class PlatformGetAddressesResponseObject(BaseSchema):
    pass


class SaveAddressResponseObject(BaseSchema):
    pass


class UpdateAddressResponseObject(BaseSchema):
    pass


class DeleteAddressResponseObject(BaseSchema):
    pass


class PlatformSelectCartAddressRequestObject(BaseSchema):
    pass
...
class PlatformShipmentResponseObject(BaseSchema):
    pass
...
class PlatformCartShipmentsResponseObject(BaseSchema):
    pass
...
class UpdateCartShipmentRequestObject(BaseSchema):
    pass


class PlatformCartMetaRequestObject(BaseSchema):
    pass


class CartMetaResponseObject(BaseSchema):
    pass


class CartMetaMissingResponseObject(BaseSchema):
    pass
...
class PlatformCartCheckoutDetailRequestObject(BaseSchema):
    pass
...
class CartCheckoutResponseObject(BaseSchema):
    pass


class CartDeliveryModesResponseObject(BaseSchema):
    pass
...
class StoreDetailsResponseObject(BaseSchema):
    pass


class UpdateCartPaymentRequestObject(BaseSchema):
    pass
...
class PlatformCartCheckoutDetailV2RequestObject(BaseSchema):
    pass
...
class PromotionOffersResponseObject(BaseSchema):
    pass
...
class CouponAdd(BaseSchema):
    ...
    is_plt_bypass = fields.Boolean(required=False)
...
class CouponObj(BaseSchema):
    ...
    rejected = fields.Float(required=False, allow_none=True)
    
    approved = fields.Float(required=False, allow_none=True)
...
class CouponDetailObj(BaseSchema):
    ...
    coupon_prefix = fields.Str(required=False)
    
    coupon_counts = fields.Float(required=False)
...
class Media(BaseSchema):
    ...
    alt_text = fields.Str(required=False)
...
class PromotionAddResult(BaseSchema):
    ...
    draft = fields.Float(required=False)
    
    review = fields.Float(required=False)
    
    rejected = fields.Float(required=False)
    
    approved = fields.Float(required=False)
    
    offer_counts = fields.Float(required=False)
    
    offer_prefix = fields.Str(required=False)
    
    is_bank_offer = fields.Boolean(required=False)
    
    custom_content = fields.Dict(required=False)
    
    medias = fields.List(fields.Nested(Media, required=False), required=False)
    
    offer_type = fields.Str(required=False)
    
    visibility = fields.Nested(Visibility, required=False)
...
class PriceAdjustmentApplied(BaseSchema):
    ...
    applied_articles_ids = fields.List(fields.Dict(required=False), required=False)
...
class CartDetailCoupon(BaseSchema):
    ...
    mrp_coupon = fields.Boolean(required=False)
...
class AddCartDetailResponseObject(BaseSchema):
    ...
    cart = fields.Nested(CartDetailResponseObject, required=False)
...
class PlatformAddress(BaseSchema):
    ...
    pincode = fields.Float(required=False, allow_none=True)
...
class PlatformShipmentResponseObject(BaseSchema):
    ...
    debug = fields.Dict(required=False)
...
class ShipmentMeta(BaseSchema):
    ...
    debug = fields.Dict(required=False, allow_none=True)
...
class PlatformCartShipmentsResponseObject(BaseSchema):
    ...
    shipments = fields.List(fields.Nested(PlatformShipmentResponseObject, required=False), required=False)
