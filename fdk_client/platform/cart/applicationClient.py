...
class Cart:
    ...
    async def createCoupon(self, body="", request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import CouponDetailResult
            schema = CouponDetailResult()
            try:
    ...
    async def getCoupons(self, page_no=None, page_size=None, is_archived=None, title=None, is_public=None, is_display=None, type_slug=None, code=None, created_by=None, reviewed_by=None, approved_start_time=None, approved_end_time=None, review_start_time=None, review_end_time=None, status=None, request_headers:Dict={}):
        ...
        :param page_size : Coupon max records fetched in single request : type integer
        :param is_archived : Filter by active or inactive coupon : type boolean
        :param title : Filter coupon by coupon title : type string
        :param is_public : Filter coupons which is public : type boolean
        :param is_display : Filter coupons which is visible to sales channel : type boolean
        :param type_slug : Filter by coupon type : type string
        :param code : Filter by coupon code : type string
        :param created_by : Filter by coupon creater user id : type string
        :param reviewed_by : Filter by coupon reviewer user id : type string
        :param approved_start_time : Filter coupon by start time date range when status is approved : type string
        :param approved_end_time : Filter coupon by end time date range when status is approved : type string
        :param review_start_time : Filter coupon by start time date range when status is in review state : type string
        :param review_end_time : Filter coupon by end time date range when status is in review state : type string
        :param status : Filter your coupons effortlessly by status, such as draft, review and more. : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/coupon", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0},"description":"current page no as per pagination"},{"name":"page_size","in":"query","schema":{"type":"integer","default":10},"description":"Coupon max records fetched in single request"},{"name":"is_archived","in":"query","schema":{"type":"boolean","default":false},"description":"Filter by active or inactive coupon"},{"name":"title","in":"query","schema":{"type":"string"},"description":"Filter coupon by coupon title"},{"name":"is_public","in":"query","schema":{"type":"boolean"},"description":"Filter coupons which is public"},{"name":"is_display","in":"query","schema":{"type":"boolean"},"description":"Filter coupons which is visible to sales channel"},{"name":"type_slug","in":"query","schema":{"type":"string"},"description":"Filter by coupon type"},{"name":"code","in":"query","schema":{"type":"string"},"description":"Filter by coupon code"},{"name":"created_by","in":"query","schema":{"type":"string"},"description":"Filter by coupon creater user id"},{"name":"reviewed_by","in":"query","schema":{"type":"string"},"description":"Filter by coupon reviewer user id"},{"name":"approved_start_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by start time date range when status is approved"},{"name":"approved_end_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by end time date range when status is approved"},{"name":"review_start_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by start time date range when status is in review state"},{"name":"review_end_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by end time date range when status is in review state"},{"name":"status","in":"query","schema":{"type":"string","enum":["draft","review","rejected","live","published","archived"]},"description":"Filter your coupons effortlessly by status, such as draft, review and more."}],"query":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0},"description":"current page no as per pagination"},{"name":"page_size","in":"query","schema":{"type":"integer","default":10},"description":"Coupon max records fetched in single request"},{"name":"is_archived","in":"query","schema":{"type":"boolean","default":false},"description":"Filter by active or inactive coupon"},{"name":"title","in":"query","schema":{"type":"string"},"description":"Filter coupon by coupon title"},{"name":"is_public","in":"query","schema":{"type":"boolean"},"description":"Filter coupons which is public"},{"name":"is_display","in":"query","schema":{"type":"boolean"},"description":"Filter coupons which is visible to sales channel"},{"name":"type_slug","in":"query","schema":{"type":"string"},"description":"Filter by coupon type"},{"name":"code","in":"query","schema":{"type":"string"},"description":"Filter by coupon code"},{"name":"created_by","in":"query","schema":{"type":"string"},"description":"Filter by coupon creater user id"},{"name":"reviewed_by","in":"query","schema":{"type":"string"},"description":"Filter by coupon reviewer user id"},{"name":"approved_start_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by start time date range when status is approved"},{"name":"approved_end_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by end time date range when status is approved"},{"name":"review_start_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by start time date range when status is in review state"},{"name":"review_end_time","in":"query","schema":{"type":"string"},"description":"Filter coupon by end time date range when status is in review state"},{"name":"status","in":"query","schema":{"type":"string","enum":["draft","review","rejected","live","published","archived"]},"description":"Filter your coupons effortlessly by status, such as draft, review and more."}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", page_no=page_no, page_size=page_size, is_archived=is_archived, title=title, is_public=is_public, is_display=is_display, type_slug=type_slug, code=code, created_by=created_by, reviewed_by=reviewed_by, approved_start_time=approved_start_time, approved_end_time=approved_end_time, review_start_time=review_start_time, review_end_time=review_end_time, status=status)
    ...
    async def getCouponTags(self, request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import TagsViewResult
            schema = TagsViewResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getPromotionTags(self, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/promo-tags", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[],"query":[],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
    ...
    async def getCouponById(self, id=None, request_headers:Dict={}):
        ...
        :param id : Coupon mongo _id for fetching single coupon data for editing : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/coupon/{id}", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"},{"name":"id","in":"path","required":true,"schema":{"type":"string"},"description":"Coupon mongo _id for fetching single coupon data for editing"}],"optional":[],"query":[],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"},{"name":"id","in":"path","required":true,"schema":{"type":"string"},"description":"Coupon mongo _id for fetching single coupon data for editing"}]}""", serverType="platform", id=id)
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
    ...
    async def updateCoupon(self, id=None, body="", request_headers:Dict={}):
        ...
        :param id : Coupon id for fetching single coupon data for editing : type string
        """
        payload = {}
    ...
    async def getPromotions(self, page_no=None, page_size=None, q=None, is_active=None, promo_group=None, promotion_type=None, fp_panel=None, promotion_id=None, created_by=None, reviewed_by=None, approved_start_time=None, approved_end_time=None, review_start_time=None, review_end_time=None, status=None, request_headers:Dict={}):
        ...
        :param page_no : current page no as per pagination : type integer
        :param page_size : Promotion max records fetched in single request : type integer
        :param q : Filter by promotion name or title : type string
        :param is_active : Filter by active or inactive promotion : type boolean
        :param promo_group : Filter by promotion group : type string
        :param promotion_type : Filter promotion type : type string
        :param fp_panel : Filter non extension promotions : type string
        :param promotion_id : Filter by promotion id : type string
        :param created_by : Filter by promotion creater user id : type string
        :param reviewed_by : Filter by promotion reviewer user id : type string
        :param approved_start_time : Filter promotion by start time date range when status is in approved state : type string
        :param approved_end_time : Filter promotion by end time date range when status is in approved state : type string
        :param review_start_time : Filter promotion by start time date range when status is in review state : type string
        :param review_end_time : Filter promotion by end time date range when status is in review state : type string
        :param status : Filter your promotions effortlessly by status, such as draft, review and more : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/promotion", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0},"description":"current page no as per pagination"},{"name":"page_size","in":"query","schema":{"type":"integer","default":10},"description":"Promotion max records fetched in single request"},{"name":"q","in":"query","schema":{"type":"string"},"description":"Filter by promotion name or title"},{"name":"is_active","in":"query","schema":{"type":"boolean","default":true},"description":"Filter by active or inactive promotion"},{"name":"promo_group","in":"query","schema":{"type":"string","enum":["product","cart","contract","ladder_price","limited_timer"]},"description":"Filter by promotion group"},{"name":"promotion_type","in":"query","schema":{"type":"string","enum":["percentage","amount","fixed_price","bogo","contract_price","shipping_price","ladder_price","bundle_price_percentage","bundle_price_amount","bundle_amount_percentage","custom","free_gift_items","free_non_sellable_items","external_price_adjustment_discount"]},"description":"Filter promotion type"},{"name":"fp_panel","in":"query","schema":{"type":"string"},"description":"Filter non extension promotions"},{"name":"promotion_id","in":"query","schema":{"type":"string"},"description":"Filter by promotion id"},{"name":"created_by","in":"query","schema":{"type":"string"},"description":"Filter by promotion creater user id"},{"name":"reviewed_by","in":"query","schema":{"type":"string"},"description":"Filter by promotion reviewer user id"},{"name":"approved_start_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by start time date range when status is in approved state"},{"name":"approved_end_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by end time date range when status is in approved state"},{"name":"review_start_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by start time date range when status is in review state"},{"name":"review_end_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by end time date range when status is in review state"},{"name":"status","in":"query","schema":{"type":"string","enum":["draft","review","rejected","live","published","archived"]},"description":"Filter your promotions effortlessly by status, such as draft, review and more"}],"query":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0},"description":"current page no as per pagination"},{"name":"page_size","in":"query","schema":{"type":"integer","default":10},"description":"Promotion max records fetched in single request"},{"name":"q","in":"query","schema":{"type":"string"},"description":"Filter by promotion name or title"},{"name":"is_active","in":"query","schema":{"type":"boolean","default":true},"description":"Filter by active or inactive promotion"},{"name":"promo_group","in":"query","schema":{"type":"string","enum":["product","cart","contract","ladder_price","limited_timer"]},"description":"Filter by promotion group"},{"name":"promotion_type","in":"query","schema":{"type":"string","enum":["percentage","amount","fixed_price","bogo","contract_price","shipping_price","ladder_price","bundle_price_percentage","bundle_price_amount","bundle_amount_percentage","custom","free_gift_items","free_non_sellable_items","external_price_adjustment_discount"]},"description":"Filter promotion type"},{"name":"fp_panel","in":"query","schema":{"type":"string"},"description":"Filter non extension promotions"},{"name":"promotion_id","in":"query","schema":{"type":"string"},"description":"Filter by promotion id"},{"name":"created_by","in":"query","schema":{"type":"string"},"description":"Filter by promotion creater user id"},{"name":"reviewed_by","in":"query","schema":{"type":"string"},"description":"Filter by promotion reviewer user id"},{"name":"approved_start_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by start time date range when status is in approved state"},{"name":"approved_end_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by end time date range when status is in approved state"},{"name":"review_start_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by start time date range when status is in review state"},{"name":"review_end_time","in":"query","schema":{"type":"string"},"description":"Filter promotion by end time date range when status is in review state"},{"name":"status","in":"query","schema":{"type":"string","enum":["draft","review","rejected","live","published","archived"]},"description":"Filter your promotions effortlessly by status, such as draft, review and more"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", page_no=page_no, page_size=page_size, q=q, is_active=is_active, promo_group=promo_group, promotion_type=promotion_type, fp_panel=fp_panel, promotion_id=promotion_id, created_by=created_by, reviewed_by=reviewed_by, approved_start_time=approved_start_time, approved_end_time=approved_end_time, review_start_time=review_start_time, review_end_time=review_end_time, status=status)
    ...
    async def getPromotionById(self, id=None, request_headers:Dict={}):
        ...
        :param id : Promotion id for fetching single promotion data for editing : type string
        """
        payload = {}
    ...
    async def updatePromotion(self, id=None, body="", request_headers:Dict={}):
        ...
        :param id : Promotion mongo _id for fetching single promotion data for editing : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/promotion/{id}", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"},{"name":"id","in":"path","schema":{"type":"string"},"description":"Promotion mongo _id for fetching single promotion data for editing","required":true}],"optional":[],"query":[],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"},{"name":"id","in":"path","schema":{"type":"string"},"description":"Promotion mongo _id for fetching single promotion data for editing","required":true}]}""", serverType="platform", id=id)
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
    ...
    async def deletePromotion(self, id=None, request_headers:Dict={}):
        ...
        :param id : Promotion id for fetching single promotion data for deleting : type string
        """
        payload = {}
    ...
    async def getCartMetaConfig(self, cart_meta_id=None, request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import CartMetaConfigDetailResult
            schema = CartMetaConfigDetailResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def createCartMetaConfig(self, body="", request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import CartMetaConfigAddResult
            schema = CartMetaConfigAddResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def addPriceAdjustment(self, body="", request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import AddPriceAdjustmentResult
            schema = AddPriceAdjustmentResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getPriceAdjustments(self, cart_id=None, request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import PriceAdjustmentResult
            schema = PriceAdjustmentResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def updatePriceAdjustment(self, id=None, body="", request_headers:Dict={}):
        ...
        :param id : price adjustment id for fetching single price adjustment data for editing : type string
        """
        payload = {}
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import UpdatePriceAdjustmentResult
            schema = UpdatePriceAdjustmentResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def fetchAndvalidateCartItems(self, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import OpenapiCartDetailsPayload
        schema = OpenapiCartDetailsPayload()
        schema.dump(schema.load(body))
    ...
    async def checkCartServiceability(self, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import OpenApiCartServiceabilityPayload
        schema = OpenApiCartServiceabilityPayload()
        schema.dump(schema.load(body))
    ...
    async def getAbandonedCart(self, page_no=None, page_size=None, from_date=None, to_date=None, anonymous_cart=None, last_id=None, sort_on=None, request_headers:Dict={}):
        ...
        :param page_no : current page no as per pagination : type integer
        :param page_size : Cart max records fetched in single request : type integer
        :param from_date : Cart which are created on or after from_date : type string
        :param to_date : Cart which are created on or before to_date : type string
        :param anonymous_cart : Filter by `anonymous_cart` : type boolean
        :param last_id : pagination is done based on the last_object_id : type string
        :param sort_on : on which column to sort on i.e created_on or last_modified : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/abandoned/carts", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0},"description":"current page no as per pagination"},{"name":"page_size","in":"query","schema":{"type":"integer","default":10},"description":"Cart max records fetched in single request"},{"name":"from_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or after from_date"},{"name":"to_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or before to_date"},{"name":"anonymous_cart","in":"query","schema":{"type":"boolean"},"description":"Filter by `anonymous_cart`"},{"name":"last_id","in":"query","schema":{"type":"string"},"description":"pagination is done based on the last_object_id"},{"name":"sort_on","in":"query","schema":{"type":"string","enum":["created_on","last_modified"]},"description":"on which column to sort on i.e created_on or last_modified"}],"query":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0},"description":"current page no as per pagination"},{"name":"page_size","in":"query","schema":{"type":"integer","default":10},"description":"Cart max records fetched in single request"},{"name":"from_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or after from_date"},{"name":"to_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or before to_date"},{"name":"anonymous_cart","in":"query","schema":{"type":"boolean"},"description":"Filter by `anonymous_cart`"},{"name":"last_id","in":"query","schema":{"type":"string"},"description":"pagination is done based on the last_object_id"},{"name":"sort_on","in":"query","schema":{"type":"string","enum":["created_on","last_modified"]},"description":"on which column to sort on i.e created_on or last_modified"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", page_no=page_no, page_size=page_size, from_date=from_date, to_date=to_date, anonymous_cart=anonymous_cart, last_id=last_id, sort_on=sort_on)
    ...
    async def getAbandonedCartDetails(self, id=None, i=None, b=None, c=None, request_headers:Dict={}):
        ...
        :param c : This is a boolean value. Select `true` to retrieve the cod charges in breakup of cart items. : type boolean
        """
        payload = {}
    ...
    async def getCouponCodeExists(self, code=None, request_headers:Dict={}):
        ...
        :param code : Coupon code : type string
        """
        payload = {}
    ...
    async def getPromotionCodeExists(self, code=None, request_headers:Dict={}):
        ...
        :param code : Promotion code : type string
        """
        payload = {}
    ...
    async def getCartList(self, from_date=None, to_date=None, filter_on=None, request_headers:Dict={}):
        ...
        :param from_date : Cart which are created on or after from_date. Supports ISO date format. : type string
        :param to_date : Cart which are created on or before to_date. Supports ISO date format. : type string
        :param filter_on : on which column to sort on i.e created_on or last_modified : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart-list", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"from_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or after from_date. Supports ISO date format."},{"name":"to_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or before to_date. Supports ISO date format."},{"name":"filter_on","in":"query","schema":{"type":"string","enum":["created_on","last_modified"]},"description":"on which column to sort on i.e created_on or last_modified"}],"query":[{"name":"from_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or after from_date. Supports ISO date format."},{"name":"to_date","in":"query","schema":{"type":"string","format":"date-time"},"description":"Cart which are created on or before to_date. Supports ISO date format."},{"name":"filter_on","in":"query","schema":{"type":"string","enum":["created_on","last_modified"]},"description":"on which column to sort on i.e created_on or last_modified"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", from_date=from_date, to_date=to_date, filter_on=filter_on)
    ...
    async def getItemCount(self, id=None, buy_now=None, cart_type=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/basic", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"Boolean value to get buy_now cart."},{"in":"query","name":"cart_type","schema":{"type":"string","enum":["universal"]},"description":"The type of cart"}],"query":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"Boolean value to get buy_now cart."},{"in":"query","name":"cart_type","schema":{"type":"string","enum":["universal"]},"description":"The type of cart"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", id=id, buy_now=buy_now, cart_type=cart_type)
    ...
    async def platformAddItems(self, i=None, b=None, buy_now=None, id=None, cart_type=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import PlatformAddCartPayload
        schema = PlatformAddCartPayload()
        schema.dump(schema.load(body))
    ...
    async def deleteCart(self, id=None, cart_type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart_archive", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}},{"name":"cart_type","in":"query","schema":{"type":"string","enum":["universal"]},"description":"The type of cart"}],"query":[{"name":"id","in":"query","description":"The unique identifier of the cart.","schema":{"type":"string"}},{"name":"cart_type","in":"query","schema":{"type":"string","enum":["universal"]},"description":"The type of cart"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", id=id, cart_type=cart_type)
    ...
    async def getAppCoupons(self, id=None, buy_now=None, slug=None, store_id=None, request_headers:Dict={}):
        ...
        :param store_id : Store id : type string
        """
        payload = {}
    ...
    async def removeCoupon(self, uid=None, buy_now=None, cart_type=None, request_headers:Dict={}):
        ...
        :param uid : The unique identifier of the cart : type string
        :param buy_now : This is boolean to get buy_now cart : type boolean
        :param cart_type : The type of cart : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/platform-pos-coupon", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"query","name":"uid","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart"},{"in":"query","name":"cart_type","schema":{"type":"string","enum":["universal"]},"description":"The type of cart"}],"query":[{"in":"query","name":"uid","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart"},{"in":"query","name":"cart_type","schema":{"type":"string","enum":["universal"]},"description":"The type of cart"}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", uid=uid, buy_now=buy_now, cart_type=cart_type)
    ...
    async def getAddresses(self, cart_id=None, buy_now=None, mobile_no=None, checkout_mode=None, tags=None, is_default=None, user_id=None, request_headers:Dict={}):
        ...
        :param cart_id : The unique identifier of the cart : type string
        :param buy_now : This is boolean to get buy_now cart : type boolean
        :param mobile_no : 10-digit mobile number : type string
        :param checkout_mode : Option to checkout for `self` or for `others`. By default, it is `self`. : type string
        ...
        :param user_id : Option to fetch address for the provided user_id. : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/address", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"cart_id","in":"query","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart"},{"in":"query","name":"mobile_no","schema":{"type":"string"},"description":"10-digit mobile number"},{"in":"query","name":"checkout_mode","schema":{"type":"string","enum":["self"]},"description":"Option to checkout for `self` or for `others`. By default, it is `self`."},{"in":"query","name":"tags","schema":{"type":"string","enum":["work","home"]},"description":"Tag given to an address, e.g. work, home, office, shop."},{"in":"query","name":"is_default","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to fetch the default address."},{"in":"query","name":"user_id","schema":{"type":"string"},"description":"Option to fetch address for the provided user_id."}],"query":[{"name":"cart_id","in":"query","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart"},{"in":"query","name":"mobile_no","schema":{"type":"string"},"description":"10-digit mobile number"},{"in":"query","name":"checkout_mode","schema":{"type":"string","enum":["self"]},"description":"Option to checkout for `self` or for `others`. By default, it is `self`."},{"in":"query","name":"tags","schema":{"type":"string","enum":["work","home"]},"description":"Tag given to an address, e.g. work, home, office, shop."},{"in":"query","name":"is_default","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to fetch the default address."},{"in":"query","name":"user_id","schema":{"type":"string"},"description":"Option to fetch address for the provided user_id."}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", cart_id=cart_id, buy_now=buy_now, mobile_no=mobile_no, checkout_mode=checkout_mode, tags=tags, is_default=is_default, user_id=user_id)
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import PlatformGetAddressesResult
            schema = PlatformGetAddressesResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getAddressById(self, id=None, cart_id=None, buy_now=None, mobile_no=None, checkout_mode=None, tags=None, is_default=None, user_id=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/address/{id}", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application _id","in":"path","required":true,"name":"application_id"},{"name":"id","in":"path","schema":{"type":"string"},"description":"ID allotted to the selected address","required":true}],"optional":[{"name":"cart_id","in":"query","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart"},{"in":"query","name":"mobile_no","schema":{"type":"string"},"description":"10-digit mobile number"},{"in":"query","name":"checkout_mode","schema":{"type":"string","enum":["self"]},"description":"Option to checkout for self or for others"},{"in":"query","name":"tags","schema":{"type":"string","enum":["home"]},"description":"Tag given to an address, e.g. work, home, office, shop."},{"in":"query","name":"is_default","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to fetch the default address."},{"in":"query","name":"user_id","schema":{"type":"string"},"description":"Option to fetch address for the provided user_id."}],"query":[{"name":"cart_id","in":"query","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart"},{"in":"query","name":"mobile_no","schema":{"type":"string"},"description":"10-digit mobile number"},{"in":"query","name":"checkout_mode","schema":{"type":"string","enum":["self"]},"description":"Option to checkout for self or for others"},{"in":"query","name":"tags","schema":{"type":"string","enum":["home"]},"description":"Tag given to an address, e.g. work, home, office, shop."},{"in":"query","name":"is_default","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to fetch the default address."},{"in":"query","name":"user_id","schema":{"type":"string"},"description":"Option to fetch address for the provided user_id."}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application _id","in":"path","required":true,"name":"application_id"},{"name":"id","in":"path","schema":{"type":"string"},"description":"ID allotted to the selected address","required":true}]}""", serverType="platform", id=id, cart_id=cart_id, buy_now=buy_now, mobile_no=mobile_no, checkout_mode=checkout_mode, tags=tags, is_default=is_default, user_id=user_id)
        query_string = await create_query_string(cart_id=cart_id, buy_now=buy_now, mobile_no=mobile_no, checkout_mode=checkout_mode, tags=tags, is_default=is_default, user_id=user_id)
        if query_string:
            url_with_params += "?" + query_string
    ...
    async def selectAddress(self, cart_id=None, buy_now=None, i=None, b=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import PlatformSelectCartAddressPayload
        schema = PlatformSelectCartAddressPayload()
        schema.dump(schema.load(body))
    ...
    async def getShipments(self, pick_at_store_uid=None, ordering_store_id=None, i=None, p=None, id=None, address_id=None, area_code=None, order_type=None, request_headers:Dict={}):
        ...
        :param pick_at_store_uid : ID of the store from where the order will be picked up by the customer, assuming the order_type is `PickAtStore`. This may or may not be the same as the ID of the ordering store. : type integer
        :param ordering_store_id : ID of the store where the customer is ordering from. : type integer
        :param i : This is a boolean value. Select `true` to retrieve all the items added in the cart. : type boolean
        :param p : This is a boolean value. Select `true` for getting a payment option in response. : type boolean
        :param id : The unique identifier of the cart : type string
    ...
    async def updateCartMeta(self, id=None, buy_now=None, user_id=None, body="", request_headers:Dict={}):
        ...
        :param id : The unique identifier of the cart : type string
        :param buy_now : this is boolean to get buy_now cart : type boolean
        :param user_id : Option to update cart meta for the provided user_id : type string
        """
        payload = {}
        ...
        # Body validation
        from .models import PlatformCartMetaPayload
        schema = PlatformCartMetaPayload()
        schema.dump(schema.load(body))
    ...
    async def platformCheckoutCart(self, id=None, cart_type=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import PlatformCartCheckoutDetailPayload
        schema = PlatformCartCheckoutDetailPayload()
        schema.dump(schema.load(body))
    ...
    async def getAvailableDeliveryModes(self, area_code=None, id=None, request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import CartDeliveryModesResult
            schema = CartDeliveryModesResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def getStoreAddressByUid(self, store_uid=None, request_headers:Dict={}):
        ...
        if 200 <= int(response['status_code']) < 300:
            from .models import StoreDetailsResult
            schema = StoreDetailsResult()
            try:
                schema.load(response["json"])
            except Exception as e:
    ...
    async def selectPaymentMode(self, id=None, buy_now=None, order_type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/payment", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}},{"in":"query","name":"order_type","description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself.","schema":{"type":"string","description":"This is boolean to get buy_now cart","enum":["HomeDelivery"]}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}},{"in":"query","name":"order_type","description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself.","schema":{"type":"string","description":"This is boolean to get buy_now cart","enum":["HomeDelivery"]}}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", id=id, buy_now=buy_now, order_type=order_type)
    ...
    async def platformCheckoutCartV2(self, id=None, cart_type=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import PlatformCartCheckoutDetailV2Payload
        schema = PlatformCartCheckoutDetailV2Payload()
        schema.dump(schema.load(body))
    ...
    async def selectPaymentModeV2(self, id=None, buy_now=None, order_type=None, body="", request_headers:Dict={}):
        ...
        # Body validation
        from .models import UpdateCartPaymentPayloadV2
        schema = UpdateCartPaymentPayloadV2()
        schema.dump(schema.load(body))
