...
class Cart:
    ...
    async def getCoupons(self, page_no=None, page_size=None, is_archived=None, title=None, is_public=None, is_display=None, type_slug=None, code=None, created_by=None, reviewed_by=None, approved_start_time=None, approved_end_time=None, review_start_time=None, review_end_time=None, status=None, filter_tags=None, request_headers:Dict={}):
        ...
        :param filter_tags : Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=homepage&filter_tags=seasonal`). Entities matching any provided tag are returned (OR). : type string
        """
        payload = {}
    ...
    async def getPromotions(self, page_no=None, page_size=None, q=None, is_active=None, promo_group=None, promotion_type=None, fp_panel=None, promotion_id=None, created_by=None, reviewed_by=None, approved_start_time=None, approved_end_time=None, review_start_time=None, review_end_time=None, status=None, filter_tags=None, request_headers:Dict={}):
        ...
        :param review_end_time :  : type string
        :param status :  : type string
        :param filter_tags : Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=flash_sale&filter_tags=vip`). Entities matching any provided tag are returned (OR). : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/promotion", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0,"description":"current page no as per pagination"}},{"name":"page_size","in":"query","schema":{"type":"integer","default":10,"description":"Promotion max records fetched in single request"}},{"name":"q","in":"query","schema":{"type":"string","description":"Filter by promotion name or title"}},{"name":"is_active","in":"query","schema":{"type":"boolean","description":"Filter by active or inactive promotion","default":true}},{"name":"promo_group","in":"query","schema":{"type":"string","description":"Filter by promotion group","enum":["product","cart","contract","ladder_price","limited_timer"]}},{"name":"promotion_type","in":"query","schema":{"type":"string","description":"Filter by promotion type","enum":["percentage","amount","fixed_price","bogo","contract_price","shipping_price","ladder_price","bundle_price_percentage","bundle_price_amount","bundle_amount_percentage","custom","free_gift_items","free_non_sellable_items","external_price_adjustment_discount","item_based_discount"]}},{"name":"fp_panel","in":"query","schema":{"type":"string","description":"Filter non extension promotions"}},{"name":"promotion_id","in":"query","schema":{"type":"string","description":"Filter by promotion id"}},{"name":"created_by","in":"query","schema":{"type":"string","description":"Filter by promotion creater user id"}},{"name":"reviewed_by","in":"query","schema":{"type":"string","description":"Filter by promotion reviewer user id"}},{"name":"approved_start_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by start time date range when status is in approved state"}},{"name":"approved_end_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by end time date range when status is in approved state"}},{"name":"review_start_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by start time date range when status is in review state"}},{"name":"review_end_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by end time date range when status is in review state"}},{"name":"status","in":"query","schema":{"type":"string","description":"Filter your promotions effortlessly by status, such as draft, review and more","enum":["draft","review","rejected","live","published"]}},{"name":"filter_tags","in":"query","description":"Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=flash_sale&filter_tags=vip`). Entities matching any provided tag are returned (OR).","schema":{"type":"string"}}],"query":[{"name":"page_no","in":"query","schema":{"type":"integer","default":0,"description":"current page no as per pagination"}},{"name":"page_size","in":"query","schema":{"type":"integer","default":10,"description":"Promotion max records fetched in single request"}},{"name":"q","in":"query","schema":{"type":"string","description":"Filter by promotion name or title"}},{"name":"is_active","in":"query","schema":{"type":"boolean","description":"Filter by active or inactive promotion","default":true}},{"name":"promo_group","in":"query","schema":{"type":"string","description":"Filter by promotion group","enum":["product","cart","contract","ladder_price","limited_timer"]}},{"name":"promotion_type","in":"query","schema":{"type":"string","description":"Filter by promotion type","enum":["percentage","amount","fixed_price","bogo","contract_price","shipping_price","ladder_price","bundle_price_percentage","bundle_price_amount","bundle_amount_percentage","custom","free_gift_items","free_non_sellable_items","external_price_adjustment_discount","item_based_discount"]}},{"name":"fp_panel","in":"query","schema":{"type":"string","description":"Filter non extension promotions"}},{"name":"promotion_id","in":"query","schema":{"type":"string","description":"Filter by promotion id"}},{"name":"created_by","in":"query","schema":{"type":"string","description":"Filter by promotion creater user id"}},{"name":"reviewed_by","in":"query","schema":{"type":"string","description":"Filter by promotion reviewer user id"}},{"name":"approved_start_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by start time date range when status is in approved state"}},{"name":"approved_end_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by end time date range when status is in approved state"}},{"name":"review_start_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by start time date range when status is in review state"}},{"name":"review_end_time","in":"query","schema":{"type":"string","format":"date-time","description":"Filter promotion by end time date range when status is in review state"}},{"name":"status","in":"query","schema":{"type":"string","description":"Filter your promotions effortlessly by status, such as draft, review and more","enum":["draft","review","rejected","live","published"]}},{"name":"filter_tags","in":"query","description":"Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=flash_sale&filter_tags=vip`). Entities matching any provided tag are returned (OR).","schema":{"type":"string"}}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", page_no=page_no, page_size=page_size, q=q, is_active=is_active, promo_group=promo_group, promotion_type=promotion_type, fp_panel=fp_panel, promotion_id=promotion_id, created_by=created_by, reviewed_by=reviewed_by, approved_start_time=approved_start_time, approved_end_time=approved_end_time, review_start_time=review_start_time, review_end_time=review_end_time, status=status, filter_tags=filter_tags)
    ...
    async def getPromotionOffers(self, slug=None, page_size=None, promotion_group=None, store_id=None, cart_type=None, promotion_type=None, cart_id=None, auto_apply=None, request_headers:Dict={}):
        ...
        :param promotion_type : Type of promotion to be fetched : type string
        :param cart_id : The unique identifier of the user cart. : type string
        :param auto_apply : Indicates whether to filter promotions based on their auto_apply status. : type boolean
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/available-promotions", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id","in":"path","required":true,"name":"application_id"}],"optional":[{"name":"slug","description":"A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/","in":"query","schema":{"type":"string"}},{"name":"page_size","description":"Number of offers to be fetched to show","in":"query","schema":{"type":"integer"}},{"name":"promotion_group","description":"Type of promotion groups","in":"query","schema":{"type":"string"}},{"name":"store_id","description":"Unique identifier of a store","in":"query","schema":{"type":"integer"}},{"name":"cart_type","in":"query","schema":{"type":"string","x-not-enum":true},"description":"The type of cart"},{"name":"promotion_type","description":"Type of promotion to be fetched","in":"query","schema":{"type":"string","x-not-enum":true}},{"name":"cart_id","in":"query","schema":{"type":"string"},"description":"The unique identifier of the user cart."},{"name":"auto_apply","in":"query","schema":{"type":"boolean"},"description":"Indicates whether to filter promotions based on their auto_apply status."}],"query":[{"name":"slug","description":"A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/","in":"query","schema":{"type":"string"}},{"name":"page_size","description":"Number of offers to be fetched to show","in":"query","schema":{"type":"integer"}},{"name":"promotion_group","description":"Type of promotion groups","in":"query","schema":{"type":"string"}},{"name":"store_id","description":"Unique identifier of a store","in":"query","schema":{"type":"integer"}},{"name":"cart_type","in":"query","schema":{"type":"string","x-not-enum":true},"description":"The type of cart"},{"name":"promotion_type","description":"Type of promotion to be fetched","in":"query","schema":{"type":"string","x-not-enum":true}},{"name":"cart_id","in":"query","schema":{"type":"string"},"description":"The unique identifier of the user cart."},{"name":"auto_apply","in":"query","schema":{"type":"boolean"},"description":"Indicates whether to filter promotions based on their auto_apply status."}],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", slug=slug, page_size=page_size, promotion_group=promotion_group, store_id=store_id, cart_type=cart_type, promotion_type=promotion_type, cart_id=cart_id, auto_apply=auto_apply)
        query_string = await create_query_string(slug=slug, page_size=page_size, promotion_group=promotion_group, store_id=store_id, cart_type=cart_type, promotion_type=promotion_type, cart_id=cart_id, auto_apply=auto_apply)
        if query_string:
            url_with_params += "?" + query_string
    ...
    async def fetchAndvalidateCartItems(self, x_ordering_source=None, x_ordering_source_type=None, x_location_detail=None, x_currency_code=None, body="", request_headers:Dict={}):
        ...
        :param x-ordering-source-type : Ordering source type header, to be used to identify source type of order creation. : type string
        ...
        if x_ordering_source_type is not None:
            payload["x_ordering_source_type"] = x_ordering_source_type
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart/validate", """{"required":[{"schema":{"type":"string"},"description":"Unique identifier of the company","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier of the sales channel application","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-location-detail","schema":{"type":"string"},"description":"Location details for the cart checkout","example":{"country":"INDIA","country_iso_code":"IN","pincode":"400093","city":"Mumbai","state":"Maharashtra"}},{"in":"header","name":"x-currency-code","schema":{"type":"string","default":"INR"},"description":"Currency code for transactions."}],"query":[],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-location-detail","schema":{"type":"string"},"description":"Location details for the cart checkout","example":{"country":"INDIA","country_iso_code":"IN","pincode":"400093","city":"Mumbai","state":"Maharashtra"}},{"in":"header","name":"x-currency-code","schema":{"type":"string","default":"INR"},"description":"Currency code for transactions."}],"path":[{"schema":{"type":"string"},"description":"Unique identifier of the company","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier of the sales channel application","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_location_detail=x_location_detail, x_currency_code=x_currency_code, )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart/validate", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_location_detail=x_location_detail, x_currency_code=x_currency_code), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def checkCartServiceability(self, x_ordering_source=None, x_ordering_source_type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart/serviceability", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string","x-not-enum":true},"description":"Ordering source type header, to be used to identify source type of order creation."}],"query":[],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string","x-not-enum":true},"description":"Ordering source type header, to be used to identify source type of order creation."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
    ...
    async def checkCODServiceability(self, body="", request_headers:Dict={}):
        ...
        # Parameter validation
        schema = CartValidator.checkCODServiceability()
        schema.dump(schema.load(payload))
        
        # Body validation
        from .models import PlatformCartCODServiceabilityCreation
        schema = PlatformCartCODServiceabilityCreation()
        schema.dump(schema.load(body))

        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/serviceability/cod", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[],"query":[],"headers":[],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/serviceability/cod", ), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))

        if 200 <= int(response['status_code']) < 300:
            from .models import PlatformCartCODServiceabilityResult
            schema = PlatformCartCODServiceabilityResult()
            try:
                schema.load(response["json"])
            except Exception as e:
                print("Response Validation failed for checkCODServiceability")
                print(e)

        return response
    
    async def checkoutCart(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, x_location_detail=None, x_currency_code=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart/checkout", """{"required":[{"schema":{"type":"string"},"description":"Unique identifier of the company for which the cart checkout is being performed.","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier for the sales channel application","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"It allows operations on cross-platform anonymous carts. When provided, the system retrieves the cart using only the cart_id, ignoring the user_id. Use this when interacting with an anonymous or guest cart across platforms."},{"in":"header","name":"x-location-detail","schema":{"type":"string"},"description":"Location details for the cart checkout","example":{"country":"INDIA","country_iso_code":"IN","pincode":"400093","city":"Mumbai","state":"Maharashtra"}},{"in":"header","name":"x-currency-code","schema":{"type":"string","default":"INR"},"description":"Currency code for transactions. Defaults to INR if the location is India."}],"query":[],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"It allows operations on cross-platform anonymous carts. When provided, the system retrieves the cart using only the cart_id, ignoring the user_id. Use this when interacting with an anonymous or guest cart across platforms."},{"in":"header","name":"x-location-detail","schema":{"type":"string"},"description":"Location details for the cart checkout","example":{"country":"INDIA","country_iso_code":"IN","pincode":"400093","city":"Mumbai","state":"Maharashtra"}},{"in":"header","name":"x-currency-code","schema":{"type":"string","default":"INR"},"description":"Currency code for transactions. Defaults to INR if the location is India."}],"path":[{"schema":{"type":"string"},"description":"Unique identifier of the company for which the cart checkout is being performed.","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier for the sales channel application","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, x_location_detail=x_location_detail, x_currency_code=x_currency_code, )
        query_string = await create_query_string()
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/cart/checkout", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, x_location_detail=x_location_detail, x_currency_code=x_currency_code), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def overrideCart(self, x_ordering_source=None, x_ordering_source_type=None, x_location_detail=None, x_currency_code=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/checkout/over-ride", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_location_detail=x_location_detail, x_currency_code=x_currency_code), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def getCart(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, id=None, user_id=None, order_type=None, i=None, b=None, assign_card_id=None, buy_now=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id, user_id=user_id, order_type=order_type, i=i, b=b, assign_card_id=assign_card_id, buy_now=buy_now), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def platformAddItems(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, i=None, b=None, include_cart_calculation=None, buy_now=None, order_type=None, id=None, body="", request_headers:Dict={}):
        ...
        :param i : This is a boolean value. Select `true` to retrieve all the items added in the cart. : type boolean
        :param b : This is a boolean value. Select `true` to retrieve the price breakup of cart items. : type boolean
        :param include_cart_calculation : Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`. : type boolean
        :param buy_now : This is a boolen value. Select `true` to set/initialize buy now cart : type boolean
        :param order_type : The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself. : type string
        :param id : The unique identifier of the cart : type string
        """
        ...
        if b is not None:
            payload["b"] = b
        if include_cart_calculation is not None:
            payload["include_cart_calculation"] = include_cart_calculation
        if buy_now is not None:
            payload["buy_now"] = buy_now
        if order_type is not None:
            payload["order_type"] = order_type
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."},{"in":"query","name":"include_cart_calculation","schema":{"type":"boolean"},"description":"Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is a boolen value. Select `true` to set/initialize buy now cart"},{"in":"query","name":"order_type","schema":{"type":"string","x-not-enum":true},"description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself."},{"in":"query","name":"id","schema":{"type":"string"},"description":"The unique identifier of the cart"}],"query":[{"in":"query","name":"i","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."},{"in":"query","name":"include_cart_calculation","schema":{"type":"boolean"},"description":"Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is a boolen value. Select `true` to set/initialize buy now cart"},{"in":"query","name":"order_type","schema":{"type":"string","x-not-enum":true},"description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself."},{"in":"query","name":"id","schema":{"type":"string"},"description":"The unique identifier of the cart"}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, i=i, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now, order_type=order_type, id=id)
        query_string = await create_query_string(i=i, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now, order_type=order_type, id=id)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, i=i, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now, order_type=order_type, id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def platformUpdateCart(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, id=None, i=None, order_type=None, b=None, include_cart_calculation=None, buy_now=None, body="", request_headers:Dict={}):
        """Customers can modify added product attributes such as quantity and size, as well as remove items from the cart.
        :param x-ordering-source : Ordering source header, to be used to identify source of order creation. : type string
        :param x-ordering-source-type : Ordering source type header, to be used to identify source type of order creation. : type string
        :param x-anonymous-cart : Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id. : type string
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."},{"in":"query","name":"id","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."},{"in":"query","name":"order_type","schema":{"type":"string","x-not-enum":true},"description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."},{"in":"query","name":"include_cart_calculation","schema":{"type":"boolean"},"description":"Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is a boolen value. Select `true` to set/initialize buy now cart"}],"query":[{"in":"query","name":"id","schema":{"type":"string"},"description":"The unique identifier of the cart"},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."},{"in":"query","name":"order_type","schema":{"type":"string","x-not-enum":true},"description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."},{"in":"query","name":"include_cart_calculation","schema":{"type":"boolean"},"description":"Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is a boolen value. Select `true` to set/initialize buy now cart"}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id, i=i, order_type=order_type, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now)
        query_string = await create_query_string(id=id, i=i, order_type=order_type, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id, i=i, order_type=order_type, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def updateCartBreakup(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, id=None, i=None, b=None, include_cart_calculation=None, buy_now=None, body="", request_headers:Dict={}):
        ...
        :param x-ordering-source-type : Identifier for the ordering source type (e.g., storefront, store_os_pos, kiosk). Used to determine the source type for order governance and validations. : type string
        :param x-anonymous-cart : Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id. : type string
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", """{"required":[{"schema":{"type":"string"},"description":"Unique identifier of the company associated with the current cart.","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier of the sales channel (e.g., website, app) for which the cart belongs.","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Identifier for the ordering source (e.g., web, mobile app, POS). Used to determine the origin of the order request and apply source-specific rules."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Identifier for the ordering source type (e.g., storefront, store_os_pos, kiosk). Used to determine the source type for order governance and validations."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."},{"in":"query","name":"id","schema":{"type":"string"},"description":"Unique identifier of the cart for which the breakup needs to be updated."},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"Set to `true` to include all items currently added to the cart in the response."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"Set to `true` to include the detailed price breakup of each cart item in the response."},{"in":"query","name":"include_cart_calculation","schema":{"type":"boolean"},"description":"Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"Set to `true` to initialize a \"Buy Now\" cart flow, enabling direct checkout for a single item."}],"query":[{"in":"query","name":"id","schema":{"type":"string"},"description":"Unique identifier of the cart for which the breakup needs to be updated."},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"Set to `true` to include all items currently added to the cart in the response."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"Set to `true` to include the detailed price breakup of each cart item in the response."},{"in":"query","name":"include_cart_calculation","schema":{"type":"boolean"},"description":"Set to `false` to skip recalculating and fetching the updated cart after the edit. Defaults to `true`."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"Set to `true` to initialize a \"Buy Now\" cart flow, enabling direct checkout for a single item."}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Identifier for the ordering source (e.g., web, mobile app, POS). Used to determine the origin of the order request and apply source-specific rules."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Identifier for the ordering source type (e.g., storefront, store_os_pos, kiosk). Used to determine the source type for order governance and validations."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."}],"path":[{"schema":{"type":"string"},"description":"Unique identifier of the company associated with the current cart.","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier of the sales channel (e.g., website, app) for which the cart belongs.","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id, i=i, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now)
        query_string = await create_query_string(id=id, i=i, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("PATCH", url_with_params, headers=get_headers_with_signature(self._conf.domain, "patch", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/detail", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id, i=i, b=b, include_cart_calculation=include_cart_calculation, buy_now=buy_now), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def applyCoupon(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, i=None, b=None, p=None, id=None, buy_now=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/platform-pos-coupon", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."},{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"p","schema":{"type":"boolean","description":"This is a boolean value. Select `true` for getting a payment option in response."}},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}}],"query":[{"in":"query","name":"i","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve all the items added in the cart."}},{"in":"query","name":"b","schema":{"type":"boolean","description":"This is a boolean value. Select `true` to retrieve the price breakup of cart items."}},{"in":"query","name":"p","schema":{"type":"boolean","description":"This is a boolean value. Select `true` for getting a payment option in response."}},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, i=i, b=b, p=p, id=id, buy_now=buy_now)
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/platform-pos-coupon", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, i=i, b=b, p=p, id=id, buy_now=buy_now), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def removeCoupon(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, uid=None, buy_now=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/platform-pos-coupon", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."},{"in":"query","name":"uid","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}}],"query":[{"in":"query","name":"uid","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, uid=uid, buy_now=buy_now)
        ...
        response = await AiohttpHelper().aiohttp_request("DELETE", url_with_params, headers=get_headers_with_signature(self._conf.domain, "delete", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/platform-pos-coupon", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, uid=uid, buy_now=buy_now), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def selectAddress(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, cart_id=None, buy_now=None, i=None, b=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/select-address", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, cart_id=cart_id, buy_now=buy_now, i=i, b=b), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def platformCheckoutCart(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, id=None, body="", request_headers:Dict={}):
        """The checkout cart initiates the order creation process based on the selected address and payment method. It revalidates the cart details to ensure safe and seamless order placement.
        :param x-ordering-source : Ordering source header, to be used to identify source of order creation. : type string
        :param x-ordering-source-type : Ordering source type header, to be used to identify source type of order creation. : type string
        :param x-anonymous-cart : Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id. : type string
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/checkout", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application _id","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."},{"in":"query","name":"id","required":false,"schema":{"type":"string"},"description":"The unique identifier of the cart"}],"query":[{"in":"query","name":"id","required":false,"schema":{"type":"string"},"description":"The unique identifier of the cart"}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"Anonymous cart header used to perform operations on cross-platform anonymous cart. When enabled, the system fetches the cart only based on cart_id instead of user_id."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application _id","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id)
        query_string = await create_query_string(id=id)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/checkout", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def selectPaymentMode(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, id=None, buy_now=None, order_type=None, body="", request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/payment", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, id=id, buy_now=buy_now, order_type=order_type), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def validateCouponForPayment(self, x_ordering_source=None, x_ordering_source_type=None, id=None, buy_now=None, address_id=None, payment_mode=None, payment_identifier=None, aggregator_name=None, merchant_code=None, request_headers:Dict={}):
        ...
        response = await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain(f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/payment/validate/", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, id=id, buy_now=buy_now, address_id=address_id, payment_mode=payment_mode, payment_identifier=payment_identifier, aggregator_name=aggregator_name, merchant_code=merchant_code), query_string, headers, "", exclude_headers=exclude_headers), data="", debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def platformCheckoutCartV2(self, x_ordering_source=None, x_ordering_source_type=None, x_anonymous_cart=None, x_location_detail=None, x_currency_code=None, id=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/checkout", """{"required":[{"schema":{"type":"string"},"description":"Unique identifier of the company","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier for the sales channel application","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation"},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"It allows operations on cross-platform anonymous carts. When provided, the system retrieves the cart using only the cart_id, ignoring the user_id. Use this when interacting with an anonymous or guest cart across platforms."},{"in":"header","name":"x-location-detail","schema":{"type":"string","format":"json"},"description":"Location information for the cart","example":{"country":"INDIA","country_iso_code":"IN","pincode":"400001","city":"Mumbai","state":"Maharashtra"}},{"in":"header","name":"x-currency-code","schema":{"type":"string","default":"INR"},"description":"Currency code for the transaction. Defaults to INR if the order location is India."},{"in":"query","name":"id","required":false,"schema":{"type":"string"},"description":"Unique identifier of the cart"}],"query":[{"in":"query","name":"id","required":false,"schema":{"type":"string"},"description":"Unique identifier of the cart"}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation"},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string"},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"header","name":"x-anonymous-cart","schema":{"type":"string"},"description":"It allows operations on cross-platform anonymous carts. When provided, the system retrieves the cart using only the cart_id, ignoring the user_id. Use this when interacting with an anonymous or guest cart across platforms."},{"in":"header","name":"x-location-detail","schema":{"type":"string","format":"json"},"description":"Location information for the cart","example":{"country":"INDIA","country_iso_code":"IN","pincode":"400001","city":"Mumbai","state":"Maharashtra"}},{"in":"header","name":"x-currency-code","schema":{"type":"string","default":"INR"},"description":"Currency code for the transaction. Defaults to INR if the order location is India."}],"path":[{"schema":{"type":"string"},"description":"Unique identifier of the company","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Unique identifier for the sales channel application","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, x_location_detail=x_location_detail, x_currency_code=x_currency_code, id=id)
        query_string = await create_query_string(id=id)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/checkout", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, x_anonymous_cart=x_anonymous_cart, x_location_detail=x_location_detail, x_currency_code=x_currency_code, id=id), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def selectPaymentModeV2(self, x_ordering_source=None, x_ordering_source_type=None, id=None, buy_now=None, order_type=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/payment", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string","x-not-enum":true},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}},{"in":"query","name":"order_type","schema":{"type":"string","description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself.","x-not-enum":true}}],"query":[{"in":"query","name":"id","schema":{"type":"string","description":"The unique identifier of the cart"}},{"in":"query","name":"buy_now","schema":{"type":"boolean","description":"This is boolean to get buy_now cart"}},{"in":"query","name":"order_type","schema":{"type":"string","description":"The order type of shipment HomeDelivery - If the customer wants the order home-delivered PickAtStore - If the customer wants the handover of an order at the store itself.","x-not-enum":true}}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string","x-not-enum":true},"description":"Ordering source type header, to be used to identify source type of order creation."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, id=id, buy_now=buy_now, order_type=order_type)
        query_string = await create_query_string(id=id, buy_now=buy_now, order_type=order_type)
        if query_string:
            url_with_params += "?" + query_string
        ...
        response = await AiohttpHelper().aiohttp_request("PUT", url_with_params, headers=get_headers_with_signature(self._conf.domain, "put", await create_url_without_domain(f"/service/platform/cart/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/payment", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, id=id, buy_now=buy_now, order_type=order_type), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def applyLoyaltyPoints(self, x_ordering_source=None, x_ordering_source_type=None, id=None, i=None, b=None, buy_now=None, body="", request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/redeem", """{"required":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}],"optional":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string","x-not-enum":true},"description":"Ordering source type header, to be used to identify source type of order creation."},{"in":"query","name":"id","schema":{"type":"string"},"description":"The unique identifier of the cart."},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"Select `true` to retrieve all the items added in the cart."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"Select `true` to retrieve the price breakup of cart items."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart."}],"query":[{"in":"query","name":"id","schema":{"type":"string"},"description":"The unique identifier of the cart."},{"in":"query","name":"i","schema":{"type":"boolean"},"description":"Select `true` to retrieve all the items added in the cart."},{"in":"query","name":"b","schema":{"type":"boolean"},"description":"Select `true` to retrieve the price breakup of cart items."},{"in":"query","name":"buy_now","schema":{"type":"boolean"},"description":"This is boolean to get buy_now cart."}],"headers":[{"in":"header","name":"x-ordering-source","schema":{"type":"string"},"description":"Ordering source header, to be used to identify source of order creation."},{"in":"header","name":"x-ordering-source-type","schema":{"type":"string","x-not-enum":true},"description":"Ordering source type header, to be used to identify source type of order creation."}],"path":[{"schema":{"type":"string"},"description":"Current company id","in":"path","required":true,"name":"company_id"},{"schema":{"type":"string"},"description":"Current Application id of sales channel","in":"path","required":true,"name":"application_id"}]}""", serverType="platform", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, id=id, i=i, b=b, buy_now=buy_now)
        ...
        response = await AiohttpHelper().aiohttp_request("POST", url_with_params, headers=get_headers_with_signature(self._conf.domain, "post", await create_url_without_domain(f"/service/platform/cart/v2.0/company/{self._conf.companyId}/application/{self.applicationId}/redeem", x_ordering_source=x_ordering_source, x_ordering_source_type=x_ordering_source_type, id=id, i=i, b=b, buy_now=buy_now), query_string, headers, body, exclude_headers=exclude_headers), data=body, debug=(self._conf.logLevel=="DEBUG"))
    ...
    async def getOffers(self, page_no=None, page_size=None, search=None, mode=None, type=None, promo_group=None, exclude_contract_offers=None, offer_id=None, created_by=None, reviewed_by=None, approved_start_time=None, approved_end_time=None, status=None, code=None, is_public=None, filter_tags=None, request_headers:Dict={}):
        ...
        :param filter_tags : Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=homepage&filter_tags=special`) or pass a comma-separated value. Entities matching any provided tag are returned (OR). : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/platform/cart/v1.0/company/{self._conf.companyId}/application/{self.applicationId}/offers", """{"required":[{"name":"company_id","description":"Current company id","in":"path","required":true,"schema":{"type":"string"}},{"name":"application_id","description":"Current Application id of sales channel","in":"path","required":true,"schema":{"type":"string"}}],"optional":[{"name":"page_no","description":"Current page no as per pagination","in":"query","schema":{"type":"integer","default":1}},{"name":"page_size","description":"Offers max records fetched in single request","in":"query","schema":{"type":"integer","default":10}},{"name":"search","in":"query","description":"Filter by offer name","schema":{"type":"string"}},{"name":"mode","in":"query","description":"Filter by offer mode","schema":{"type":"string","enum":["promotion","coupon"]}},{"name":"type","in":"query","description":"Filter by offer type","schema":{"type":"string"}},{"name":"promo_group","in":"query","schema":{"type":"string","description":"Filter by promotion offer group","enum":["product","cart","contract","ladder_price","limited_timer"]}},{"name":"exclude_contract_offers","in":"query","description":"Filter non contract offers","schema":{"type":"boolean"}},{"name":"offer_id","in":"query","description":"Filter by offer id","schema":{"type":"string"}},{"name":"created_by","description":"Filter by offer created by user id","in":"query","schema":{"type":"string"}},{"name":"reviewed_by","description":"Filter by offer reviewer user id","in":"query","schema":{"type":"string"}},{"name":"approved_start_time","description":"Filter offer by start time date range when status is in approved state","in":"query","schema":{"type":"string","format":"date-time"}},{"name":"approved_end_time","description":"Filter offer by end time date range when status is in approved state","in":"query","schema":{"type":"string","format":"date-time"}},{"name":"status","description":"Filter your offers effortlessly by status, such as draft, review and more","in":"query","schema":{"type":"string","enum":["draft","review","rejected","live","unpublished","not_live"]}},{"name":"code","description":"Filter by offer code in case of coupons","in":"query","schema":{"type":"string"}},{"name":"is_public","description":"Filter offers which are public","in":"query","schema":{"type":"boolean"}},{"name":"filter_tags","in":"query","description":"Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=homepage&filter_tags=special`) or pass a comma-separated value. Entities matching any provided tag are returned (OR).","schema":{"type":"string"}}],"query":[{"name":"page_no","description":"Current page no as per pagination","in":"query","schema":{"type":"integer","default":1}},{"name":"page_size","description":"Offers max records fetched in single request","in":"query","schema":{"type":"integer","default":10}},{"name":"search","in":"query","description":"Filter by offer name","schema":{"type":"string"}},{"name":"mode","in":"query","description":"Filter by offer mode","schema":{"type":"string","enum":["promotion","coupon"]}},{"name":"type","in":"query","description":"Filter by offer type","schema":{"type":"string"}},{"name":"promo_group","in":"query","schema":{"type":"string","description":"Filter by promotion offer group","enum":["product","cart","contract","ladder_price","limited_timer"]}},{"name":"exclude_contract_offers","in":"query","description":"Filter non contract offers","schema":{"type":"boolean"}},{"name":"offer_id","in":"query","description":"Filter by offer id","schema":{"type":"string"}},{"name":"created_by","description":"Filter by offer created by user id","in":"query","schema":{"type":"string"}},{"name":"reviewed_by","description":"Filter by offer reviewer user id","in":"query","schema":{"type":"string"}},{"name":"approved_start_time","description":"Filter offer by start time date range when status is in approved state","in":"query","schema":{"type":"string","format":"date-time"}},{"name":"approved_end_time","description":"Filter offer by end time date range when status is in approved state","in":"query","schema":{"type":"string","format":"date-time"}},{"name":"status","description":"Filter your offers effortlessly by status, such as draft, review and more","in":"query","schema":{"type":"string","enum":["draft","review","rejected","live","unpublished","not_live"]}},{"name":"code","description":"Filter by offer code in case of coupons","in":"query","schema":{"type":"string"}},{"name":"is_public","description":"Filter offers which are public","in":"query","schema":{"type":"boolean"}},{"name":"filter_tags","in":"query","description":"Filter by filter tag. Repeat this query parameter for multiple values (e.g. `?filter_tags=homepage&filter_tags=special`) or pass a comma-separated value. Entities matching any provided tag are returned (OR).","schema":{"type":"string"}}],"headers":[],"path":[{"name":"company_id","description":"Current company id","in":"path","required":true,"schema":{"type":"string"}},{"name":"application_id","description":"Current Application id of sales channel","in":"path","required":true,"schema":{"type":"string"}}]}""", serverType="platform", page_no=page_no, page_size=page_size, search=search, mode=mode, type=type, promo_group=promo_group, exclude_contract_offers=exclude_contract_offers, offer_id=offer_id, created_by=created_by, reviewed_by=reviewed_by, approved_start_time=approved_start_time, approved_end_time=approved_end_time, status=status, code=code, is_public=is_public, filter_tags=filter_tags)
