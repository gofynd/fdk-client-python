...
class Logistics:
    ...
    async def getCourierPartnerAccounts(self, company_id=None, page_no=None, page_size=None, stage=None, payment_mode=None, transport_type=None, request_headers:Dict={}):
        ...
        query_string = await create_query_string(company_id=company_id, page_no=page_no, page_size=page_size, stage=stage, payment_mode=payment_mode, transport_type=transport_type)
    ...
    async def updateCourierPartnerAccount(self, company_id=None, account_id=None, body="", request_headers:Dict={}):
        ...
        query_string = await create_query_string(company_id=company_id, account_id=account_id)
    ...
    async def updateCourierPartnerScheme(self, scheme_id=None, body="", request_headers:Dict={}):
        ...
        query_string = await create_query_string(scheme_id=scheme_id)
    ...
    async def getCountries(self, onboarding=None, page_no=None, page_size=None, q=None, request_headers:Dict={}):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, f"/service/partner/logistics/v1.0/organization/{self._conf.organizationId}/countries", """{"required":[{"in":"path","name":"organization_id","description":"Unique Identifier of Organization","schema":{"type":"string"},"required":true}],"optional":[{"in":"query","name":"onboarding","description":"Only fetch countries which allowed for onboard on Platform.","schema":{"type":"boolean"},"required":false,"examples":{"Yes":{"value":true},"No":{"value":false}}},{"in":"query","name":"page_no","description":"page number.","schema":{"type":"integer","default":1},"required":false,"examples":{"One":{"value":1},"Ten":{"value":10}}},{"in":"query","name":"page_size","description":"page size.","schema":{"type":"integer","default":12,"maximum":48},"required":false,"examples":{"Six":{"value":6},"Five":{"value":5}}},{"in":"query","name":"q","description":"search.","schema":{"type":"string"},"required":false,"examples":{"India":{"value":"india"},"Australia":{"value":"aust"}}}],"query":[{"in":"query","name":"onboarding","description":"Only fetch countries which allowed for onboard on Platform.","schema":{"type":"boolean"},"required":false,"examples":{"Yes":{"value":true},"No":{"value":false}}},{"in":"query","name":"page_no","description":"page number.","schema":{"type":"integer","default":1},"required":false,"examples":{"One":{"value":1},"Ten":{"value":10}}},{"in":"query","name":"page_size","description":"page size.","schema":{"type":"integer","default":12,"maximum":48},"required":false,"examples":{"Six":{"value":6},"Five":{"value":5}}},{"in":"query","name":"q","description":"search.","schema":{"type":"string"},"required":false,"examples":{"India":{"value":"india"},"Australia":{"value":"aust"}}}],"headers":[],"path":[{"in":"path","name":"organization_id","description":"Unique Identifier of Organization","schema":{"type":"string"},"required":true}]}""", serverType="partner", onboarding=onboarding, page_no=page_no, page_size=page_size, q=q)
