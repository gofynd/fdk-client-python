...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `cart_type` (type: `string`)
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] `query` parameter `store_id` (type: `string`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `start_date` (type: `string`)

	- [Breaking] [Deleted] `query` parameter `end_date` (type: `string`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `allow_inactive` (type: `boolean`)
...
- ##### What's New
	- [Breaking] [Deleted] `query` parameter `order_id` (type: `string`)

- [Breaking] [Added] Required `query` parameter `pincode` (type: `string`)

- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `display_split` (type: `boolean`)

	- [Breaking] [Deleted] `query` parameter `advance_payment` (type: `boolean`)

	- [Breaking] [Deleted] `query` parameter `shipment_id` (type: `string`)
...
- ##### What's Changed
	- [Breaking] [Changed] Required status of query parameter `cart_id`
	- [Breaking] [Changed] Required status of query parameter `checkout_mode`
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `is_pinned` (type: `boolean`)

	- [Breaking] [Deleted] `query` parameter `is_excluded` (type: `boolean`)
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] `query` parameter `store_types` (type: `array`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `brand_id` (type: `integer`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `page_no` (type: `integer`)

	- [Breaking] [Deleted] `query` parameter `page_size` (type: `integer`)
...
- [Added] `query` parameter `from_date` (type: `string`)
	- [Breaking] [Deleted] `query` parameter `end_date` (type: `string`)

- [Added] `query` parameter `to_date` (type: `string`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `search_text` (type: `string`)
...
- ##### What's New
	- [Added] `query` parameter `allow_inactive` (type: `boolean`)
...
- ##### What's New
	- [Added] `query` parameter `my_orders` (type: `boolean`)
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] `query` parameter `template_slug` (type: `string`)
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] `query` parameter `schedule_status` (type: `string`)

	- [Breaking] [Deleted] `query` parameter `type` (type: `string`)

	- [Breaking] [Deleted] `query` parameter `tags` (type: `array`)

	- [Breaking] [Deleted] `query` parameter `is_active` (type: `boolean`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `sort_on` (type: `string`)

	- [Breaking] [Deleted] `query` parameter `page_id` (type: `string`)
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] `query` parameter `item_type` (type: `string`)
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] `query` parameter `from_date` (type: `string`)

	- [Breaking] [Deleted] `query` parameter `to_date` (type: `string`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `brand_ids` (type: `array`)

	- [Breaking] [Deleted] `query` parameter `category_ids` (type: `array`)

	- [Breaking] [Deleted] `query` parameter `item_ids` (type: `array`)

	- [Breaking] [Deleted] `query` parameter `department_ids` (type: `array`)

	- [Breaking] [Deleted] `query` parameter `item_code` (type: `array`)
...
- ##### What's Deprecated
	- [Breaking] [Deleted] `query` parameter `brand_uid` (type: `integer`)

	- [Breaking] [Deleted] `query` parameter `item_code` (type: `string`)
...
- ##### What's New
	- [Added] `query` parameter `order_type` (type: `string`)
...
- ##### What's New
	...
	- [Added] `query` parameter `config_type` (type: `string`)
...
- ##### What's New
	- [Added] `query` parameter `item_type` (type: `string`)
...
- ##### What's New
	- [Added] `query` parameter `sort_type` (type: `string`)

	- [Added] `query` parameter `show_cross_company_data` (type: `boolean`)

	- [Added] `query` parameter `customer_id` (type: `string`)
...
- ##### What's New
	- [Breaking] [Added] Required `path` parameter `theme_id` (type: `string`)
