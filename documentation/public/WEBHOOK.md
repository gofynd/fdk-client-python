...
```python
try:
    result = await publicClient.webhook.notifyDepricatedEvent()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await publicClient.webhook.testHandlerTransformation(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await publicClient.webhook.validateSchema(body=body)
    # use result
except Exception as e:
    print(e)
```
