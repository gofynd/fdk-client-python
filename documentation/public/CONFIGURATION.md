...
```python
try:
    result = await client.configuration.fetchAllWebhookEvents()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.configuration.queryWebhookEventDetails(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.configuration.getJobConfigByIntegrationType(integrationType=integrationType, disable=disable)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.configuration.getJobCodesMetrics(dailyJob=dailyJob, jobCode=jobCode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.configuration.saveJobCodesMetrics(body=body)
    # use result
except Exception as e:
    print(e)
```
