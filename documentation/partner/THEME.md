...
```python
try:
    result = await partnerClient.theme.getAllPages(themeId=themeId, organizationId=organizationId)
    # use result
...
```python
try:
    result = await partnerClient.theme.createPage(themeId=themeId, organizationId=organizationId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.updateMultiplePages(themeId=themeId, organizationId=organizationId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getPage(themeId=themeId, pageValue=pageValue, organizationId=organizationId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.updatePage(themeId=themeId, pageValue=pageValue, organizationId=organizationId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.deletePage(themeId=themeId, pageValue=pageValue, organizationId=organizationId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getApplicationThemes(organizationId=organizationId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getThemeById(themeId=themeId, organizationId=organizationId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.updateTheme(themeId=themeId, organizationId=organizationId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.deleteTheme(themeId=themeId, organizationId=organizationId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getOrganizationThemes(organizationId=organizationId, status=status, pageSize=pageSize, pageNo=pageNo)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getOrganizationThemeDetails(organizationId=organizationId, themeId=themeId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.updateDraftTheme(organizationId=organizationId, themeId=themeId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.submitOrganizationTheme(organizationId=organizationId, themeId=themeId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.deleteOrganizationTheme(organizationId=organizationId, themeId=themeId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getLatestVersionOfThemeBySlug(organizationId=organizationId, slugName=slugName)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.createNewThemeInOrganization(organizationId=organizationId, slug=slug, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getThemeRejectionReasons(organizationId=organizationId, themeId=themeId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await partnerClient.theme.getThemeVersions(organizationId=organizationId, themeSlug=themeSlug, pageSize=pageSize, pageNo=pageNo)
    # use result
except Exception as e:
    print(e)
```
