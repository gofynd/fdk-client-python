...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPosPaymentModeRoutes(amount=amount, cartId=cartId, pincode=pincode, checkoutMode=checkoutMode, refresh=refresh, cardReference=cardReference, orderType=orderType, userDetails=userDetails)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | methodCode | [PaymentCode](#PaymentCode) |  no  | Payment method code |
...
---
 ...
 | areaCodeSlug | String |  no  | area slug code, use pin/zip code if not available |
 | addressType | String |  no  | address type e.g. home, office |
...
---
 ...
 | shippingAddress | [AddressDetail](#AddressDetail) |  no  | shipping address |
 ...
 | billingAddress | [AddressDetail](#AddressDetail) |  no  | billing address |
