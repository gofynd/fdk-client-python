...
* [getPaymentModeRoutesPos](#getpaymentmoderoutespos)
...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.getPaymentModeRoutesPos(refresh=refresh, requestType=requestType)
    # use result
except Exception as e:
    print(e)
```
