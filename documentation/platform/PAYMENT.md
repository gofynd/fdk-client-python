...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.edcDevice(terminalUniqueIdentifier=terminalUniqueIdentifier, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.edcDevice(terminalUniqueIdentifier=terminalUniqueIdentifier)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | edcModels | String? |  yes  | Name of the model |
