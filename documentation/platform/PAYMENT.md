...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getBrandPaymentGatewayConfig(aggregator=aggregator, configType=configType)
    # use result
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPaymentModeRoutes(refresh=refresh, requestType=requestType, orderId=orderId, shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.edcAggregatorsAndModelList()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.edcDeviceStats()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.updateEdcDevice(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getEdcDevice(terminalUniqueIdentifier=terminalUniqueIdentifier)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.addEdcDevice(terminalUniqueIdentifier=terminalUniqueIdentifier, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.edcDeviceList(pageNo=pageNo, pageSize=pageSize, isActive=isActive, storeId=storeId, deviceTag=deviceTag)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.initialisePayment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.checkAndUpdatePaymentStatus(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.resendOrCancelPayment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.paymentStatusBulk(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.oauthGetUrl(aggregator=aggregator, successRedirectUrl=successRedirectUrl, failureRedirectUrl=failureRedirectUrl)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.revokeOauthToken(aggregator=aggregator)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.repaymentDetails(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.merchantOnBoarding(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.verifyCustomerForPayment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPaymentLink(paymentLinkId=paymentLinkId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.createPaymentLink(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.pollingPaymentLink(paymentLinkId=paymentLinkId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.resendPaymentLink(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.cancelPaymentLink(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPaymentModeControlRoutes(mode=mode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.setMerchantModeControlRoutes(mode=mode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPaymentModeCustomConfig(mode=mode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.setPaymentModeCustomConfig(mode=mode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPaymentCodeOption()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPaymentSession(gid=gid, lineItem=lineItem)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.updatePaymentSession(gid=gid, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.updateRefundSession(gid=gid, requestId=requestId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getMerchantPaymentOption(paymentOptionType=paymentOptionType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.patchMerchantPaymentOption(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getMerchantAggregatorPaymentModeDetails(aggregatorId=aggregatorId, businessUnit=businessUnit, device=device)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.patchMerchantAggregatorPaymentModeDetails(aggregatorId=aggregatorId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPGConfigAggregators()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getMerchantRefundPriority(configType=configType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.createMerchantRefundPriority(configType=configType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.updateMerchantRefundPriority(configType=configType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.createPaymentOrder(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getMerchantAggregatorAppVersion(aggregatorId=aggregatorId, businessUnit=businessUnit, device=device, paymentModeId=paymentModeId, subPaymentMode=subPaymentMode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.patchMerchantPaymentOptionVersion(aggregatorId=aggregatorId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.deleteBeneficiaryDetails(beneficiaryId=beneficiaryId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getRefundOptions(configuration=configuration, productType=productType, amount=amount)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.setRefundOptionforShipment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getSelectedRefundOption(shipmentId=shipmentId, orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getUserBeneficiariesDetailV2(orderId=orderId, shipmentId=shipmentId, mop=mop)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.validateBeneficiaryAddress(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.updateDefaultBeneficiary(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.getPennyDropValidation()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").payment.updatePennyDropValidation(body=body)
    # use result
except Exception as e:
    print(e)
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- |
| body | [UpdatePennyDropValidationRequest](#UpdatePennyDropValidationRequest) | yes | Request body |
...
---
 ...
 | isActive | Boolean? |  yes  | Enable or Disable Flag |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | aggregators | ArrayList<String>? |  yes  | List of added payment gateway |
 | success | Boolean |  no  | Response is successful or not |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | isActive | Boolean? |  yes  | Is Advance Payment active |
 ...
 | allPrepaymentType | ArrayList<String>? |  yes  | All available types of prepayment |
 | allowCustomAdvanceAmount | Boolean? |  yes  | Is custom advance amount allowed? |
...
---
 ...
 | success | Boolean |  no  | Response is successful or not |
 | paymentBreakup | HashMap<String,Any>? |  yes  | Payment Breakup for advance payment |
 | advancePayment | ArrayList<[AdvancePaymentObject](#AdvancePaymentObject)>? |  yes  | Advance Payment Array |
...
---
 ...
 | payoutsAggregators | ArrayList<[PayoutAggregator](#PayoutAggregator)>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | success | Boolean |  no  | Response is successful or not |
 | items | ArrayList<[Payout](#Payout)> |  no  | contains list of PayoutSchema |
...
---
 ...
 | isActive | Boolean |  no  | Enable or Disable Flag Payout |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | isDefault | Boolean? |  yes  | Enable or Disable Default Payout |
 | isActive | Boolean |  no  | Enable or DIsable Flag Payout |
 | success | Boolean |  no  | Response is successful or not |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | isDefault | Boolean |  no  | Enable or Disable Default Payout |
 | isActive | Boolean |  no  | Enable or Disable Flag Payout |
 | uniqueExternalId | String |  no  | Unique Id of Payout |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | delete | Boolean? |  yes  | delete is successful or not |
...
---
 ...
 | allPrepaymentType | ArrayList<String>? |  yes  |  |
...
---
 ...
 | success | Boolean? |  yes  | Response is successful or not |
 | message | String? |  yes  |  |
 | items | ArrayList<[GetUserBULimitResponse](#GetUserBULimitResponse)>? |  yes  |  |
...
---
 ...
 | items | ArrayList<[SetBUPaymentLimit](#SetBUPaymentLimit)> |  no  |  |
...
---
 ...
 | models | ArrayList<String> |  no  | List of string of edc models |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | ArrayList<[EdcModelData](#EdcModelData)> |  no  | List of aggregators and their edc models |
 | success | Boolean |  no  | Response is successful or not |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | merchantOrderId | ArrayList<String> |  no  | List of order ids |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | userObject | HashMap<String,Any> |  no  |  |
 | modifiedOn | String |  no  |  |
 | collectedBy | String |  no  |  |
 | createdOn | String |  no  |  |
 | refundObject | HashMap<String,Any>? |  yes  |  |
 | id | String |  no  |  |
 | paymentId | String? |  yes  |  |
 | currency | String |  no  |  |
 | currentStatus | String |  no  |  |
 | aggregatorPaymentObject | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | paymentObjectList | ArrayList<[PaymentObjectListSerializer](#PaymentObjectListSerializer)>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | message | String? |  yes  | Message |
 | items | HashMap<String,Any>? |  yes  | List of all aggregator and payment mode details. |
 | success | Boolean |  no  | Response is successful or not. |
...
---
 ...
 | offerList | ArrayList<[OfferSerializer](#OfferSerializer)>? |  yes  |  |
...
---
 ...
 | aggregatorOrderDetails | HashMap<String,Any> |  no  | aggregator order details generated by the payment gateway. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | googleMapPoint | HashMap<String,Any>? |  yes  | google map point of location |
 ...
 | geoLocation | HashMap<String,Any>? |  yes  | location latitude and logitude |
 ...
 | tags | ArrayList<HashMap<String,Any>>? |  yes  | optional address tag |
...
---
 ...
 | paymentMethods | ArrayList<HashMap<String,Any>> |  no  | method of payment |
 ...
 | meta | HashMap<String,Any>? |  yes  | Metadata |
...
---
 ...
 | currency | String |  no  | currency of the payment. |
 | paymentDetails | ArrayList<[PaymentSessionDetail](#PaymentSessionDetail)> |  no  | The payment details with the schema `PaymentSessionDetail`. |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | gid | String |  no  | Global identifier of the entity (e.g. order, cart etc.) against which payment_session was initiated. This is generated by Fynd payments platform and is unique. |
 | platformTransactionDetails | ArrayList<HashMap<String,Any>> |  no  | platform transaction details. |
 | status | String |  no  | status of the payment. |
 | currency | String |  no  | currency of the payment. |
 | totalAmount | Int |  no  | amount paid. |
...
---
 ...
 | refundDetails | ArrayList<[RefundSessionDetail](#RefundSessionDetail)>? |  yes  | details of the refund |
 | error | [ErrorDescription](#ErrorDescription)? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | HashMap<String,Any> |  no  | Items that are added in cart |
 | articles | ArrayList<HashMap<String,Any>> |  no  | list of articles that are added in cart |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | paymentDetails | Any |  no  | object of payment details |
 ...
 | refundDetails | ArrayList<[RefundDetailsSerializer](#RefundDetailsSerializer)> |  no  | object of refund details |
...
---
 ...
 | items | ArrayList<HashMap<String,Any>> |  no  | List of item details with respect to payment_mode |
 | device | HashMap<String,Any> |  no  | List of devices and its activation status |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | device | ArrayList<HashMap<String,Any>> |  no  | Device name to copy the config to |
 | businessUnit | String |  no  | Business unit name |
...
---
 ...
 | paymentMethods | ArrayList<[PaymentOrderMethods](#PaymentOrderMethods)>? |  yes  |  |
...
---
 ...
 | message | String |  no  | Message |
 | success | Boolean |  no  | Successful or failure |
 | items | ArrayList<[AggregatorVersionItemSchema](#AggregatorVersionItemSchema)>? |  yes  |  |
...
---
 ...
 | items | ArrayList<HashMap<String,Any>>? |  yes  | List of item details with respect to payment_mode |
...
---
 ...
 | groups | ArrayList<Int>? |  yes  | Customer groups. |
 | types | ArrayList<String>? |  yes  | Customer types. |
...
---
 ...
 | preOrder | ArrayList<String>? |  yes  | Payment modes available for pre-order. |
 | postOrder | ArrayList<String>? |  yes  | Payment modes available for post-order. |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | businessUnit | String |  no  | The business unit to which the store belongs. |
 | items | ArrayList<[PaymentCustomConfigDetailsRequestSchema](#PaymentCustomConfigDetailsRequestSchema)> |  no  |  |
...
---
 ...
 | success | Boolean |  no  |  |
 | message | String |  no  |  |
 | items | ArrayList<[PaymentModeCustomConfigSchema](#PaymentModeCustomConfigSchema)> |  no  |  |
...
---
 ...
 | isActive | Boolean? |  yes  | Refund option is active or not |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | items | [RefundOptionsDetails](#RefundOptionsDetails) |  no  | List of all refund options. |
 | paymentModes | ArrayList<String> |  no  | List of all offline payment options. MOP Code value |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | transferMode | HashMap<String,Any> |  no  | selected transfer mode for given shipment |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | showBeneficiaryDetails | Boolean |  no  | Show Beneficiary details on UI or not. |
 | data | [BeneficiaryRefundOptions](#BeneficiaryRefundOptions) |  no  | Beneficiary Data for Bank account, UPI and Wallets. |
 | limit | HashMap<String,Any> |  no  | Max Limit for adding bank account, UPI and wallet |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | isValid | Boolean |  no  | Is VPA valid or not |
...
---
 ...
 | success | Boolean |  no  | Successful or not. |
 | ifsc | HashMap<String,Any>? |  yes  | IFSC details response data |
...
---
 ...
 | success | Boolean |  no  | Successful or not. |
 | message | String |  no  | message |
 | allowPennydropValidation | Boolean |  no  | PennyDrop validation flag. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | allowPennydropValidation | Boolean |  no  | Allow Penny Drop Validation flag |
