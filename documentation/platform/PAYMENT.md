...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.repaymentDetails(body=body)
    # use result
except Exception as e:
    print(e)
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- |
| body | [RepaymentRequestDetails](#RepaymentRequestDetails) | yes | Request body |
...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.merchantOnBoarding(body=body)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | amount | Int |  no  | Amount to paid back |
