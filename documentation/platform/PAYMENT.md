...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.getPosPaymentModeRoutes()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").payment.getPosPaymentModeRoutes(body=body)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | remaining | Int |  no  | Remaining Limit for COD of User |
