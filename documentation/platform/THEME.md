...
```python
try:
    result = await platformClient.theme.getCompanyLevelThemes()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.theme.addMarketplaceThemeToCompany(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.theme.deleteCompanyTheme(themeId=themeId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").theme.getApplicationThemesV2()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").theme.getApplicationThemesCountV2()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").theme.getApplicationThemeByIdV2(themeId=themeId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").theme.updateThemeV2(themeId=themeId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").theme.applyThemeV2(body=body)
    # use result
except Exception as e:
    print(e)
```
