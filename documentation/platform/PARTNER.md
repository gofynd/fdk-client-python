...
```python
try:
    result = await platformClient.partner.subscribeExtension(entity=entity, extensionId=extensionId, entityId=entityId, body=body)
    # use result
...
```python
try:
    result = await platformClient.partner.getPublicExtension(extensionId=extensionId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.partner.getExtensionById(extensionId=extensionId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.partner.deleteExtensionById(extensionId=extensionId, message=message, uninstallReasonType=uninstallReasonType)
    # use result
except Exception as e:
    print(e)
```
...
| query | HashMap<String,Any>? | no | Filter query which we want to pass |  
...
```python
try:
    result = await platformClient.partner.getExtensionsSuggestions(pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.partner.getPartnerInvites(requestStatus=requestStatus, pageSize=pageSize, pageNo=pageNo)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.partner.getPartnerRequestDetails(inviteId=inviteId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.partner.modifyPartnerRequest(inviteId=inviteId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.partner.setupProducts(requestId=requestId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").partner.getProxyPath(extensionId=extensionId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").partner.getProxyPathAttachedPath(extensionId=extensionId, attachedPath=attachedPath)
    # use result
except Exception as e:
    print(e)
```
...
### Schemas
 ...
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[ExtensionListItems](#ExtensionListItems)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[ExtensionItems](#ExtensionItems)>? |  yes  |  |
 | page | [Pagination](#Pagination)? |  yes  |  |
...
---
 ...
 | name | String? |  yes  |  |
 | logo | [Logo](#Logo)? |  yes  |  |
 | scope | ArrayList<[Scope](#Scope)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[ExtensionSuggestion](#ExtensionSuggestion)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | applicationRole | ArrayList<String>? |  yes  |  |
 | companyPermissions | ArrayList<String>? |  yes  |  |
 | companyRole | ArrayList<String>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | applicationPermissions | ArrayList<String>? |  yes  |  |
 | applicationRole | ArrayList<String>? |  yes  |  |
 | companyPermissions | ArrayList<String>? |  yes  |  |
 | companyRole | ArrayList<String>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | applicationPermissions | HashMap<String,[ApplicationPermissions](#ApplicationPermissions)>? |  yes  |  |
 | companyPermissions | ArrayList<String>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | page | [Pagination](#Pagination)? |  yes  |  |
 | items | ArrayList<[AddProxyResponse](#AddProxyResponse)>? |  yes  |  |
