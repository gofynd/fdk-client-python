...
```python
try:
    result = await client.documentengine.generateBulkPackageLabel(body=body)
    # use result
...
```python
try:
    result = await client.documentengine.generateBulkBoxLabel(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.generateBulkShipmentLabel(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.generateNoc(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.getLabelStatus(uid=uid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.getNocStatus(uid=uid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.getPresignedURL(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.getLabelPresignedURL(uid=uid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.getNocPresignedURL(uid=uid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.documentengine.getBulkShipmentStatus(batchId=batchId)
    # use result
except Exception as e:
    print(e)
```
