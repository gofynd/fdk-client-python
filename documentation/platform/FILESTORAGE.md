...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").filestorage.browsefiles(namespace=namespace, page=page, limit=limit, search=search, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").filestorage.getDefaultPdfData(pdfTypeId=pdfTypeId, countryCode=countryCode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").filestorage.saveHtmlTemplate(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").filestorage.getDefaultPdfTemplate(pdfTypeId=pdfTypeId, format=format, countryCode=countryCode)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | ArrayList<[InvoiceTypesDataResponse](#InvoiceTypesDataResponse)> |  no  |  |
 | success | Boolean |  no  |  |
...
---
 ...
 | businessCountryCurrency | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | products | ArrayList<[ItemsProductTable](#ItemsProductTable)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | taxes | ArrayList<[Taxes](#Taxes)>? |  yes  |  |
 | totalTax | Double? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | value | ArrayList<HashMap<String,Any>>? |  yes  |  |
...
---
 ...
 | totalValueOfGoods | Double? |  yes  |  |
 | b2BBuyerDetails | HashMap<String,Any>? |  yes  |  |
 | isQwik | HashMap<String,Any>? |  yes  |  |
 ...
 | payments | ArrayList<[PaymentData](#PaymentData)>? |  yes  |  |
 ...
 | waybills | ArrayList<HashMap<String,Any>>? |  yes  |  |
 | totalItems | Double? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | ArrayList<[DummyTemplateData](#DummyTemplateData)> |  no  |  |
 | success | Boolean |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | ArrayList<[PdfConfigSuccessData](#PdfConfigSuccessData)>? |  yes  |  |
 | success | Boolean? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | ArrayList<[Document](#Document)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | paymentReceipt | ArrayList<String>? |  yes  |  |
...
---
 ...
 | payments | ArrayList<[PaymentReceiptPayments](#PaymentReceiptPayments)>? |  yes  |  |
...
---
 ...
 | eventTraceInfo | HashMap<String,Any>? |  yes  |  |
 | trace | String? |  yes  |  |
