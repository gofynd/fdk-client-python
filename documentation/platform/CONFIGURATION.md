...
### getDomains
Get domains list attached with the current application.
...
```python
try:
    result = await client.application("<APPLICATION_ID>").configuration.getDomains(comapnyId=comapnyId, appicationId=appicationId)
    # use result
except Exception as e:
    print(e)
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| comapnyId | String | yes | Current company id |   
| appicationId | String | yes | current application id |  



Gives the domains list attached with the current application.

**Note**
* Gets Maximum 4 domains      
