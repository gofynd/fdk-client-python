...
```python
try:
    result = await client.lead.getTicket(ticketId=ticketId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.lead.editTicket(ticketId=ticketId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").lead.getTicket(ticketId=ticketId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").lead.editTicket(ticketId=ticketId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.lead.createHistory(ticketId=ticketId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.lead.getTicketHistory(ticketId=ticketId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").lead.createHistory(ticketId=ticketId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").lead.getTicketHistory(ticketId=ticketId)
    # use result
except Exception as e:
    print(e)
```
