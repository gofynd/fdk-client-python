...
```python
try:
    result = await client.ordermanage.invalidateShipmentCache(body=body)
    # use result
...
```python
try:
    result = await client.ordermanage.reassignLocation(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.updateShipmentLock(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.getAnnouncements(date=date)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.updateAddress(shipmentId=shipmentId, name=name, address=address, addressType=addressType, pincode=pincode, phone=phone, email=email, landmark=landmark, addressCategory=addressCategory, city=city, state=state, country=country)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.click2Call(caller=caller, receiver=receiver, bagId=bagId, callingTo=callingTo, callerId=callerId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.updateShipmentStatus(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.processManifest(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.dispatchManifest(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.getRoleBasedActions()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.getShipmentHistory(shipmentId=shipmentId, bagId=bagId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.sendSmsNinja(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.platformManualAssignDPToShipment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.updatePackagingDimensions(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.createOrder(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.getChannelConfig()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.createChannelConfig(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.uploadConsent(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.checkOrderStatus(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.ordermanage.sendSmsNinjaPlatform()
    # use result
except Exception as e:
    print(e)
```
