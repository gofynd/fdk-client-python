...
```python
try:
    result = await platformClient.order.getStateTransitionFlags(pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getStateTransitionFlagsById(flagId=flagId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getStateTransitionFilters(pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getStateTransitionFiltersById(filterId=filterId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getStateManagerTasks(pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getStateManagerTaskById(taskId=taskId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getStateManagerStates(pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getShipmentById(channelShipmentId=channelShipmentId, shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
