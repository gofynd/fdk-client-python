...
```python
try:
    result = await platformClient.order.postRefundStateConfiguration(appId=appId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getRefundStateConfiguration(appId=appId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getRefundEnableStateList()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.postRefundConfiguration(appId=appId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getRefundConfiguration(appId=appId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.click2Call(caller=caller, receiver=receiver, bagId=bagId, callerId=callerId, method=method)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getStateTransitionMap()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getAllowedStateTransition(orderingChannel=orderingChannel, status=status)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.fetchCreditBalanceDetail(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.fetchRefundModeConfig(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.attachOrderUser(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.sendUserMobileOTP(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.verifyMobileOTP(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.downloadLanesReport(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.bulkStateTransistion(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.bulkListing(pageSize=pageSize, pageNo=pageNo, startDate=startDate, endDate=endDate, status=status, bulkActionType=bulkActionType, searchKey=searchKey)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.jobDetails(batchId=batchId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getFileByStatus(batchId=batchId, status=status, fileType=fileType, reportType=reportType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getManifestShipments(dpIds=dpIds, stores=stores, toDate=toDate, fromDate=fromDate, dpName=dpName, salesChannels=salesChannels, searchType=searchType, searchValue=searchValue, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getManifests(status=status, startDate=startDate, endDate=endDate, searchType=searchType, storeId=storeId, searchValue=searchValue, dpIds=dpIds, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.processManifests(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getManifestDetails(manifestId=manifestId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.dispatchManifests(manifestId=manifestId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.uploadConsents(manifestId=manifestId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getManifestfilters(view=view)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.eInvoiceRetry(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.trackShipment(shipmentId=shipmentId, awb=awb, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.updateShipmentTracking(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.failedOrderLogs(pageNo=pageNo, pageSize=pageSize, searchType=searchType, searchValue=searchValue)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.failedOrderLogDetails(logId=logId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getQuestions(pageNo=pageNo, pageSize=pageSize, q=q, isActive=isActive)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getRuleLaneConfig(searchValue=searchValue)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.createRule(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getRuleById(ruleId=ruleId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.updateRule(ruleId=ruleId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.deleteRule(ruleId=ruleId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.updateRulePosition(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getRuleParameters()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getRuleList(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").order.getShipmentBagReasons(shipmentId=shipmentId, lineNumber=lineNumber)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getShipmentById(channelShipmentId=channelShipmentId, shipmentId=shipmentId, fetchActiveShipment=fetchActiveShipment)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getOrderById(orderId=orderId, myOrders=myOrders, allowInactive=allowInactive)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getuserviews()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.postuserviews(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.updateuserviews(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.deleteuserviews(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.globalfilters(showIn=showIn, requestSource=requestSource)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getBulkShipmentExcelFile(salesChannels=salesChannels, dpIds=dpIds, startDate=startDate, endDate=endDate, stores=stores, tags=tags, bagStatus=bagStatus, paymentMethods=paymentMethods, fileType=fileType, timeToDispatch=timeToDispatch, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getBulkActionTemplate()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.downloadBulkActionTemplate(templateSlug=templateSlug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.generatePOSReceiptByOrderId(orderId=orderId, shipmentId=shipmentId, documentType=documentType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getAllowedTemplatesForBulk()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.order.getTemplate(templateName=templateName)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | customFiltersForLane | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | label | ArrayList<String>? |  yes  |  |
 | invoice | ArrayList<String>? |  yes  |  |
 | failedShipments | ArrayList<HashMap<String,String>>? |  yes  |  |
 | processingShipments | ArrayList<String>? |  yes  |  |
 | successfulShipments | ArrayList<String>? |  yes  |  |
 | invoiceableShipments | ArrayList<String>? |  yes  |  |
 | failedInvoicedShipments | HashMap<String,String>? |  yes  |  |
 | processingInvoiceShipments | ArrayList<String>? |  yes  |  |
 | successfulInvoicedShipments | ArrayList<String>? |  yes  |  |
...
---
 ...
 | doInvoiceLabelGenerated | Boolean? |  yes  |  |
 | id | Int? |  yes  |  |
 | userId | String? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | success | Boolean? |  yes  |  |
 | data | ArrayList<[BulkActionListingData](#BulkActionListingData)>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | success | Boolean? |  yes  |  |
 | data | ArrayList<[JobDetailsData](#JobDetailsData)>? |  yes  |  |
 | fileUrl | String? |  yes  |  |
 | message | String? |  yes  |  |
 | failedRecords | ArrayList<HashMap<String,String>>? |  yes  |  |
 | uploadedBy | String? |  yes  |  |
 | userId | String? |  yes  |  |
 | createdTs | String? |  yes  |  |
 | uploadedOn | String? |  yes  |  |
...
---
 ...
 | success | Boolean |  no  |  |
 | status | Int |  no  |  |
 | items | ArrayList<[ManifestItemDetails](#ManifestItemDetails)>? |  yes  |  |
 | message | String? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | consent | String? |  yes  |  |
 | mediaUpdates | ArrayList<[ManifestMediaUpdate](#ManifestMediaUpdate)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[Manifest](#Manifest)>? |  yes  |  |
...
---
 ...
 | manifestDetails | ArrayList<[Manifest](#Manifest)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | advanceFilter | ArrayList<[FiltersInfo](#FiltersInfo)>? |  yes  |  |
...
---
 ...
 | hasPrevious | Boolean? |  yes  | if previous page contains any result |
...
---
 ...
 | errorDetails | ArrayList<[EInvoiceErrorDetails](#EInvoiceErrorDetails)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | responseData | ArrayList<[EInvoiceErrorResponseData](#EInvoiceErrorResponseData)>? |  yes  |  |
 | message | String? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | responseData | ArrayList<[EInvoiceErrorResponseData](#EInvoiceErrorResponseData)> |  no  |  |
 | message | String? |  yes  |  |
...
---
 ...
 | meta | HashMap<String,Any>? |  yes  | Meta field to store Courier partner's meta data |
...
---
 ...
 | paymentInfo | ArrayList<[BagPaymentMethods](#BagPaymentMethods)>? |  yes  |  |
 | quantity | Int? |  yes  |  |
 | identifier | String? |  yes  |  |
 | canReturn | Boolean? |  yes  |  |
 | canCancel | Boolean? |  yes  |  |
...
---
 ...
 | displayName | String? |  yes  |  |
 | dpDetails | HashMap<String,Any>? |  yes  |  |
 | einvoiceInfo | HashMap<String,Any>? |  yes  |  |
 | entityType | String? |  yes  |  |
 | fallbackUser | HashMap<String,Any>? |  yes  |  |
 ...
 | shipmentStatusHistory | ArrayList<[ShipmentStatusData](#ShipmentStatusData)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[BagDetails](#BagDetails)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | templateXSlug | ArrayList<[Templates](#Templates)>? |  yes  |  |
