...
```python
try:
    result = await client.order.statusUpdateInternalV4(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getShipmentDetails(shipmentId=shipmentId, orderingCompanyId=orderingCompanyId, requestByExt=requestByExt)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getOrderShipmentDetails(orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getPlatformShipmentReasons1(shipmentId=shipmentId, bagId=bagId, state=state)
    # use result
except Exception as e:
    print(e)
```
