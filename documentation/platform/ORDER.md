...
```python
try:
    result = await client.order.generatePOSReceiptByOrderId(orderId=orderId, documentType=documentType)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | manufacturerAddress | HashMap<String,Any>? |  yes  |  |
 | companyId | Int? |  yes  |  |
