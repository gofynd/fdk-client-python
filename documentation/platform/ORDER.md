...
```python
try:
    result = await client.order.getReasonCodes(category=category, pageSize=pageSize, pageNo=pageNo)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getShipments(bagIds=bagIds, shipmentIds=shipmentIds, orderIds=orderIds, channelBagIds=channelBagIds, channelShipmentIds=channelShipmentIds, channelOrderIds=channelOrderIds, channelId=channelId, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getOrderById(fyndOrderId=fyndOrderId, channelOrderId=channelOrderId, channelShipmentId=channelShipmentId, channelBagId=channelBagId, channelId=channelId, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getOrders(bagIds=bagIds, shipmentIds=shipmentIds, orderIds=orderIds, channelBagIds=channelBagIds, channelShipmentIds=channelShipmentIds, channelOrderIds=channelOrderIds, channelId=channelId, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | entityIds | ArrayList<String>? |  yes  |  |
 | bagIds | ArrayList<String>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | entityId | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | processInBackground | Boolean? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | status | Boolean |  no  |  |
 | errorEntities | ArrayList<[EntityTransitionError](#EntityTransitionError)>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | page | [Page](#Page)? |  yes  |  |
 | items | ArrayList<[ReasonCodes](#ReasonCodes)>? |  yes  |  |
...
---
 ...
 | paymentMethods | HashMap<String,Any> |  no  |  |
 | bagId | Int |  no  |  |
...
---
 ...
 | ewbn | Any? |  yes  |  |
 | awbType | String |  no  |  |
 | excludeDps | ArrayList<Int>? |  yes  |  |
 | rdpcId | Int |  no  |  |
 | isDpAssignedManually | Boolean |  no  |  |
...
---
 ...
 | dueDate | String? |  yes  |  |
 | timestamp | HashMap<String,Any>? |  yes  |  |
 | forwardAffiliateOrderId | String? |  yes  |  |
 | formatted | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | businessDetails | HashMap<String,Any>? |  yes  |  |
 | notificationEmails | ArrayList<String> |  no  |  |
 | documents | [Documents1](#Documents1) |  no  |  |
 | contactDetails | HashMap<String,Any> |  no  |  |
 | businessInfo | String? |  yes  |  |
 | stage | String |  no  |  |
 | address | ArrayList<[CompanyAddress](#CompanyAddress)> |  no  |  |
...
---
 ...
 | products | ArrayList<[ShipmentProduct](#ShipmentProduct)>? |  yes  |  |
 | qcRequired | Any? |  yes  |  |
 | orderIntegrationId | String? |  yes  |  |
 | shipmentStatusHistory | ArrayList<[ShipmentStatusCommon](#ShipmentStatusCommon)> |  no  |  |
 | weight | HashMap<String,Any> |  no  |  |
 ...
 | searchKey | HashMap<String,Any> |  no  |  |
 ...
 | originalBagList | ArrayList<Int> |  no  |  |
 ...
 | bagStatusHistory | ArrayList<[BagStatusHistory](#BagStatusHistory)> |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[Shipment](#Shipment)> |  no  |  |
 | page | [Page1](#Page1) |  no  |  |
