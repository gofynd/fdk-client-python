...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.getDefaultEmailProviders()
    # use result
except Exception as e:
    print(e)
```
...
[ArrayList<DefaultEmailProviders>](#ArrayList<DefaultEmailProviders>)
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.getVoiceProviders(pageNo=pageNo, pageSize=pageSize, sort=sort)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.createVoiceProvider(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.getVoiceProviderById(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.getVoiceTemplates(pageNo=pageNo, pageSize=pageSize, sort=sort)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.createVoiceTemplate(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.getVoiceTemplateById(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.updateVoiceTemplateById(id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.deleteVoiceTemplateById(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").communication.getSystemVoiceTemplates(pageNo=pageNo, pageSize=pageSize, sort=sort)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | attachments | ArrayList<String>? |  yes  |  |
 | createdAt | String? |  yes  |  |
 | updatedAt | String? |  yes  |  |
 | slug | String? |  yes  |  |
 | v | Int? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[EmailTemplateAdmin](#EmailTemplateAdmin)>? |  yes  |  |
 | page | [Page](#Page)? |  yes  |  |
...
---
 ...
 | createdAt | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[SmsTemplateAdmin](#SmsTemplateAdmin)>? |  yes  |  |
 | page | [Page](#Page)? |  yes  |  |
...
---
 ...
 | whitelistedIp | ArrayList<String>? |  yes  | An array of whitelisted IP addresses for the Exotel voice provider implementation |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[VoiceProvider](#VoiceProvider)>? |  yes  |  |
 | page | [Page](#Page)? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[VoiceTemplate](#VoiceTemplate)>? |  yes  |  |
 | page | [Page](#Page)? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[SystemVoiceTemplate](#SystemVoiceTemplate)>? |  yes  |  |
 | page | [Page](#Page)? |  yes  |  |
