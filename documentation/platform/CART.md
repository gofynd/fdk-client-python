...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.updateCartWithSharedItems(token=token, action=action)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.addItems(i=i, b=b, buyNow=buyNow, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.updateCart(id=id, i=i, b=b, buyNow=buyNow, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.getCoupons(id=id, buyNow=buyNow)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.getShipments(p=p, id=id, buyNow=buyNow, addressId=addressId, areaCode=areaCode, orderingStoreId=orderingStoreId, orderType=orderType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.getShipmentDelivery(i=i, p=p, id=id, addressId=addressId, orderType=orderType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").cart.checkoutCart(buyNow=buyNow, body=body)
    # use result
except Exception as e:
    print(e)
```
