...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.updatePriceAdjustment(id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.removePriceAdjustment(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.addPriceAdjustment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getAppCoupons(id=id, buyNow=buyNow, slug=slug, storeId=storeId)
    # use result
except Exception as e:
    print(e)
```
