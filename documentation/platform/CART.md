...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getPromotions(pageNo=pageNo, pageSize=pageSize, q=q, isActive=isActive, promoGroup=promoGroup, promotionType=promotionType, fpPanel=fpPanel, promotionId=promotionId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getPromosCouponConfig(entityType=entityType, isHidden=isHidden)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.updateCartMetaConfig(cartMetaId=cartMetaId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.createCartMetaConfig(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.updateCartDynamicInjection(id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.removeCartDynamicInjection(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.createCartDynamicInjection(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getAbandonedCart(userId=userId, pageNo=pageNo, pageSize=pageSize, fromDate=fromDate, toDate=toDate, anonymousCart=anonymousCart, lastId=lastId, sortOn=sortOn)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getAbandonedCartDetails(userId=userId, id=id, i=i, b=b)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.addItems(cartId=cartId, b=b, userId=userId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.updateCart(cartId=cartId, b=b, userId=userId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getCouponOptionValues()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getCouponCodeExists(code=code)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.getPromotionCodeExists(code=code)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.overrideCart(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.selectPaymentMode(id=id, buyNow=buyNow, orderType=orderType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.application("<APPLICATION_ID>").cart.selectPaymentModeV2(id=id, buyNow=buyNow, orderType=orderType, body=body)
    # use result
except Exception as e:
    print(e)
```
