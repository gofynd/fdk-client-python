...
```python
try:
    result = await client.orders.getShipmentById(channelShipmentId=channelShipmentId, shipmentId=shipmentId, orderingCompanyId=orderingCompanyId, requestByExt=requestByExt)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getOrderById(orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getOrders(lane=lane, searchType=searchType, searchValue=searchValue, fromDate=fromDate, toDate=toDate, dpIds=dpIds, stores=stores, salesChannel=salesChannel, pageNo=pageNo, pageSize=pageSize, isPrioritySort=isPrioritySort, customMeta=customMeta)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").orders.getAppOrderShipmentDetails(orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.application("<APPLICATION_ID>").orders.trackPlatformShipment(shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getfilters(view=view, groupEntity=groupEntity)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getBulkInvoice(batchId=batchId, docType=docType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getBulkInvoiceLabel(batchId=batchId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getBulkShipmentExcelFile(lane=lane, searchType=searchType, searchId=searchId, fromDate=fromDate, toDate=toDate, dpIds=dpIds, orderingCompanyId=orderingCompanyId, stores=stores, salesChannel=salesChannel, requestByExt=requestByExt, pageNo=pageNo, pageSize=pageSize, customerId=customerId, isPrioritySort=isPrioritySort)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getManifestList(status=status, storeId=storeId, pageNo=pageNo, pageSize=pageSize, searchValue=searchValue, fromDate=fromDate, toDate=toDate)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getManifestDetailsWithShipments(manifestId=manifestId, fromDate=fromDate, toDate=toDate, storeId=storeId, page=page, pageSize=pageSize, lane=lane, dpIds=dpIds, searchType=searchType, searchValue=searchValue)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getBulkActionFailedReport(batchId=batchId, reportType=reportType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getShipmentReasons(shipmentId=shipmentId, bagId=bagId, state=state)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.bulkActionProcessXlsxFile(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.bulkActionDetails(batchId=batchId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getBagById(bagId=bagId, channelBagId=channelBagId, channelId=channelId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.orders.getBags(bagIds=bagIds, shipmentIds=shipmentIds, orderIds=orderIds, channelBagIds=channelBagIds, channelShipmentIds=channelShipmentIds, channelOrderIds=channelOrderIds, channelId=channelId, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
