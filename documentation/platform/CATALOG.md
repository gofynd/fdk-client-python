...
```python
try:
    result = await client.catalog.upsertInventory(itemId=itemId, sellerIdentifier=sellerIdentifier, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.upsertBulkInventory(body=body)
    # use result
except Exception as e:
    print(e)
```
