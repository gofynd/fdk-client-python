...
```python
try:
    result = await platformClient.billing.getEnterprisePlans()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.billing.planStatusUpdate(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.billing.subscripePlan(body=body)
    # use result
except Exception as e:
    print(e)
```
