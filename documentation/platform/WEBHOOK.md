...
```python
try:
    result = await platformClient.webhook.manualRetryOfFailedEvent(body=body)
    # use result
...
```python
try:
    result = await platformClient.webhook.getEventCounts(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.getManualRetryStatus()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.manualRetryCancel()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.downloadDeliveryReport(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.pingWebhook(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.getReportFilters(body=body)
    # use result
except Exception as e:
    print(e)
```
...
[ArrayList<ReportFilterResponse>](#ArrayList<ReportFilterResponse>)
...
```python
try:
    result = await platformClient.webhook.getHistoricalReports(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.cancelJobByName(filename=filename)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.getDeliveryReports(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await platformClient.webhook.registerSubscriberToEventV2(body=body)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | data | HashMap<String,Any>? |  yes  | The data associated with the event. |
