...
```json
{
  ...
  "quantity": 9999988899,
  "pincode": 421302,
  "article_id": "1_000000000490002051",
  "grouped_attributes": [],
      ...
      "details": [
        {
          "key": "MRP",
          "type": "text",
          "value": "₹200.00 inclusive of all taxes"
        },
        {
          "key": "Dimension",
          "type": "text",
          "value": "25.0 x 20.0 x 15.0 cm"
        },
        {
          "key": "Packer Information",
          "type": "text",
          "value": "Reliance,Ghansoli"
        }
      ]
    }
  ],
  ...
  "seller": {
    "uid": 1,
    "name": "Reliance Industries Limited - HoReCa & Institution"
  },
  "store": {
    "uid": 1,
    "name": "RRL Bhiwandi FC",
    "count": 1
  },
...
```python
try:
    result = await client.catalog.getProductPriceBySlugV3(slug=slug, size=size, storeId=storeId, pincode=pincode, moq=moq)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getProductSellersBySlugV3(slug=slug, size=size, pincode=pincode, strategy=strategy, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
