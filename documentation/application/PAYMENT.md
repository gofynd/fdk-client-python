...
```python
try:
    result = await applicationClient.payment.getPaymentModeRoutes(amount=amount, cartId=cartId, checkoutMode=checkoutMode, refresh=refresh, orderId=orderId, cardReference=cardReference, userDetails=userDetails, displaySplit=displaySplit, advancePayment=advancePayment, shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.linkWallet(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.delinkWallet(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.cardDetails(cardInfo=cardInfo, aggregator=aggregator)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.outstandingOrderDetails(aggregator=aggregator)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.paidOrderDetails(aggregator=aggregator)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.createPaymentOrder(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.deleteBeneficiaryDetails(beneficiaryId=beneficiaryId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.getRefundOptions(configuration=configuration, productType=productType, amount=amount)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.setRefundOptionforShipment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.getSelectedRefundOption(shipmentId=shipmentId, orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.getUserBeneficiariesDetailV2(orderId=orderId, shipmentId=shipmentId, mop=mop)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.payment.validateBeneficiaryAddress(body=body)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | meta | HashMap<String,Any>? |  yes  | Payment methods meta |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | HashMap<String,Any> |  no  | Response received from aggregator |
...
---
 ...
 | isDomesticCard | Boolean |  no  | Is card domestic or international |
...
---
 ...
 | session | HashMap<String,Any>? |  yes  | User Session |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | statusCode | Int |  no  | HTTP Status code |
 | data | ArrayList<HashMap<String,Any>>? |  yes  | Dict containing the outstanding order details |
 | success | Boolean |  no  | Response is successful or not. |
 | message | String? |  yes  | Message |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | statusCode | Int |  no  | HTTP Status code |
 | data | ArrayList<HashMap<String,Any>>? |  yes  | Dict containing the paid order details |
 | success | Boolean |  no  | Response is successful or not. |
 | message | String? |  yes  | Message |
