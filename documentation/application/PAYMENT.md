...
```python
try:
    result = await client.payment.outstandingOrderDetails(merchantUserId=merchantUserId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.payment.paidOrderDetails(merchantUserId=merchantUserId)
    # use result
except Exception as e:
    print(e)
```
