...
```python
try:
    result = await applicationClient.cart.getCart(id=id, i=i, b=b, assignCardId=assignCardId, areaCode=areaCode)
    # use result
...
```python
try:
    result = await applicationClient.cart.addItems(i=i, b=b, areaCode=areaCode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.updateCart(id=id, i=i, b=b, areaCode=areaCode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.getItemCount(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.getCoupons(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.applyCoupon(i=i, b=b, p=p, id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.removeCoupon(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.applyRewardPoints(id=id, i=i, b=b, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.getAddresses(cartId=cartId, mobileNo=mobileNo, checkoutMode=checkoutMode, tags=tags, isDefault=isDefault)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.getAddressById(id=id, cartId=cartId, mobileNo=mobileNo, checkoutMode=checkoutMode, tags=tags, isDefault=isDefault)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.selectAddress(cartId=cartId, i=i, b=b, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.selectPaymentMode(id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.validateCouponForPayment(id=id, addressId=addressId, paymentMode=paymentMode, paymentIdentifier=paymentIdentifier, aggregatorName=aggregatorName, merchantCode=merchantCode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.getShipments(p=p, id=id, addressId=addressId, areaCode=areaCode, orderType=orderType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.checkoutCart(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.cart.updateCartMeta(id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
