...
```python
try:
    result = await client.cart.getCart(id=id, i=i, b=b, assignCardId=assignCardId, areaCode=areaCode)
    # use result
...
```python
try:
    result = await client.cart.getCartLastModified(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.addItems(i=i, b=b, areaCode=areaCode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.updateCart(id=id, i=i, b=b, areaCode=areaCode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getItemCount(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getCoupons(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.removeCoupon(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getBulkDiscountOffers(itemId=itemId, articleId=articleId, uid=uid, slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getAddresses(cartId=cartId, mobileNo=mobileNo, checkoutMode=checkoutMode, tags=tags, isDefault=isDefault)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getAddressById(id=id, cartId=cartId, mobileNo=mobileNo, checkoutMode=checkoutMode, tags=tags, isDefault=isDefault)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.removeAddress(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.validateCouponForPayment(id=id, addressId=addressId, paymentMode=paymentMode, paymentIdentifier=paymentIdentifier, aggregatorName=aggregatorName, merchantCode=merchantCode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getShipments(p=p, id=id, addressId=addressId, areaCode=areaCode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getCartSharedItems(token=token)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.updateCartWithSharedItems(token=token, action=action)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getPromotionOffers(slug=slug, pageSize=pageSize, promotionGroup=promotionGroup)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.cart.getLadderOffers(slug=slug, storeId=storeId, promotionId=promotionId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
