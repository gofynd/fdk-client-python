...
```python
try:
    result = await client.order.updateShipmentExternal(shipmentId=shipmentId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
| --------- | -----  | -------- | ----------- | 
| shipmentId | Int | yes |  |  
| body | [UpdateShipmentExternalRequest](#UpdateShipmentExternalRequest) | yes | Request body |
...
```json
{
  ...
  "message": [],
  "final_state": {
    "16612419888281180737": {
      "cancelled_customer": "cancelled_customer",
      "shipment_id": "16612419888281180737"
    }
  }
}
```
...
```python
try:
    result = await client.order.updateShipmentExternal1(shipmentId=shipmentId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 #### [UpdateShipmentExternalRequest](#UpdateShipmentExternalRequest)

 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | forceTransition | Boolean? |  yes  |  |
 | statuses | ArrayList<HashMap<String,Any>> |  no  |  |
