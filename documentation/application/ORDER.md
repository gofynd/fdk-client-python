...
```python
try:
    result = await client.order.getInvoiceByShipmentId1(shipmentId=shipmentId, parameters=parameters)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getCreditNoteByShipmentId(shipmentId=shipmentId, parameters=parameters)
    # use result
except Exception as e:
    print(e)
```
