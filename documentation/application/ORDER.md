...
```python
try:
    result = await client.order.getOrders1(pageNo=pageNo, pageSize=pageSize, fromDate=fromDate, toDate=toDate, status=status)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | order | [OrderSchema1](#OrderSchema1) |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | ArrayList<[OrderSchema1](#OrderSchema1)> |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | reasons | ArrayList<[BagReasons1](#BagReasons1)> |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | shipment | [Shipments1](#Shipments1) |  no  |  |
...
---
 ...
 | id | Int? |  yes  |  |
 | financialBreakup | ArrayList<[FinancialBreakup](#FinancialBreakup)>? |  yes  |  |
 | appliedPromos | ArrayList<[AppliedPromos1](#AppliedPromos1)>? |  yes  |  |
...
---
 ...
 | articleQuantity | Double? |  yes  |  |
 | mrpPromotion | Boolean? |  yes  |  |
 | appliedFreeArticles | [AppliedFreeArticles1](#AppliedFreeArticles1)? |  yes  |  |
...
---
 ...
 #### [AppliedFreeArticles1](#AppliedFreeArticles1)
