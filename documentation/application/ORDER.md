...
```python
try:
    result = await client.order.updateShipmentStatus1(shipmentId=shipmentId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getOrders1(status=status, pageNo=pageNo, pageSize=pageSize, fromDate=fromDate, toDate=toDate, customMeta=customMeta)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getOrderById1(orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getPosOrderById1(orderId=orderId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getShipmentById1(shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getInvoiceByShipmentId1(shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.trackShipment1(shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getCustomerDetailsByShipmentId1(orderId=orderId, shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.sendOtpToShipmentCustomer1(orderId=orderId, shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.verifyOtpShipmentCustomer1(orderId=orderId, shipmentId=shipmentId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getShipmentBagReasons1(shipmentId=shipmentId, bagId=bagId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.getShipmentReasons1(shipmentId=shipmentId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.order.updateShipmentStatus2(shipmentId=shipmentId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | products | ArrayList<[ProductsDataUpdates1](#ProductsDataUpdates1)>? |  yes  |  |
...
---
 ...
 | dataUpdates | [DataUpdates1](#DataUpdates1)? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | status | String? |  yes  |  |
 | shipments | ArrayList<[ShipmentsRequest1](#ShipmentsRequest1)>? |  yes  |  |
...
---
 ...
 | statuses | ArrayList<[StatuesRequest1](#StatuesRequest1)>? |  yes  |  |
 | task | Boolean? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | [ProductsReasonsData1](#ProductsReasonsData1)? |  yes  |  |
 | filters | ArrayList<[ProductsReasonsFilters1](#ProductsReasonsFilters1)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | data | [EntityReasonData1](#EntityReasonData1)? |  yes  |  |
 | filters | ArrayList<HashMap<String,Any>>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | products | ArrayList<[ProductsReasons1](#ProductsReasons1)>? |  yes  |  |
 | entities | ArrayList<[EntitiesReasons1](#EntitiesReasons1)>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | data | HashMap<String,Any>? |  yes  |  |
 | filters | ArrayList<[ProductsDataUpdatesFilters1](#ProductsDataUpdatesFilters1)>? |  yes  |  |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | identifier | String |  no  |  |
 | products | ArrayList<[Products1](#Products1)>? |  yes  |  |
 | reasons | [ReasonsData1](#ReasonsData1)? |  yes  |  |
...
---
 ...
 #### [StatuesRequest1](#StatuesRequest1)
