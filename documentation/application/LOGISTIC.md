...
```python
try:
    result = await client.logistic.getPincodeCity(pincode=pincode, countryCode=countryCode)
    # use result
...
```python
try:
    result = await client.logistic.getAllCountries()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.logistic.assignLocations(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.logistic.getOptimalLocations(body=body)
    # use result
except Exception as e:
    print(e)
```
