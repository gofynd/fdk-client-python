...
```python
try:
    result = await client.poscart.getCart(id=id, i=i, b=b, assignCardId=assignCardId, areaCode=areaCode)
    # use result
...
```json
{
  "items": [
    {
      ...
      "coupon": {},
      "identifiers": {
        "identifier": "oYiy2LXVRSCOdNByp7PsRQ"
      },
      "coupon_message": "",
      "discount": "20% OFF",
      "is_set": false,
      "product": {
        "type": "product",
        "uid": 7500037,
        "name": "Handblock Printed Cotton Kurta Red",
        "slug": "handblock-printed-cotton-kurta-red",
        "brand": {
          "uid": 3,
          "name": "Swadesh"
        },
        ...
        "attributes": {
          ...
          "fabric-type": "Slub",
          "fabric-detail": "100% cotton",
          "pattern": "Straight",
          "disclaimer": "Wash dark colour separately. Dark colour may bleed or rub on to other fabrics in wet condition.",
          "model-chest-size": "34",
          "model-height": "5'6",
          "model-waist-size": "28",
          "size-worn-by-model": "S",
          "craft-name": "Hand block printed Ajrak",
          "usp": "A Elegant  Straight Kurta front placket,  with floral motifs in hand- block  print.",
          "trend-theme": "Earth",
          "size-group": "Regular",
          "size-format": "1N",
          "technique": "Hand block printed Ajrak",
          "neckline": "Collar Neck",
          "sleeve": "3/4th",
          "fitting": "Regular",
          "garment-length": "48",
          "brand_name": "Swadesh",
          "primary_color_hex": "800000"
        },
        "images": [
          {
            "aspect_ratio": "16:25",
            "url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/ymvKh8Jvi-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png",
            "secure_url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/ymvKh8Jvi-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png"
          },
          {
            "aspect_ratio": "16:25",
            "url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/qWeCXcUTF-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png",
            "secure_url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/qWeCXcUTF-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png"
          },
          {
            "aspect_ratio": "16:25",
            "url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/qh6p6ISby-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png",
            "secure_url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/qh6p6ISby-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png"
          },
          {
            "aspect_ratio": "16:25",
            "url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/Gl8cvevID-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png",
            "secure_url": "https://cdn.pixelbin.io/v2/broken-voice-fda1b8/8ScdyV/wrkr/swadeshz0/products/pictures/item/free/original/Gl8cvevID-HANDBLOCK-PRINTED-COTTON-KURTA-RED.png"
          }
        ],
        "action": {
          "type": "product",
          "url": "https://api.fyndx0.de/platform/content/v1/products/handblock-printed-cotton-kurta-red/",
          "query": {
            "product_slug": [
              "handblock-printed-cotton-kurta-red"
            ]
          }
        },
        "item_code": "441122757_ MAROON",
        "_custom_json": {},
        "tags": [],
        "teaser_tag": null
      },
      ...
      "promotions_applied": [
        {
          "promo_id": "637e063b43ae655b190e65e4",
          "amount": 39.95,
          "article_quantity": 1,
          "mrp_promotion": false,
          "promotion_type": "percentage",
          "offer_text": "percentage discount to users |"
        }
      ]
    }
  ],
  ...
  "last_modified": "Tue, 06 Dec 2022 05:10:57 GMT"
}
```
</details>
...
```python
try:
    result = await client.poscart.getCartLastModified(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.addItems(i=i, b=b, areaCode=areaCode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.updateCart(id=id, i=i, b=b, areaCode=areaCode, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getItemCount(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getCoupons(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.removeCoupon(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getBulkDiscountOffers(itemId=itemId, articleId=articleId, uid=uid, slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getAddresses(cartId=cartId, mobileNo=mobileNo, checkoutMode=checkoutMode, tags=tags, isDefault=isDefault)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getAddressById(id=id, cartId=cartId, mobileNo=mobileNo, checkoutMode=checkoutMode, tags=tags, isDefault=isDefault)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.removeAddress(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.validateCouponForPayment(id=id, addressId=addressId, paymentMode=paymentMode, paymentIdentifier=paymentIdentifier, aggregatorName=aggregatorName, merchantCode=merchantCode)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getShipments(pickAtStoreUid=pickAtStoreUid, orderingStoreId=orderingStoreId, p=p, id=id, addressId=addressId, areaCode=areaCode, orderType=orderType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getAvailableDeliveryModes(areaCode=areaCode, id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getStoreAddressByUid(storeUid=storeUid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.getCartSharedItems(token=token)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.poscart.updateCartWithSharedItems(token=token, action=action)
    # use result
except Exception as e:
    print(e)
```
