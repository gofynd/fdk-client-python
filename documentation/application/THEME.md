...
```python
try:
    result = await applicationClient.theme.getPage(themeId=themeId, pageValue=pageValue, filters=filters, company=company)
    # use result
except Exception as e:
    print(e)
```
...
---
 ...
 | list | ArrayList<[ThemeConfiguration](#ThemeConfiguration)> |  no  | A list of configurations |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | sections | ArrayList<[Section](#Section)>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | blocks | ArrayList<[Block](#Block)>? |  yes  |  |
