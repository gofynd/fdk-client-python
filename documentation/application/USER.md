...
```python
try:
    result = await applicationClient.user.resetForgotPassword(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.verifyEmailForgotOTP(platform=platform, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.sendForgotOTPOnMobile(platform=platform, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.verifyMobileForgotOTP(platform=platform, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.sendForgotOTPOnEmail(platform=platform, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.userExists(q=q)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.getUserAttributes(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await applicationClient.user.updateUserAttributes(body=body)
    # use result
except Exception as e:
    print(e)
```
