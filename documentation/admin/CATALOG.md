...
```python
try:
    result = await client.catalog.listCategories(level=level, department=department, q=q, pageNo=pageNo, pageSize=pageSize)
    # use result
...
```python
try:
    result = await client.catalog.getDepartment(uid=uid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listDepartments(pageNo=pageNo, pageSize=pageSize, name=name, search=search, isActive=isActive)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createDepartment(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getFilterAttributesPriority()
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.setFilterAttributesPriority(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getAttributeGroupsPriority(groupType=groupType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.setAttributeGroupsPriority(groupType=groupType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getProductAttributeGroup(slug=slug, ca=ca, department=department, variant=variant, sort=sort, sortOn=sortOn, q=q, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateProductAttributeGroup(slug=slug, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listProductAttributesGroups(ca=ca, department=department, variant=variant, sort=sort, sortOn=sortOn, q=q, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createProductAttributeGroup(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listProductAttributes(ca=ca, department=department, variant=variant, sort=sort, sortOn=sortOn, q=q, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createProductAttribute(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getProductAttribute(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateProductAttribute(slug=slug, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listVariants(ca=ca, department=department, variant=variant, sort=sort, sortOn=sortOn, q=q, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createVariant(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getVariantByUID(uid=uid)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateVariant(uid=uid, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listProductTemplate(department=department, sort=sort, search=search, pageNo=pageNo, pageSize=pageSize, slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getProductTemplateList(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateProductTemplate(slug=slug, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.deleteProductTemplate(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getProductTemplate(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.validateProductTemplate(slug=slug, itemType=itemType, bulk=bulk)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.verifyCompany(q=q, opted=opted, pageNo=pageNo, pageSize=pageSize, status=status, brandIds=brandIds)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listProductVerification(q=q, opted=opted, pageNo=pageNo, pageSize=pageSize, status=status, brandIds=brandIds)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getProductVerificationDetails(itemId=itemId, id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.verifyProduct(itemId=itemId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getAppProducts(brandIds=brandIds, categoryIds=categoryIds, departmentIds=departmentIds, tags=tags, itemIds=itemIds, pageNo=pageNo, pageSize=pageSize, q=q)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listBulkImportJobs(jobType=jobType, search=search, stage=stage, startDate=startDate, endDate=endDate, pageNo=pageNo, pageSize=pageSize, total=total)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createBulkImportJob(jobType=jobType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getBulkImportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateBulkImportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.listBulkExportJobs(jobType=jobType, search=search, stage=stage, startDate=startDate, endDate=endDate, pageNo=pageNo, pageSize=pageSize, total=total)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createBulkExportJob(jobType=jobType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getBulkExportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateBulkExportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getImportValidationSchema(jobType=jobType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.downloadImportFile(jobType=jobType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getAllHsnCodes(pageNo=pageNo, pageSize=pageSize, q=q, type=type)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.createHsnCodev2(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.getSingleHSNCode(reportingHsn=reportingHsn)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.catalog.updateHsnCode(reportingHsn=reportingHsn, body=body)
    # use result
except Exception as e:
    print(e)
```
