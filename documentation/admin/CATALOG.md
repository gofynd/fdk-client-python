...
```python
try:
    result = await adminClient.catalog.deleteProductTemplate(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.updateProductTemplate(slug=slug, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getProductTemplate(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.downloadProductTemplateViews(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.validateProductTemplate(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.verifyCompany(q=q, opted=opted, pageNo=pageNo, pageSize=pageSize, status=status, brandIds=brandIds)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.listProductVerification(q=q, opted=opted, pageNo=pageNo, pageSize=pageSize, status=status, brandIds=brandIds)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.verifyProduct(itemId=itemId, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getProductVerificationDetails(itemId=itemId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.createSizeGuide(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getSizeGuides(active=active, q=q, tag=tag, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.updateSizeGuide(id=id, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getSizeGuide(id=id)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getAppProducts(brandIds=brandIds, categoryIds=categoryIds, departmentIds=departmentIds, tags=tags, itemIds=itemIds, pageNo=pageNo, pageSize=pageSize, q=q)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.createBulkImportJob(jobType=jobType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.listBulkImportJobs(jobType=jobType, search=search, stage=stage, startDate=startDate, endDate=endDate, pageNo=pageNo, pageSize=pageSize, total=total)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.updateBulkImportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getBulkImportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.createBulkExportJob(jobType=jobType, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.listBulkExportJobs(jobType=jobType, search=search, stage=stage, startDate=startDate, endDate=endDate, pageNo=pageNo, pageSize=pageSize, total=total)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.updateBulkExportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getBulkExportJob(jobType=jobType, jobId=jobId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getImportValidationSchema(jobType=jobType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.downloadImportFile(jobType=jobType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.createHsnCodev2(body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getAllHsnCodes(pageNo=pageNo, pageSize=pageSize, q=q, type=type)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.updateHsnCode(reportingHsn=reportingHsn, body=body)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await adminClient.catalog.getSingleHSNCode(reportingHsn=reportingHsn)
    # use result
except Exception as e:
    print(e)
```
