...
```python
try:
    result = await adminClient.communication.sendSellerCommunicationSynchronously(body=body)
    # use result
...
```python
try:
    result = await adminClient.communication.sendSellerCommunicationAsynchronously(body=body)
    # use result
except Exception as e:
    print(e)
```
