...
```python
try:
    result = await client.communication.sendSellerCommunicationSynchronously(body=body)
    # use result
...
```python
try:
    result = await client.communication.sendSellerCommunicationAsynchronously(body=body)
    # use result
except Exception as e:
    print(e)
```
