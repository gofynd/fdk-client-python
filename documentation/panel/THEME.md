...
```python
try:
    result = await panelClient.theme.getMarketplaceThemes(pageSize=pageSize, pageNo=pageNo)
    # use result
...
```python
try:
    result = await panelClient.theme.getMarketplaceThemeBySlug(slugName=slugName)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await panelClient.theme.getMarketplaceThemeVersions(slugName=slugName)
    # use result
except Exception as e:
    print(e)
```
